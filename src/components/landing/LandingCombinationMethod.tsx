...
import { Sparkles, Volume2, RefreshCw, Zap } from 'lucide-react';
...
export default function LandingCombinationMethod() {
  ...
  return (
    <section id="methode" className="py-16 sm:py-24 bg-gray-50/70 dark:bg-[#151515] relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        
        {/* Section Header */}
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
          <span className="text-xs font-bold uppercase tracking-widest text-[#00897B] dark:text-[#03DAC5] block mb-2">
            Méthode Combinatoire Exclusive
          </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-8">
          ...
          {/* Sujet */}
          <div className="bg-white dark:bg-[#1E1E1E] rounded-2xl p-3 sm:p-4 border border-gray-100 dark:border-white/5 shadow-sm">
          ...
          {/* Verbe */}
          <div className="bg-white dark:bg-[#1E1E1E] rounded-2xl p-3 sm:p-4 border border-gray-100 dark:border-white/5 shadow-sm">
            <span className="text-[11px] font-bold uppercase tracking-wider text-teal-600 dark:text-teal-400 block mb-2">
              2. Action / Modal
            </span>
            <div className="flex flex-col gap-1.5">
              {VERBES.map((v, idx) => (
        ...
        <div className="bg-white dark:bg-[#1E1E1E] rounded-3xl p-6 sm:p-8 border border-gray-100 dark:border-white/10 shadow-lg text-center flex flex-col items-center">
          ...
          <p className="text-2xl sm:text-4xl font-black text-gray-900 dark:text-white font-hanzi tracking-wide mb-2">
            {fullSentenceHanzi}
          </p>
          <p className="text-sm sm:text-base font-semibold text-[#00897B] dark:text-[#03DAC5] font-pinyin mb-2">
            {fullSentencePinyin}
          </p>
