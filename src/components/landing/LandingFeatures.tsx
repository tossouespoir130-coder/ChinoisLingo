...
import { Headphones, BookOpen, Video, Award, ArrowRight } from 'lucide-react';
...
export default function LandingFeatures() {
  ...
  return (
    <section id="fonctionnalites" className="py-16 sm:py-24 bg-white dark:bg-[#121212] relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {PILLARS.map((p, idx) => (
            <div
              key={idx}
              className="bg-gray-50 dark:bg-[#1A1A1A] rounded-3xl p-5 border border-gray-100 dark:border-white/5 flex flex-col justify-between hover:shadow-xl transition-all hover:-translate-y-1"
            >
              <div>
              ...
              <div className="mt-5 pt-3 border-t border-gray-200/50 dark:border-white/5 flex items-center justify-end">
                <Link
                  href="/connexion"
                  className="text-xs font-bold text-[#6200EE] dark:text-[#BB86FC] flex items-center gap-1 hover:underline"
                >
                  <span>Découvrir</span>
