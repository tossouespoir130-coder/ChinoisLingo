...
function FormationContent() {
  ...
  const handleAddComment = (e: React.FormEvent) => {
    ...
    const newComm: CourseComment = {
      ...
      authorName: userName || (user?.email ? user.email.split('@')[0] : 'Apprenant'),
      authorAvatar: userAvatar || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=120&auto=format&fit=crop&q=80',
                ...
                <div className="aspect-video w-full relative flex items-center justify-center bg-black">
                  {isPlayingVideo && currentLesson.youtubeId ? (
                    ...
                    >
                      ...
                      {/* Centered ChinoisLingo Brand Play Button (Exact replacement for YouTube play button) */}
