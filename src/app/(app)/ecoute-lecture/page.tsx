...
export const readingCatalog: ReadingItem[] = [
  ...
  },
  {
    ...
    seriesEpisodes: [
      ...
      {
        id: 'vie_chine_business_ep6',
        episodeNumber: 6,
        titleFr: 'Partie 6 : À la recherche du sac (1) — Le premier magasin',
        titleZh: '第六篇：找包（一）— 第一家店',
        titlePinyin: 'Dì liù piān: Zhǎo bāo (yī) — Dì yī jiā diàn',
        duration: '1 min 40',
        level: 'HSK 3',
        description: 'Katia cherche un sac identique à son échantillon et entre seule dans un premier magasin pour se renseigner.',
        ...
        characters: [
          {
            ...
            pinyin: 'Kǎdìyà',
            role: 'Femme d’affaires',
            description: 'Cherche un modèle de sac spécifique d’après son échantillon.',
            color: 'pink'
          },
          {
            name: 'Vendeur',
            ...
            description: 'Employé du magasin qui conseille Katia et lui présente des articles similaires.',
            color: 'turquoise'
          }
        ],
        sentences: [
          {
            id: 'vc_b6_1',
            hanzi: '卡蒂娅想买包。',
            pinyin: 'Kǎdìyà xiǎng mǎi bāo.',
            french: 'Katia veut acheter des sacs.',
          },
          {
            id: 'vc_b6_2',
            hanzi: '她有一个包的样品。',
            pinyin: 'Tā yǒu yí ge bāo de yàngpǐn.',
            french: 'Elle a un échantillon de sac.',
          },
          {
            id: 'vc_b6_3',
            hanzi: '她想找一样的包。',
            pinyin: 'Tā xiǎng zhǎo yíyàng de bāo.',
            french: 'Elle veut trouver un sac identique.',
          },
          {
            id: 'vc_b6_4',
            hanzi: '她一个人去第一家店。',
            pinyin: 'Tā yí ge rén qù dì yī jiā diàn.',
            french: 'Elle va seule dans un premier magasin.',
          },
          {
            id: 'vc_b6_5',
            speaker: 'Katia',
            speakerRole: 'Femme d’affaires',
            speakerColor: 'pink',
            hanzi: '你好，请问你们这儿有这个包吗？',
            pinyin: 'Nǐ hǎo, qǐngwèn nǐmen zhèr yǒu zhège bāo ma?',
            french: 'Bonjour, excusez-moi, vous avez ce sac ici ?',
          },
          {
            id: 'vc_b6_6',
            speaker: 'Vendeur',
            speakerRole: 'Vendeur',
            speakerColor: 'turquoise',
            hanzi: '这个？我看看。……不好意思，这个包我们没有了。',
            pinyin: 'Zhège? Wǒ kànkan. …… Bù hǎoyìsi, zhège bāo wǒmen méiyǒu le.',
            french: 'Celui-ci ? Laissez-moi voir. … Désolé, nous n’avons plus ce sac.',
          },
          {
            id: 'vc_b6_7',
            speaker: 'Katia',
            ...
            speakerColor: 'pink',
            hanzi: '那有类似的吗？',
            pinyin: 'Nà yǒu lèisì de ma?',
            french: 'Alors, vous avez quelque chose de similaire ?',
          },
          {
            id: 'vc_b6_8',
            speaker: 'Vendeur',
            ...
            speakerColor: 'turquoise',
            hanzi: '有，您看看这个。',
            pinyin: 'Yǒu, nín kànkan zhège.',
            french: 'Oui, regardez celui-ci.',
          },
          {
            id: 'vc_b6_9',
            speaker: 'Katia',
            ...
            speakerColor: 'pink',
            hanzi: '谢谢，但是我不想要这种。',
            pinyin: 'Xièxie, dànshì wǒ bù xiǎng yào zhè zhǒng.',
            french: 'Merci, mais je ne veux pas ce modèle.',
          },
          {
            id: 'vc_b6_10',
            speaker: 'Vendeur',
        ...
        vocabulary: [
          { hanzi: '包', pinyin: 'bāo', french: 'sac, sac à main', role: 'Nom commun' },
          { hanzi: '样品', pinyin: 'yàngpǐn', french: 'échantillon, spécimen', role: 'Nom commun' },
          { hanzi: '一样', pinyin: 'yíyàng', french: 'identique, pareil', role: 'Adjectif' },
          { hanzi: '一个人', pinyin: 'yí ge rén', french: 'seul, par soi-même', role: 'Expression' },
          { hanzi: '店', pinyin: 'diàn', french: 'magasin, boutique', role: 'Nom commun' },
          { hanzi: '请问', pinyin: 'qǐngwèn', french: 's’il vous plaît, puis-je demander', role: 'Formule de politesse' },
          { hanzi: '这儿', pinyin: 'zhèr', french: 'ici', role: 'Pronom de lieu' },
          { hanzi: '看看', pinyin: 'kànkan', french: 'regarder, jeter un œil', role: 'Verbe' },
          { hanzi: '不好意思', pinyin: 'bù hǎoyìsi', french: 'désolé, pardon', role: 'Expression' },
          { hanzi: '类似', pinyin: 'lèisì', french: 'similaire, ressemblant', role: 'Adjectif' },
          { hanzi: '这种', pinyin: 'zhè zhǒng', french: 'ce modèle, ce genre', role: 'Pronom démonstratif' },
        ]
      },
      {
        id: 'vie_chine_business_ep7',
        episodeNumber: 7,
        titleFr: 'Partie 7 : À la recherche du sac (2) — Le deuxième magasin',
        titleZh: '第七篇：找包（二）— 第二家店',
        titlePinyin: 'Dì qī piān: Zhǎo bāo (èr) — Dì èr jiā diàn',
        duration: '1 min 30',
        level: 'HSK 3',
        description: 'Katia poursuit ses recherches dans une deuxième boutique et précise qu’elle ne souhaite que le modèle exact correspondant à son échantillon.',
        ...
        characters: [
          {
            ...
            pinyin: 'Kǎdìyà',
            role: 'Femme d’affaires',
            description: 'Persévère pour trouver le modèle précis de sac de cette marque.',
            color: 'pink'
          },
          {
            name: 'Vendeur',
            ...
            pinyin: 'Diànyuán',
            role: 'Vendeur en boutique',
            description: 'Employé du deuxième magasin qui renseigne Katia sur la disponibilité du modèle.',
            color: 'turquoise'
          }
        ],
        sentences: [
          {
            id: 'vc_b7_1',
            hanzi: '卡蒂娅去第二家店。',
            pinyin: 'Kǎdìyà qù dì èr jiā diàn.',
            french: 'Katia va dans un deuxième magasin.',
          },
          {
            id: 'vc_b7_2',
            hanzi: '她还是想找一样的包。',
            pinyin: 'Tā háishì xiǎng zhǎo yíyàng de bāo.',
            french: 'Elle veut toujours trouver le même sac.',
          },
          {
            id: 'vc_b7_3',
            speaker: 'Katia',
            speakerRole: 'Femme d’affaires',
            speakerColor: 'pink',
            hanzi: '你好，请问你们有这个牌子的包吗？',
            pinyin: 'Nǐ hǎo, qǐngwèn nǐmen yǒu zhège páizi de bāo ma?',
            french: 'Bonjour, excusez-moi, vous avez des sacs de cette marque ?',
          },
          {
            id: 'vc_b7_4',
            speaker: 'Vendeur',
            ...
            speakerColor: 'turquoise',
            hanzi: '有，您要哪一款？',
            pinyin: 'Yǒu, nín yào nǎ yì kuǎn?',
            french: 'Oui, quel modèle voulez-vous ?',
          },
          {
            id: 'vc_b7_5',
            speaker: 'Katia',
            ...
            speakerColor: 'pink',
            hanzi: '我要这个样品一样的。',
            pinyin: 'Wǒ yào zhège yàngpǐn yíyàng de.',
            french: 'Je veux le même que cet échantillon.',
          },
          {
            id: 'vc_b7_6',
            speaker: 'Vendeur',
            speakerRole: 'Vendeur',
            speakerColor: 'turquoise',
            hanzi: '这个款我们没有了。您看看别的款？',
            pinyin: 'Zhège kuǎn wǒmen méiyǒu le. Nín kànkan bié de kuǎn?',
            french: 'Ce modèle-là, nous ne l’avons plus. Regardez un autre modèle ?',
          },
          {
            id: 'vc_b7_7',
            speaker: 'Katia',
            ...
            speakerColor: 'pink',
            hanzi: '谢谢，不用了。我只要这个款。',
            pinyin: 'Xièxie, bú yòng le. Wǒ zhǐ yào zhège kuǎn.',
            french: 'Merci, ce n’est pas la peine. Je veux seulement ce modèle.',
          },
          {
            id: 'vc_b7_8',
            speaker: 'Vendeur',
            ...
            speakerColor: 'turquoise',
            hanzi: '好的，不好意思。',
            pinyin: 'Hǎo de, bù hǎoyìsi.',
            french: 'D’accord, désolé.',
          },
        ],
        vocabulary: [
          { hanzi: '牌子', pinyin: 'páizi', french: 'marque, enseigne', role: 'Nom commun' },
          { hanzi: '款', pinyin: 'kuǎn', french: 'modèle, style, article', role: 'Spécificatif / Nom' },
          { hanzi: '还是', pinyin: 'háishì', french: 'toujours, quand même', role: 'Adverbe' },
          { hanzi: '别的', pinyin: 'bié de', french: 'autre, d’autres', role: 'Pronom / Adjectif' },
          { hanzi: '不用了', pinyin: 'bú yòng le', french: 'ce n’est pas la peine, pas besoin', role: 'Expression' },
          { hanzi: '只', pinyin: 'zhǐ', french: 'seulement, uniquement', role: 'Adverbe' },
          { hanzi: '第二家店', pinyin: 'dì èr jiā diàn', french: 'deuxième magasin', role: 'Expression' },
        ]
      },
      {
        id: 'vie_chine_business_ep8',
        episodeNumber: 8,
        titleFr: 'Partie 8 : À la recherche du sac (3) — Le troisième magasin',
        titleZh: '第八篇：找包（三）— 第三家店',
        ...
        sentences: [
          {
            id: 'vc_b8_1',
            hanzi: '卡蒂娅继续找包。',
            pinyin: 'Kǎdìyà jìxù zhǎo bāo.',
            french: 'Katia continue à chercher le sac.',
          },
          {
            id: 'vc_b8_2',
            hanzi: '她去了第三家店。',
            pinyin: 'Tā qù le dì sān jiā diàn.',
            french: 'Elle est allée dans un troisième magasin.',
          },
          {
            id: 'vc_b8_3',
            speaker: 'Katia',
            ...
            speakerColor: 'pink',
            hanzi: '你好，请问你们有这个包吗？',
            pinyin: 'Nǐ hǎo, qǐngwèn nǐmen yǒu zhège bāo ma?',
            french: 'Bonjour, excusez-moi, vous avez ce sac ?',
          },
          {
            id: 'vc_b8_4',
            speaker: 'Vendeur',
            ...
            french: 'Oui. Quelle couleur voulez-vous ?',
          },
          {
            id: 'vc_b8_5',
            speaker: 'Katia',
            ...
            speakerColor: 'pink',
            hanzi: '你们有什么颜色？',
            pinyin: 'Nǐmen yǒu shénme yánsè?',
            french: 'Quelles couleurs avez-vous ?',
          },
          {
            id: 'vc_b8_6',
            speaker: 'Vendeur',
            ...
            french: 'Nous avons du noir, du blanc, du rouge, du bleu et du marron. Regardez.',
          },
          {
            id: 'vc_b8_7',
            speaker: 'Katia',
            ...
            speakerColor: 'pink',
            hanzi: '我比较喜欢黑色、红色和蓝色。',
            pinyin: 'Wǒ bǐjiào xǐhuan hēisè, hóngsè hé lánsè.',
            french: 'Je préfère le noir, le rouge et le bleu.',
          },
          {
            id: 'vc_b8_8',
            speaker: 'Vendeur',
            ...
            french: 'D’accord. Alors combien en voulez-vous ?',
          },
          {
            id: 'vc_b8_9',
            speaker: 'Katia',
            ...
            speakerColor: 'pink',
            hanzi: '我先看看。',
            pinyin: 'Wǒ xiān kànkan.',
            french: 'Je regarde d’abord.',
          },
          {
            id: 'vc_b8_10',
            speaker: 'Vendeur',
            ...
            french: 'D’accord, prenez votre temps.',
          },
        ],
        vocabulary: [
          { hanzi: '继续', pinyin: 'jìxù', french: 'continuer, poursuivre', role: 'Verbe' },
          { hanzi: '第三家店', pinyin: 'dì sān jiā diàn', french: 'troisième magasin', role: 'Expression' },
          { hanzi: '颜色', pinyin: 'yánsè', french: 'couleur', role: 'Nom commun' },
          { hanzi: '黑色', pinyin: 'hēisè', french: 'noir (couleur)', role: 'Nom / Adjectif' },
          { hanzi: '白色', pinyin: 'báisè', french: 'blanc (couleur)', role: 'Nom / Adjectif' },
          { hanzi: '红色', pinyin: 'hóngsè', french: 'rouge (couleur)', role: 'Nom / Adjectif' },
          { hanzi: '蓝色', pinyin: 'lánsè', french: 'bleu (couleur)', role: 'Nom / Adjectif' },
  ...
  },
  {
    ...
    titleFr: 'Où est mon passeport ?',
    titleZh: '我的护照在哪儿？',
    titlePinyin: 'Wǒ de hùzhào zài nǎr?',
    type: 'dialogues',
    level: 'HSK 2',
    duration: '1 min 30',
    description: 'Xiaoming cherche activement son passeport avec l’aide de Xiaohong avant de partir pour l’aéroport.',
    imageUrl: 'https://images.unsplash.com/photo-1578852612716-854e527abf2e?w=600&auto=format&fit=crop&q=80',
    iconBg: 'from-[#0288D1] to-[#01579B]',
    characters: [
      {
        name: '小明',
        ...
        pinyin: 'Xiǎomíng',
        role: 'Voyageur',
        description: 'Cherche activement son passeport pour ne pas manquer son vol.',
        color: 'violet'
      },
      {
        name: '小红',
        ...
        pinyin: 'Xiǎohóng',
        role: 'Voyageuse',
        description: 'Aide Xiaoming à retrouver calmement ses affaires avant le grand départ.',
        color: 'turquoise'
      }
    ],
    sentences: [
      {
        ...
        speakerColor: 'violet',
        hanzi: '小红，我的护照在哪儿？',
        pinyin: 'Xiǎohóng, wǒ de hùzhào zài nǎr?',
        french: 'Xiaohong, où est mon passeport ?',
      },
      {
        id: 'dmp_2',
        speaker: '小红',
        speakerRole: 'Voyageuse',
        speakerColor: 'turquoise',
        hanzi: '你的护照不是在桌子上吗？',
        pinyin: 'Nǐ de hùzhào bú shì zài zhuōzi shang ma?',
        french: 'Ton passeport n’est-il pas sur la table ?',
      },
      {
        id: 'dmp_3',
        speaker: '小明',
        ...
        speakerColor: 'violet',
        hanzi: '桌子上没有。我找了，没有。',
        pinyin: 'Zhuōzi shang méiyǒu. Wǒ zhǎo le, méiyǒu.',
        french: 'Il n’est pas sur la table. J’ai cherché, il n’y est pas.',
      },
      {
        id: 'dmp_4',
        speaker: '小红',
        ...
        speakerColor: 'turquoise',
        hanzi: '你再看看，是不是在书下面？',
        pinyin: 'Nǐ zài kànkan, shì bu shì zài shū xiàmiàn?',
        french: 'Regarde encore, n’est-il pas sous les livres ?',
      },
      {
        id: 'dmp_5',
        speaker: '小明',
        speakerRole: 'Voyageur',
        speakerColor: 'violet',
        hanzi: '书下面也没有。怎么办？我们要迟到了！',
        pinyin: 'Shū xiàmiàn yě méiyǒu. Zěnmebàn? Wǒmen yào chídào le!',
        french: 'Il n’est pas non plus sous les livres. Comment faire ? Nous allons être en retard !',
      },
      {
        id: 'dmp_6',
        speaker: '小红',
        ...
        speakerColor: 'turquoise',
        hanzi: '别急。你昨天用护照了吗？',
        pinyin: 'Bié jí. Nǐ zuótiān yòng hùzhào le ma?',
        french: 'Ne t’inquiète pas. As-tu utilisé ton passeport hier ?',
      },
      {
        id: 'dmp_7',
        speaker: '小明',
        ...
        speakerColor: 'violet',
        hanzi: '用了。我买了飞机票。',
        pinyin: 'Yòng le. Wǒ mǎi le fēijīpiào.',
        french: 'Oui. J’ai acheté des billets d’avion.',
      },
      {
        id: 'dmp_8',
        speaker: '小红',
        speakerRole: 'Voyageuse',
        speakerColor: 'turquoise',
        hanzi: '那你想想，买了票以后，你放在哪儿了？',
        pinyin: 'Nà nǐ xiǎngxiang, mǎi le piào yǐhòu, nǐ fàng zài nǎr le?',
        french: 'Alors réfléchis, après avoir acheté les billets, où l’as-tu mis ?',
      },
      {
        id: 'dmp_9',
        speaker: '小明',
        ...
        speakerColor: 'violet',
        hanzi: '嗯……我放在包里了。',
        pinyin: 'Èn... Wǒ fàng zài bāo lǐ le.',
        french: 'Hum... Je l’ai mis dans le sac.',
      },
      {
        id: 'dmp_10',
        speaker: '小红',
        ...
        speakerColor: 'turquoise',
        hanzi: '哪个包？黑色的？蓝色的？',
        pinyin: 'Nǎge bāo? Hēisè de? Lánsè de?',
        french: 'Quel sac ? Le noir ? Le bleu ?',
      },
      {
        id: 'dmp_11',
        speaker: '小明',
        ...
        speakerColor: 'violet',
        hanzi: '蓝色的包。但是包里没有。',
        pinyin: 'Lánsè de bāo. Dànshì bāo lǐ méiyǒu.',
        french: 'Le sac bleu. Mais il n’est pas dans le sac.',
      },
      {
        id: 'dmp_12',
        speaker: '小红',
        ...
        speakerColor: 'turquoise',
        hanzi: '你去看看你的衣服里有没有。',
        pinyin: 'Nǐ qù kànkan nǐ de yīfu lǐ yǒu méiyǒu.',
        french: 'Va voir dans tes vêtements s’il y est.',
      },
      {
        id: 'dmp_13',
        speaker: '小明',
        speakerRole: 'Voyageur',
        speakerColor: 'violet',
        hanzi: '好，我去看看。……找到了！在我的衣服里！',
        pinyin: 'Hǎo, wǒ qù kànkan. ... Zhǎodào le! Zài wǒ de yīfu lǐ!',
        french: 'D’accord, je vais voir. ... Trouvé ! Il est dans mes vêtements !',
      },
      {
        id: 'dmp_14',
        speaker: '小红',
        speakerRole: 'Voyageuse',
        speakerColor: 'turquoise',
        hanzi: '太好了！我们走吧，飞机要飞了。',
        pinyin: 'Tài hǎo le! Wǒmen zǒu ba, fēijī yào fēi le.',
        french: 'Trop bien ! Partons, l’avion va décoller.',
      },
      {
        id: 'dmp_15',
        speaker: '小明',
        ...
        speakerColor: 'violet',
        hanzi: '好的，快走！',
        pinyin: 'Hǎo de, kuài zǒu!',
        french: 'D’accord, dépêchons-nous !',
      },
    ],
    vocabulary: [
      { hanzi: '护照', pinyin: 'hùzhào', french: 'passeport', role: 'Nom commun' },
      { hanzi: '桌子', pinyin: 'zhuōzi', french: 'table', role: 'Nom commun' },
      { hanzi: '找', pinyin: 'zhǎo', french: 'chercher', role: 'Verbe' },
      { hanzi: '书', pinyin: 'shū', french: 'livre', role: 'Nom commun' },
      { hanzi: '下面', pinyin: 'xiàmiàn', french: 'en dessous, sous', role: 'Nom de localisation' },
      { hanzi: '迟到', pinyin: 'chídào', french: 'être en retard', role: 'Verbe' },
      { hanzi: '急', pinyin: 'jí', french: 's’inquiéter (别急 = ne t’inquiète pas)', role: 'Adjectif / Verbe' },
      { hanzi: '用', pinyin: 'yòng', french: 'utiliser', role: 'Verbe' },
      { hanzi: '飞机票', pinyin: 'fēijīpiào', french: 'billet d’avion', role: 'Nom commun' },
      { hanzi: '包', pinyin: 'bāo', french: 'sac', role: 'Nom commun' },
      { hanzi: '黑色', pinyin: 'hēisè', french: 'noir', role: 'Nom commun / Couleur' },
      { hanzi: '蓝色', pinyin: 'lánsè', french: 'bleu', role: 'Nom commun / Couleur' },
      { hanzi: '衣服', pinyin: 'yīfu', french: 'vêtement', role: 'Nom commun' },
      { hanzi: '飞', pinyin: 'fēi', french: 'voler, décoller', role: 'Verbe' },
      { hanzi: '走', pinyin: 'zǒu', french: 'partir, marcher, aller', role: 'Verbe' },
    ]
  },
  ...
  // ---------- NIVEAU HSK 1 ----------
  {
    ...
    imageUrl: 'https://img.youtube.com/vi/ItPX_lJjyPE/hqdefault.jpg',
    iconBg: 'from-[#00897B] to-[#004D40]',
    sentences: [
      { id: 'ch3_1', section: 'Couplet 1', hanzi: '好一朵美丽的茉莉花', pinyin: 'Hǎo yì duǒ měilì de mòlihuā', french: 'Quelle ravissante fleur de jasmin' },
      { id: 'ch3_2', hanzi: '好一朵美丽的茉莉花', pinyin: 'Hǎo yì duǒ měilì de mòlihuā', french: 'Quelle ravissante fleur de jasmin' },
      { id: 'ch3_3', hanzi: '芬芳美丽满枝桠', pinyin: 'Fēnfāng měilì mǎn zhīyā', french: 'Parfumée et gracieuse sur la branche' },
      { id: 'ch3_4', hanzi: '又香又白人人夸', pinyin: 'Yòu xiāng yòu bái rén rén kuā', french: 'Si blanche et odorante, tous en font l’éloge' },
      { id: 'ch3_5', hanzi: '让我来将你摘下', pinyin: 'Ràng wǒ lái jiāng nǐ zhāi xià', french: 'Laisse-moi venir te cueillir' },
      { id: 'ch3_6', hanzi: '送给别人家', pinyin: 'Sòng gěi biérén jiā', french: 'Pour t’offrir à quelqu’un de cher' },
      { id: 'ch3_7', hanzi: '茉莉花呀茉莉花', pinyin: 'Mòlihuā ya mòlihuā', french: 'Ô fleur de jasmin, douce fleur de jasmin' },
      { id: 'ch3_8', section: 'Couplet 2', hanzi: '好一朵美丽的茉莉花', pinyin: 'Hǎo yì duǒ měilì de mòlihuā', french: 'Quelle ravissante fleur de jasmin' },
      { id: 'ch3_9', hanzi: '好一朵美丽的茉莉花', pinyin: 'Hǎo yì duǒ měilì de mòlihuā', french: 'Quelle ravissante fleur de jasmin' },
      { id: 'ch3_10', hanzi: '满园花草', pinyin: 'Mǎnyuán huācǎo', french: 'Dans tout le jardin fleuri' },
      { id: 'ch3_11', hanzi: '香也香不过它', pinyin: 'Xiāng yě xiāng búguò tā', french: 'Nulle fleur n’égale son parfum' },
      { id: 'ch3_12', hanzi: '我有心采下一朵戴', pinyin: 'Wǒ yǒuxīn cǎi xià yì duǒ dài', french: 'J’ai bien envie d’en cueillir une pour la porter' },
      { id: 'ch3_13', hanzi: '又怕看花的人儿骂', pinyin: 'Yòu pà kàn huā de rén’er mà', french: 'Mais je crains que le jardinier ne me gronde' },
      { id: 'ch3_14', hanzi: '茉莉花呀茉莉花', pinyin: 'Mòlihuā ya mòlihuā', french: 'Ô fleur de jasmin, précieuse fleur de jasmin' },
      { id: 'ch3_15', section: 'Couplet 3', hanzi: '好一朵美丽的茉莉花', pinyin: 'Hǎo yì duǒ měilì de mòlihuā', french: 'Quelle ravissante fleur de jasmin' },
      { id: 'ch3_16', hanzi: '好一朵美丽的茉莉花', pinyin: 'Hǎo yì duǒ měilì de mòlihuā', french: 'Quelle ravissante fleur de jasmin' },
      { id: 'ch3_17', hanzi: '满园花开', pinyin: 'Mǎnyuán huākāi', french: 'Toutes les fleurs écloses' },
      { id: 'ch3_18', hanzi: '比不过它', pinyin: 'Bǐ búguò tā', french: 'Ne rivalisent avec sa grâce' },
      { id: 'ch3_19', hanzi: '我有心采下一朵戴', pinyin: 'Wǒ yǒuxīn cǎi xià yì duǒ dài', french: 'J’aimerais en cueillir une pour la garder' },
      { id: 'ch3_20', hanzi: '又怕来年不发芽', pinyin: 'Yòu pà láinián bù fāyá', french: 'Mais je crains qu’elle ne bourgeonne plus l’an prochain' },
      { id: 'ch3_21', hanzi: '茉莉花呀茉莉花', pinyin: 'Mòlihuā ya mòlihuā', french: 'Ô fleur de jasmin, admirable fleur de jasmin' },
    ],
  },
  {
    id: 'chanson_tianmimi',
    ...
    imageUrl: 'https://img.youtube.com/vi/tc2tW0jFHPo/hqdefault.jpg',
    iconBg: 'from-[#00897B] to-[#004D40]',
    sentences: [
      { id: 'tm_1', section: 'Couplet 1', hanzi: '甜蜜蜜', pinyin: 'Tiánmìmì', french: 'Doux comme le miel' },
      { id: 'tm_2', hanzi: '你笑得甜蜜蜜', pinyin: 'Nǐ xiào de tiánmìmì', french: 'Ton sourire est doux comme le miel' },
      { id: 'tm_3', hanzi: '好像花儿开在春风里', pinyin: 'Hǎoxiàng huā’er kāi zài chūnfēng lǐ', french: 'Comme une fleur qui éclot dans la brise printanière' },
      { id: 'tm_4', hanzi: '开在春风里', pinyin: 'Kāi zài chūnfēng lǐ', french: 'Éclose dans la douce brise de printemps' },
      { id: 'tm_5', hanzi: '在哪里', pinyin: 'Zài nǎlǐ', french: 'Où donc ?' },
      { id: 'tm_6', hanzi: '在哪里见过你', pinyin: 'Zài nǎlǐ jiàn guò nǐ', french: 'Où t’ai-je déjà rencontré ?' },
      { id: 'tm_7', hanzi: '你的笑容这样熟悉', pinyin: 'Nǐ de xiàoróng zhèyàng shúxī', french: 'Ton sourire m’est tellement familier' },
      { id: 'tm_8', hanzi: '我一时想不起', pinyin: 'Wǒ yìshí xiǎng bù qǐ', french: 'Je n’arrive pas à m’en souvenir sur l’instant' },
      { id: 'tm_9', section: 'Refrain', hanzi: '啊', pinyin: 'A', french: 'Ah !' },
      { id: 'tm_10', hanzi: '在梦里', pinyin: 'Zài mèng lǐ', french: 'Dans un rêve !' },
      { id: 'tm_11', hanzi: '梦里', pinyin: 'Mèng lǐ', french: 'En rêve' },
      { id: 'tm_12', hanzi: '梦里见过你', pinyin: 'Mèng lǐ jiàn guò nǐ', french: 'Dans mes rêves je t’ai rencontré' },
      { id: 'tm_13', hanzi: '甜蜜', pinyin: 'Tiánmì', french: 'Si doux' },
      { id: 'tm_14', hanzi: '笑容多甜蜜', pinyin: 'Xiàoróng duō tiánmì', french: 'Quel sourire merveilleusement doux' },
      { id: 'tm_15', hanzi: '是你', pinyin: 'Shì nǐ', french: 'C’est toi' },
      { id: 'tm_16', hanzi: '是你', pinyin: 'Shì nǐ', french: 'C’est bien toi' },
      { id: 'tm_17', hanzi: '梦见的就是你', pinyin: 'Mèng jiàn de jiù shì nǐ', french: 'C’est bien toi dont j’avais rêvé' },
      { id: 'tm_18', hanzi: '在哪里', pinyin: 'Zài nǎlǐ', french: 'Où donc ?' },
      { id: 'tm_19', hanzi: '在哪里见过你', pinyin: 'Zài nǎlǐ jiàn guò nǐ', french: 'Où t’ai-je déjà rencontré ?' },
      { id: 'tm_20', hanzi: '你的笑容这样熟悉', pinyin: 'Nǐ de xiàoróng zhèyàng shúxī', french: 'Ton sourire m’est si familier' },
      { id: 'tm_21', hanzi: '我一时想不起', pinyin: 'Wǒ yìshí xiǎng bù qǐ', french: 'Je n’arrive pas à m’en rappeler sur le moment' },
      { id: 'tm_22', hanzi: '啊', pinyin: 'A', french: 'Ah !' },
      { id: 'tm_23', hanzi: '在梦里', pinyin: 'Zài mèng lǐ', french: 'Dans un doux rêve !' },
      { id: 'tm_24', section: 'Couplet 2', hanzi: '甜蜜蜜', pinyin: 'Tiánmìmì', french: 'Doux comme le miel' },
      { id: 'tm_25', hanzi: '你笑得甜蜜蜜', pinyin: 'Nǐ xiào de tiánmìmì', french: 'Ton sourire rayonne comme le miel' },
      { id: 'tm_26', hanzi: '好像花儿开在春风里', pinyin: 'Hǎoxiàng huā’er kāi zài chūnfēng lǐ', french: 'Comme une fleur qui s’épanouit au vent tiède' },
      { id: 'tm_27', hanzi: '开在春风里', pinyin: 'Kāi zài chūnfēng lǐ', french: 'Fleurie dans la brise printanière' },
      { id: 'tm_28', hanzi: '在哪里', pinyin: 'Zài nǎlǐ', french: 'Où donc ?' },
      { id: 'tm_29', hanzi: '在哪里见过你', pinyin: 'Zài nǎlǐ jiàn guò nǐ', french: 'Où t’ai-je déjà rencontré ?' },
      { id: 'tm_30', hanzi: '你的笑容这样熟悉', pinyin: 'Nǐ de xiàoróng zhèyàng shúxī', french: 'Ton visage m’est si familier' },
      { id: 'tm_31', hanzi: '我一时想不起', pinyin: 'Wǒ yìshí xiǎng bù qǐ', french: 'Je cherche encore dans mes souvenirs' },
      { id: 'tm_32', section: 'Refrain', hanzi: '啊', pinyin: 'A', french: 'Ah !' },
      { id: 'tm_33', hanzi: '在梦里', pinyin: 'Zài mèng lǐ', french: 'Dans un rêve !' },
      { id: 'tm_34', hanzi: '梦里', pinyin: 'Mèng lǐ', french: 'En rêve' },
      { id: 'tm_35', hanzi: '梦里见过你', pinyin: 'Mèng lǐ jiàn guò nǐ', french: 'En rêve je t’ai vu' },
      { id: 'tm_36', hanzi: '甜蜜', pinyin: 'Tiánmì', french: 'Si doux' },
      { id: 'tm_37', hanzi: '笑容多甜蜜', pinyin: 'Xiàoróng duō tiánmì', french: 'Quel lumineux et doux sourire' },
      { id: 'tm_39', hanzi: '是你', pinyin: 'Shì nǐ', french: 'C’est bien toi' },
      { id: 'tm_40', hanzi: '梦见的就是你', pinyin: 'Mèng jiàn de jiù shì nǐ', french: 'C’est toi mon rêve chéri' },
      { id: 'tm_41', hanzi: '在哪里', pinyin: 'Zài nǎlǐ', french: 'Où donc ?' },
      { id: 'tm_42', hanzi: '在哪里见过你', pinyin: 'Zài nǎlǐ jiàn guò nǐ', french: 'Où t’ai-je déjà rencontré ?' },
      { id: 'tm_43', hanzi: '你的笑容这样熟悉', pinyin: 'Nǐ de xiàoróng zhèyàng shúxī', french: 'Ton sourire familier me revient' },
      { id: 'tm_44', hanzi: '我一时想不起', pinyin: 'Wǒ yìshí xiǎng bù qǐ', french: 'Je cherche encore en moi' },
      { id: 'tm_45', hanzi: '啊', pinyin: 'A', french: 'Ah !' },
      { id: 'tm_46', hanzi: '在梦里', pinyin: 'Zài mèng lǐ', french: 'Dans un doux rêve !' },
    ],
  },
  {
    ...
    imageUrl: 'https://img.youtube.com/vi/oMEtryL1cLk/hqdefault.jpg',
    iconBg: 'from-[#00BFA5] to-[#004D40]',
    sentences: [
      { id: 'sa_1', section: 'Refrain', hanzi: '祝你生日快乐', pinyin: 'Zhù nǐ shēngrì kuàilè', french: 'Joyeux anniversaire à toi' },
      { id: 'sa_2', hanzi: '祝你生日快乐', pinyin: 'Zhù nǐ shēngrì kuàilè', french: 'Joyeux anniversaire à toi' },
      { id: 'sa_3', hanzi: '祝你生日快乐', pinyin: 'Zhù nǐ shēngrì kuàilè', french: 'Joyeux anniversaire à toi' },
      { id: 'sa_4', hanzi: '祝你生日快乐', pinyin: 'Zhù nǐ shēngrì kuàilè', french: 'Joyeux anniversaire à toi' },
      { id: 'sa_5', hanzi: '祝你生日快乐', pinyin: 'Zhù nǐ shēngrì kuàilè', french: 'Joyeux anniversaire à toi' },
      { id: 'sa_6', hanzi: '祝你生日快乐', pinyin: 'Zhù nǐ shēngrì kuàilè', french: 'Joyeux anniversaire à toi' },
      { id: 'sa_7', hanzi: '祝你生日快乐', pinyin: 'Zhù nǐ shēngrì kuàilè', french: 'Joyeux anniversaire à toi' },
      { id: 'sa_8', hanzi: '祝你生日快乐', pinyin: 'Zhù nǐ shēngrì kuàilè', french: 'Joyeux anniversaire à toi' },
    ],
  },
  ...
  // ---------- NIVEAU HSK 2 ----------
  {
    ...
    imageUrl: 'https://img.youtube.com/vi/IO9NIizev6M/hqdefault.jpg',
    iconBg: 'from-[#00897B] to-[#004D40]',
    sentences: [
      { id: 'bj_1', section: 'Couplet 1', hanzi: '迎接另一个晨曦', pinyin: 'Yíngjiē lìng yí gè chénxī', french: 'Accueillir une nouvelle aube' },
      { id: 'bj_2', hanzi: '带来全新空气', pinyin: 'Dàilái quánxīn kōngqì', french: 'Qui apporte un souffle tout neuf' },
      { id: 'bj_3', hanzi: '气息改变情味不变', pinyin: 'Qìxī gǎibiàn qíngwèi bú biàn', french: 'L’air se renouvelle mais la sincérité demeure' },
      { id: 'bj_4', hanzi: '茶香飘满情谊', pinyin: 'Cháxiāng piāomǎn qíngyì', french: 'Le parfum du thé déborde d’amitié' },
      { id: 'bj_5', hanzi: '我家大门常打开', pinyin: 'Wǒ jiā dàmén cháng dǎkāi', french: 'Les portes de ma maison sont grandes ouvertes' },
      { id: 'bj_6', hanzi: '开放怀抱等你', pinyin: 'Kāifàng huáibào děng nǐ', french: 'Je t’attends les bras grands ouverts' },
      { id: 'bj_7', hanzi: '拥抱过就有了默契', pinyin: 'Yōngbào guò jiù yǒu le mòqì', french: 'Une étreinte suffit pour nous comprendre' },
      { id: 'bj_8', hanzi: '你会爱上这里', pinyin: 'Nǐ huì ài shàng zhèlǐ', french: 'Tu tomberas amoureux de cet endroit' },
      { id: 'bj_9', hanzi: '不管远近都是客人', pinyin: 'Bùguǎn yuǎnjìn dōu shì kèrén', french: 'Que vous veniez de près ou de loin, vous êtes nos invités' },
      { id: 'bj_10', hanzi: '请不用客气', pinyin: 'Qǐng búyòng kèqi', french: 'Faites comme chez vous' },
      { id: 'bj_11', hanzi: '相约好了在一起', pinyin: 'Xiāngyuē hǎo le zài yìqǐ', french: 'Nous nous sommes donné rendez-vous ensemble' },
      { id: 'bj_12', hanzi: '我们欢迎你', pinyin: 'Wǒmen huānyíng nǐ', french: 'Nous vous souhaitons la bienvenue' },
      { id: 'bj_13', hanzi: '我家种着万年青', pinyin: 'Wǒ jiā zhòng zhe wànniánqīng', french: 'Chez nous pousse l’aglaonéma éternel' },
      { id: 'bj_14', hanzi: '开放每段传奇', pinyin: 'Kāifàng měi duàn chuánqí', french: 'Berceau de chaque légende fleurissante' },
      { id: 'bj_15', hanzi: '为传统的土壤播种', pinyin: 'Wèi chuántǒng de tǔrǎng bōzhòng', french: 'Semer sur cette terre millénaire' },
      { id: 'bj_16', hanzi: '为你留下回忆', pinyin: 'Wèi nǐ liúxià huíyì', french: 'Pour te laisser des souvenirs impérissables' },
      { id: 'bj_17', hanzi: '陌生熟悉都是客人', pinyin: 'Mòshēng shúxī dōu shì kèrén', french: 'Visages familiers ou nouveaux venus' },
      { id: 'bj_18', hanzi: '请不用拘礼', pinyin: 'Qǐng búyòng jūlǐ', french: 'Soyez à l’aise sans contrainte' },
      { id: 'bj_19', hanzi: '第几次来没关系', pinyin: 'Dì jǐ cì lái méi guānxì', french: 'Que ce soit votre première ou dixième visite' },
      { id: 'bj_20', hanzi: '有太多话题', pinyin: 'Yǒu tài duō huàtí', french: 'Nous avons tant d’histoires à partager' },
      { id: 'bj_21', section: 'Refrain', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_22', hanzi: '为你开天辟地', pinyin: 'Wèi nǐ kāitiānpìdì', french: 'Et déploie toute son énergie' },
      { id: 'bj_23', hanzi: '流动中的魅力充满着朝气', pinyin: 'Liúdòng zhōng de mèilì chōngmǎn zhe zhāoqì', french: 'Une ferveur pleine de vitalité' },
      { id: 'bj_24', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_25', hanzi: '在太阳下分享呼吸', pinyin: 'Zài tàiyáng xià fēnxiǎng hūxī', french: 'Partageons le même souffle' },
      { id: 'bj_26', hanzi: '在黄土地刷新成绩', pinyin: 'Zài huáng tǔdì shuāxīn chéngjì', french: 'Et bâtissons ensemble l’avenir' },
      { id: 'bj_27', section: 'Couplet 2', hanzi: '我家大门常打开', pinyin: 'Wǒ jiā dàmén cháng dǎkāi', french: 'Les portes de ma demeure sont grandes ouvertes' },
      { id: 'bj_28', hanzi: '开怀容纳天地', pinyin: 'Kāihuái róngnà tiāndì', french: 'Pour accueillir le monde à cœur ouvert' },
      { id: 'bj_29', hanzi: '岁月绽放青春笑容', pinyin: 'Suìyuè zhànfàng qīngchūn xiàoróng', french: 'Les années font éclore des sourires de jeunesse' },
      { id: 'bj_30', hanzi: '迎接这个日期', pinyin: 'Yíngjiē zhège rìqī', french: 'Pour célébrer ce grand jour' },
      { id: 'bj_31', hanzi: '天大地大都是朋友请不用客气', pinyin: 'Tiān dà dì dà dōushì péngyǒu qǐng búyòng kèqì', french: 'Sous ce vaste ciel, nous sommes tous amis, faites comme chez vous' },
      { id: 'bj_32', hanzi: '画意诗情带笑意', pinyin: 'Huàyì shīqíng dài xiàoyì', french: 'Dans la poésie et la joie partagée' },
      { id: 'bj_33', hanzi: '只为等待你', pinyin: 'Zhǐ wèi děngdài nǐ', french: 'Rien que pour vous attendre' },
      { id: 'bj_34', section: 'Refrain', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_35', hanzi: '像音乐感动你', pinyin: 'Xiàng yīnyuè gǎndòng nǐ', french: 'Comme une mélodie qui vous émeut' },
      { id: 'bj_36', hanzi: '让我们都加油去超越自己', pinyin: 'Ràng wǒmen dōu jiāyóu qù chāoyuè zìjǐ', french: 'Donnons le meilleur de nous pour nous dépasser' },
      { id: 'bj_37', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_38', hanzi: '有梦想谁都了不起', pinyin: 'Yǒu mèngxiǎng shéi dōu liǎobuqǐ', french: 'Quiconque a un rêve est formidable' },
      { id: 'bj_39', hanzi: '有勇气就会有奇迹', pinyin: 'Yǒu yǒngqì jiù huì yǒu qíjì', french: 'Avec du courage naissent les miracles' },
      { id: 'bj_40', section: 'Refrain', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_41', hanzi: '为你开天辟地', pinyin: 'Wèi nǐ kāitiānpìdì', french: 'Et déploie toute son énergie' },
      { id: 'bj_42', hanzi: '流动中的魅力充满着朝气', pinyin: 'Liúdòng zhōng de mèilì chōngmǎn zhe zhāoqì', french: 'Une ferveur pleine de vitalité' },
      { id: 'bj_43', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_44', hanzi: '在太阳下分享呼吸', pinyin: 'Zài tàiyáng xià fēnxiǎng hūxī', french: 'Partageons le même souffle' },
      { id: 'bj_45', hanzi: '在黄土地刷新成绩', pinyin: 'Zài huáng tǔdì shuāxīn chéngjì', french: 'Et bâtissons ensemble l’avenir' },
      { id: 'bj_46', section: 'Refrain', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_47', hanzi: '像音乐感动你', pinyin: 'Xiàng yīnyuè gǎndòng nǐ', french: 'Comme une mélodie qui vous émeut' },
      { id: 'bj_48', hanzi: '让我们都加油去超越自己', pinyin: 'Ràng wǒmen dōu jiāyóu qù chāoyuè zìjǐ', french: 'Donnons le meilleur de nous pour nous dépasser' },
      { id: 'bj_49', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_50', hanzi: '有梦想谁都了不起', pinyin: 'Yǒu mèngxiǎng shéi dōu liǎobuqǐ', french: 'Quiconque a un rêve est formidable' },
      { id: 'bj_51', hanzi: '有勇气就会有奇迹', pinyin: 'Yǒu yǒngqì jiù huì yǒu qíjì', french: 'Avec du courage naissent les miracles' },
      { id: 'bj_52', section: 'Couplet 3', hanzi: '我家大门常打开', pinyin: 'Wǒ jiā dàmén cháng dǎkāi', french: 'Les portes de ma maison sont grandes ouvertes' },
      { id: 'bj_53', hanzi: '开放怀抱等你', pinyin: 'Kāifàng huáibào děng nǐ', french: 'Je t’attends les bras grands ouverts' },
      { id: 'bj_54', hanzi: '拥抱过就有了默契', pinyin: 'Yōngbào guò jiù yǒu le mòqì', french: 'Une étreinte suffit pour nous comprendre' },
      { id: 'bj_55', hanzi: '你会爱上这里', pinyin: 'Nǐ huì ài shàng zhèlǐ', french: 'Tu tomberas amoureux de cet endroit' },
      { id: 'bj_56', hanzi: '不管远近都是客人', pinyin: 'Bùguǎn yuǎnjìn dōu shì kèrén', french: 'Que vous veniez de près ou de loin, vous êtes nos invités' },
      { id: 'bj_57', hanzi: '请不用客气', pinyin: 'Qǐng búyòng kèqi', french: 'Faites comme chez vous' },
      { id: 'bj_58', hanzi: '相约好了在一起', pinyin: 'Xiāngyuē hǎo le zài yìqǐ', french: 'Nous nous sommes donné rendez-vous ensemble' },
      { id: 'bj_59', hanzi: '我们欢迎你', pinyin: 'Wǒmen huānyíng nǐ', french: 'Nous vous souhaitons la bienvenue' },
      { id: 'bj_60', section: 'Refrain', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_61', hanzi: '为你开天辟地', pinyin: 'Wèi nǐ kāitiānpìdì', french: 'Et déploie toute son énergie' },
      { id: 'bj_62', hanzi: '流动中的魅力充满着朝气', pinyin: 'Liúdòng zhōng de mèilì chōngmǎn zhe zhāoqì', french: 'Une ferveur pleine de vitalité' },
      { id: 'bj_63', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_64', hanzi: '在太阳下分享呼吸', pinyin: 'Zài tàiyáng xià fēnxiǎng hūxī', french: 'Partageons le même souffle' },
      { id: 'bj_65', hanzi: '在黄土地刷新成绩', pinyin: 'Zài huáng tǔdì shuāxīn chéngjì', french: 'Et bâtissons ensemble l’avenir' },
      { id: 'bj_66', section: 'Couplet 4', hanzi: '我家大门常打开', pinyin: 'Wǒ jiā dàmén cháng dǎkāi', french: 'Les portes de ma demeure sont grandes ouvertes' },
      { id: 'bj_67', hanzi: '开怀容纳天地', pinyin: 'Kāihuái róngnà tiāndì', french: 'Pour accueillir le monde à cœur ouvert' },
      { id: 'bj_68', hanzi: '岁月绽放青春笑容', pinyin: 'Suìyuè zhànfàng qīngchūn xiàoróng', french: 'Les années font éclore des sourires de jeunesse' },
      { id: 'bj_69', hanzi: '迎接这个日期', pinyin: 'Yíngjiē zhège rìqī', french: 'Pour célébrer ce grand jour' },
      { id: 'bj_70', hanzi: '天大地大都是朋友请不用客气', pinyin: 'Tiān dà dì dà dōushì péngyǒu qǐng búyòng kèqì', french: 'Sous ce vaste ciel, nous sommes tous amis, faites comme chez vous' },
      { id: 'bj_71', hanzi: '画意诗情带笑意', pinyin: 'Huàyì shīqíng dài xiàoyì', french: 'Dans la poésie et la joie partagée' },
      { id: 'bj_72', hanzi: '只为等待你', pinyin: 'Zhǐ wèi děngdài nǐ', french: 'Rien que pour vous attendre' },
      { id: 'bj_73', section: 'Refrain', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_74', hanzi: '像音乐感动你', pinyin: 'Xiàng yīnyuè gǎndòng nǐ', french: 'Comme une mélodie qui vous émeut' },
      { id: 'bj_75', hanzi: '让我们都加油去超越自己', pinyin: 'Ràng wǒmen dōu jiāyóu qù chāoyuè zìjǐ', french: 'Donnons le meilleur de nous pour nous dépasser' },
      { id: 'bj_76', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_77', hanzi: '有梦想谁都了不起', pinyin: 'Yǒu mèngxiǎng shéi dōu liǎobuqǐ', french: 'Quiconque a un rêve est formidable' },
      { id: 'bj_78', hanzi: '有勇气就会有奇迹', pinyin: 'Yǒu yǒngqì jiù huì yǒu qíjì', french: 'Avec du courage naissent les miracles' },
      { id: 'bj_79', section: 'Refrain', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_80', hanzi: '为你开天辟地', pinyin: 'Wèi nǐ kāitiānpìdì', french: 'Et déploie toute son énergie' },
      { id: 'bj_81', hanzi: '流动中的魅力充满着朝气', pinyin: 'Liúdòng zhōng de mèilì chōngmǎn zhe zhāoqì', french: 'Une ferveur pleine de vitalité' },
      { id: 'bj_82', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_83', hanzi: '在太阳下分享呼吸', pinyin: 'Zài tàiyáng xià fēnxiǎng hūxī', french: 'Partageons le même souffle' },
      { id: 'bj_84', hanzi: '在黄土地刷新成绩', pinyin: 'Zài huáng tǔdì shuāxīn chéngjì', french: 'Et bâtissons ensemble l’avenir' },
      { id: 'bj_85', section: 'Refrain', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_86', hanzi: '像音乐感动你', pinyin: 'Xiàng yīnyuè gǎndòng nǐ', french: 'Comme une mélodie qui vous émeut' },
      { id: 'bj_87', hanzi: '让我们都加油去超越自己', pinyin: 'Ràng wǒmen dōu jiāyóu qù chāoyuè zìjǐ', french: 'Donnons le meilleur de nous pour nous dépasser' },
      { id: 'bj_88', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_89', hanzi: '有梦想谁都了不起', pinyin: 'Yǒu mèngxiǎng shéi dōu liǎobuqǐ', french: 'Quiconque a un rêve est formidable' },
      { id: 'bj_90', hanzi: '有勇气就会有奇迹', pinyin: 'Yǒu yǒngqì jiù huì yǒu qíjì', french: 'Avec du courage naissent les miracles' },
      { id: 'bj_91', section: 'Refrain', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_92', hanzi: '有梦想谁都了不起', pinyin: 'Yǒu mèngxiǎng shéi dōu liǎobuqǐ', french: 'Quiconque a un rêve est formidable' },
      { id: 'bj_93', hanzi: '有勇气就会有奇迹', pinyin: 'Yǒu yǒngqì jiù huì yǒu qíjì', french: 'Avec du courage naissent les miracles' },
      { id: 'bj_94', section: 'Refrain', hanzi: '北京欢迎你', pinyin: 'Běijīng huānyíng nǐ', french: 'Pékin vous accueille' },
      { id: 'bj_95', hanzi: '有梦想谁都了不起', pinyin: 'Yǒu mèngxiǎng shéi dōu liǎobuqǐ', french: 'Quiconque a un rêve est formidable' },
      { id: 'bj_96', hanzi: '有勇气就会有奇迹', pinyin: 'Yǒu yǒngqì jiù huì yǒu qíjì', french: 'Avec du courage naissent les miracles' },
    ],
  },
  {
    id: 'chanson_moon',
    ...
    imageUrl: 'https://img.youtube.com/vi/IiFm7AWP9n4/hqdefault.jpg',
    iconBg: 'from-[#00897B] to-[#004D40]',
    sentences: [
      { id: 'ch1_1', section: 'Couplet 1', hanzi: '你问我爱你有多深', pinyin: 'Nǐ wèn wǒ ài nǐ yǒu duō shēn', french: 'Tu me demandes à quel point je t’aime' },
      { id: 'ch1_2', hanzi: '我爱你有几分', pinyin: 'Wǒ ài nǐ yǒu jǐ fēn', french: 'Quelle est la profondeur de mon amour' },
      { id: 'ch1_3', hanzi: '我的情也真', pinyin: 'Wǒ de qíng yě zhēn', french: 'Mes sentiments sont d’une absolue sincérité' },
      { id: 'ch1_4', hanzi: '我的爱也真', pinyin: 'Wǒ de ài yě zhēn', french: 'Mon amour est profondément vrai' },
      { id: 'ch1_5', hanzi: '月亮代表我的心', pinyin: 'Yuèliang dàibiǎo wǒ de xīn', french: 'La lune représente fidèlement mon cœur' },
      { id: 'ch1_6', section: 'Couplet 2', hanzi: '你问我爱你有多深', pinyin: 'Nǐ wèn wǒ ài nǐ yǒu duō shēn', french: 'Tu me demandes à quel point je t’aime' },
      { id: 'ch1_7', hanzi: '我爱你有几分', pinyin: 'Wǒ ài nǐ yǒu jǐ fēn', french: 'Quelle est la force de mes sentiments' },
      { id: 'ch1_8', hanzi: '我的情不移', pinyin: 'Wǒ de qíng bù yí', french: 'Mes sentiments ne faibliront jamais' },
      { id: 'ch1_9', hanzi: '我的爱不变', pinyin: 'Wǒ de ài bú biàn', french: 'Mon amour ne changera jamais' },
      { id: 'ch1_10', hanzi: '月亮代表我的心', pinyin: 'Yuèliang dàibiǎo wǒ de xīn', french: 'La lune représente la pureté de mon cœur' },
      { id: 'ch1_11', section: 'Refrain', hanzi: '轻轻的一个吻', pinyin: 'Qīngqīng de yí gè wěn', french: 'Un baiser si doux et léger' },
      { id: 'ch1_12', hanzi: '已经打动我的心', pinyin: 'Yǐjīng dǎdòng wǒ de xīn', french: 'A déjà profondément touché mon cœur' },
      { id: 'ch1_13', hanzi: '深深的一段情', pinyin: 'Shēnshēn de yí duàn qíng', french: 'Une histoire d’amour si profonde' },
      { id: 'ch1_14', hanzi: '叫我思念到如今', pinyin: 'Jiào wǒ sīniàn dào rújīn', french: 'Me fait penser tendrement à toi jusqu’à aujourd’hui' },
      { id: 'ch1_15', section: 'Couplet 3', hanzi: '你问我爱你有多深', pinyin: 'Nǐ wèn wǒ ài nǐ yǒu duō shēn', french: 'Tu me demandes à quel point je t’aime' },
      { id: 'ch1_16', hanzi: '我爱你有几分', pinyin: 'Wǒ ài nǐ yǒu jǐ fēn', french: 'Quelle est la sincérité de mon attachement' },
      { id: 'ch1_17', hanzi: '你去想一想', pinyin: 'Nǐ qù xiǎng yi xiǎng', french: 'Prends le temps d’y réfléchir' },
      { id: 'ch1_18', hanzi: '你去看一看', pinyin: 'Nǐ qù kàn yi kàn', french: 'Lève les yeux vers la lune' },
      { id: 'ch1_19', hanzi: '月亮代表我的心', pinyin: 'Yuèliang dàibiǎo wǒ de xīn', french: 'La lune représente mon cœur éternel' },
      { id: 'ch1_20', section: 'Refrain', hanzi: '轻轻的一个吻', pinyin: 'Qīngqīng de yí gè wěn', french: 'Un baiser si doux et délicat' },
      { id: 'ch1_21', hanzi: '已经打动我的心', pinyin: 'Yǐjīng dǎdòng wǒ de xīn', french: 'A fait chavirer mon âme' },
      { id: 'ch1_22', hanzi: '深深的一段情', pinyin: 'Shēnshēn de yí duàn qíng', french: 'Ce sentiment si pur et sincère' },
      { id: 'ch1_23', hanzi: '叫我思念到如今', pinyin: 'Jiào wǒ sīniàn dào rújīn', french: 'Nourrit mon souvenir jusqu’à ce jour' },
      { id: 'ch1_24', section: 'Couplet 4', hanzi: '你问我爱你有多深', pinyin: 'Nǐ wèn wǒ ài nǐ yǒu duō shēn', french: 'Tu me demandes à quel point je t’aime' },
      { id: 'ch1_25', hanzi: '我爱你有几分', pinyin: 'Wǒ ài nǐ yǒu jǐ fēn', french: 'Quelle est l’intensité de mon amour' },
      { id: 'ch1_26', hanzi: '你去想一想', pinyin: 'Nǐ qù xiǎng yi xiǎng', french: 'Penses-y un instant' },
      { id: 'ch1_27', hanzi: '你去看一看', pinyin: 'Nǐ qù kàn yi kàn', french: 'Contemple la clarté du ciel' },
      { id: 'ch1_28', hanzi: '月亮代表我的心', pinyin: 'Yuèliang dàibiǎo wǒ de xīn', french: 'La lune représente fidèlement mon cœur' },
      { id: 'ch1_29', hanzi: '你去想一想', pinyin: 'Nǐ qù xiǎng yi xiǎng', french: 'Penses-y toujours' },
      { id: 'ch1_30', hanzi: '你去看一看', pinyin: 'Nǐ qù kàn yi kàn', french: 'Regarde le ciel nocturne' },
      { id: 'ch1_31', hanzi: '月亮代表我的心', pinyin: 'Yuèliang dàibiǎo wǒ de xīn', french: 'La lune est le témoin éternel de mon cœur' },
    ],
  },
  {
    id: 'chanson_pengyou',
    ...
    imageUrl: 'https://img.youtube.com/vi/6lbPgfKK7m4/hqdefault.jpg',
    iconBg: 'from-[#00897B] to-[#004D40]',
    sentences: [
      { id: 'ch2_1', section: 'Couplet 1', hanzi: '这些年', pinyin: 'Zhèxiē nián', french: 'Ces dernières années' },
      { id: 'ch2_2', hanzi: '一个人', pinyin: 'Yí gè rén', french: 'Passées tout seul' },
      { id: 'ch2_3', hanzi: '风也过', pinyin: 'Fēng yě guò', french: 'À traverser les vents' },
      { id: 'ch2_4', hanzi: '雨也走', pinyin: 'Yǔ yě zǒu', french: 'Et les tempêtes de pluie' },
      { id: 'ch2_5', hanzi: '有过泪', pinyin: 'Yǒu guò lèi', french: 'Il y a eu des larmes' },
      { id: 'ch2_6', hanzi: '有过错', pinyin: 'Yǒu guò cuò', french: 'Il y a eu des erreurs' },
      { id: 'ch2_7', hanzi: '还记得坚持什么', pinyin: 'Hái jìde jiānchí shénme', french: 'Mais je me souviens de nos idéaux' },
      { id: 'ch2_8', hanzi: '真爱过', pinyin: 'Zhēn ài guò', french: 'Après avoir aimé sincèrement' },
      { id: 'ch2_9', hanzi: '才会懂', pinyin: 'Cái huì dǒng', french: 'On comprend enfin' },
      { id: 'ch2_10', hanzi: '会寂寞', pinyin: 'Huì jìmò', french: 'La solitude' },
      { id: 'ch2_11', hanzi: '会回首', pinyin: 'Huì huíshǒu', french: 'Et les regards en arrière' },
      { id: 'ch2_12', hanzi: '终有梦', pinyin: 'Zhōng yǒu mèng', french: 'Il reste toujours un rêve' },
      { id: 'ch2_13', hanzi: '终有你在心中', pinyin: 'Zhōng yǒu nǐ zài xīn zhōng', french: 'Et ton souvenir ancré en mon cœur' },
      { id: 'ch2_14', section: 'Refrain', hanzi: '朋友一生一起走', pinyin: 'Péngyǒu yìshēng yìqǐ zǒu', french: 'Les vrais amis cheminent ensemble toute la vie' },
      { id: 'ch2_15', hanzi: '那些日子不再有', pinyin: 'Nàxiē rìzi bú zài yǒu', french: 'Ces jours précieux ne reviendront plus' },
      { id: 'ch2_16', hanzi: '一句话', pinyin: 'Yí jù huà', french: 'Une seule parole' },
      { id: 'ch2_17', hanzi: '一辈子', pinyin: 'Yí bèizi', french: 'Pour toute la vie' },
      { id: 'ch2_18', hanzi: '一生情', pinyin: 'Yì shēng qíng', french: 'Une amitié sincère' },
      { id: 'ch2_19', hanzi: '一杯酒', pinyin: 'Yì bēi jiǔ', french: 'Scellée par un verre' },
      { id: 'ch2_20', hanzi: '朋友不曾孤单过', pinyin: 'Péngyǒu bùcéng gūdān guò', french: 'Entre amis on n’est jamais seul' },
      { id: 'ch2_21', hanzi: '一声朋友你会懂', pinyin: 'Yì shēng péngyǒu nǐ huì dǒng', french: 'Un mot fraternel et tu comprends tout' },
      { id: 'ch2_22', hanzi: '还有伤', pinyin: 'Hái yǒu shāng', french: 'Même avec des peines' },
      { id: 'ch2_23', hanzi: '还有痛', pinyin: 'Hái yǒu tòng', french: 'Et des blessures' },
      { id: 'ch2_24', hanzi: '还要走', pinyin: 'Hái yào zǒu', french: 'Nous continuerons d’avancer' },
      { id: 'ch2_25', hanzi: '还有我', pinyin: 'Hái yǒu wǒ', french: 'Tu peux toujours compter sur moi' },
      { id: 'ch2_26', section: 'Couplet 2', hanzi: '这些年', pinyin: 'Zhèxiē nián', french: 'Ces dernières années' },
      { id: 'ch2_27', hanzi: '一个人', pinyin: 'Yí gè rén', french: 'Solitaire sur la route' },
      { id: 'ch2_28', hanzi: '风也过', pinyin: 'Fēng yě guò', french: 'Face aux vents' },
      { id: 'ch2_29', hanzi: '雨也走', pinyin: 'Yǔ yě zǒu', french: 'Et sous les orages' },
      { id: 'ch2_30', hanzi: '有过泪', pinyin: 'Yǒu guò lèi', french: 'Des larmes versées' },
      { id: 'ch2_31', hanzi: '有过错', pinyin: 'Yǒu guò cuò', french: 'Des maladresses passées' },
      { id: 'ch2_32', hanzi: '还记得坚持什么', pinyin: 'Hái jìde jiānchí shénme', french: 'Gardant intacte notre force' },
      { id: 'ch2_33', hanzi: '真爱过', pinyin: 'Zhēn ài guò', french: 'L’amour véritable' },
      { id: 'ch2_34', hanzi: '才会懂', pinyin: 'Cái huì dǒng', french: 'Nous éclaire enfin' },
      { id: 'ch2_35', hanzi: '会寂寞', pinyin: 'Huì jìmò', french: 'Dans les moments de solitude' },
      { id: 'ch2_36', hanzi: '会回首', pinyin: 'Huì huíshǒu', french: 'Quand on songe au passé' },
      { id: 'ch2_37', hanzi: '终有梦', pinyin: 'Zhōng yǒu mèng', french: 'Il reste un grand rêve' },
      { id: 'ch2_38', hanzi: '终有你在心中', pinyin: 'Zhōng yǒu nǐ zài xīn zhōng', french: 'Et ton amitié au fond de mon cœur' },
      { id: 'ch2_39', section: 'Refrain', hanzi: '朋友一生一起走', pinyin: 'Péngyǒu yìshēng yìqǐ zǒu', french: 'Les amis cheminent côte à côte' },
      { id: 'ch2_40', hanzi: '那些日子不再有', pinyin: 'Nàxiē rìzi bú zài yǒu', french: 'Chérissons ces jours uniques' },
      { id: 'ch2_41', hanzi: '一句话', pinyin: 'Yí jù huà', french: 'Une seule parole' },
      { id: 'ch2_42', hanzi: '一辈子', pinyin: 'Yí bèizi', french: 'Pour l’existence entière' },
      { id: 'ch2_43', hanzi: '一生情', pinyin: 'Yì shēng qíng', french: 'Une fraternité pure' },
      { id: 'ch2_44', hanzi: '一杯酒', pinyin: 'Yì bēi jiǔ', french: 'Pour l’éternité' },
      { id: 'ch2_45', hanzi: '朋友不曾孤单过', pinyin: 'Péngyǒu bùcéng gūdān guò', french: 'Un véritable ami est toujours là' },
      { id: 'ch2_46', hanzi: '一声朋友你会懂', pinyin: 'Yì shēng péngyǒu nǐ huì dǒng', french: 'Il suffit d’un appel et tu comprends' },
      { id: 'ch2_47', hanzi: '还有伤', pinyin: 'Hái yǒu shāng', french: 'Malgré les blessures' },
      { id: 'ch2_48', hanzi: '还有痛', pinyin: 'Hái yǒu tòng', french: 'Et les épreuves' },
      { id: 'ch2_49', hanzi: '还要走', pinyin: 'Hái yào zǒu', french: 'Nous irons de l’avant' },
      { id: 'ch2_50', hanzi: '还有我', pinyin: 'Hái yǒu wǒ', french: 'Je serai toujours à tes côtés' },
      { id: 'ch2_51', section: 'Refrain', hanzi: '朋友一生一起走', pinyin: 'Péngyǒu yìshēng yìqǐ zǒu', french: 'Les amis marchent ensemble pour toujours' },
      { id: 'ch2_52', hanzi: '那些日子不再有', pinyin: 'Nàxiē rìzi bú zài yǒu', french: 'Ces précieux moments sont gravés' },
      { id: 'ch2_53', hanzi: '一句话', pinyin: 'Yí jù huà', french: 'Une parole' },
      { id: 'ch2_54', hanzi: '一辈子', pinyin: 'Yí bèizi', french: 'Toute une existence' },
      { id: 'ch2_55', hanzi: '一生情', pinyin: 'Yì shēng qíng', french: 'Une fraternité pure' },
      { id: 'ch2_56', hanzi: '一杯酒', pinyin: 'Yì bēi jiǔ', french: 'Scellée à jamais' },
      { id: 'ch2_57', hanzi: '朋友不曾孤单过', pinyin: 'Péngyǒu bùcéng gūdān guò', french: 'Un véritable ami est toujours là' },
      { id: 'ch2_58', hanzi: '一声朋友你会懂', pinyin: 'Yì shēng péngyǒu nǐ huì dǒng', french: 'Il suffit d’un appel et tu comprends' },
      { id: 'ch2_59', hanzi: '还有伤', pinyin: 'Hái yǒu shāng', french: 'Malgré les blessures' },
      { id: 'ch2_60', hanzi: '还有痛', pinyin: 'Hái yǒu tòng', french: 'Et les épreuves' },
      { id: 'ch2_61', hanzi: '还要走', pinyin: 'Hái yào zǒu', french: 'Nous irons de l’avant' },
      { id: 'ch2_62', hanzi: '还有我', pinyin: 'Hái yǒu wǒ', french: 'Je serai toujours à tes côtés' },
      { id: 'ch2_63', section: 'Refrain', hanzi: '一句话', pinyin: 'Yí jù huà', french: 'Une parole' },
      { id: 'ch2_64', hanzi: '一辈子', pinyin: 'Yí bèizi', french: 'Toute une existence' },
      { id: 'ch2_65', hanzi: '一生情', pinyin: 'Yì shēng qíng', french: 'Une fraternité pure' },
      { id: 'ch2_66', hanzi: '一杯酒', pinyin: 'Yì bēi jiǔ', french: 'Scellée à jamais' },
    ],
  },
  {
    id: 'chanson_wings',
    ...
    imageUrl: 'https://img.youtube.com/vi/be2wvNFTLMc/hqdefault.jpg',
    iconBg: 'from-[#00897B] to-[#004D40]',
    sentences: [
      { id: 'wg_1', section: 'Couplet 1', hanzi: '每一次', pinyin: 'Měi yí cì', french: 'Chaque fois' },
      { id: 'wg_2', hanzi: '都在徘徊孤单中坚强', pinyin: 'Dōu zài páihuái gūdān zhōng jiānqiáng', french: 'Je trouve ma force au milieu du doute et de la solitude' },
      { id: 'wg_3', hanzi: '每一次', pinyin: 'Měi yí cì', french: 'Chaque fois' },
      { id: 'wg_4', hanzi: '就算很受伤也不闪泪光', pinyin: 'Jiùsuàn hěn shòushāng yě bù shǎn lèiguāng', french: 'Même blessée, je ne laisse pas couler mes larmes' },
      { id: 'wg_5', hanzi: '我知道', pinyin: 'Wǒ zhīdào', french: 'Je sais' },
      { id: 'wg_6', hanzi: '我一直有双隐形的翅膀', pinyin: 'Wǒ yìzhí yǒu shuāng yǐnxíng de chìbǎng', french: 'Que je possède depuis toujours une paire d’ailes invisibles' },
      { id: 'wg_7', hanzi: '带我飞', pinyin: 'Dài wǒ fēi', french: 'Pour m’envoler' },
      { id: 'wg_8', hanzi: '飞过绝望', pinyin: 'Fēi guò juéwàng', french: 'Au-dessus du désespoir' },
      { id: 'wg_9', section: 'Couplet 2', hanzi: '不去想', pinyin: 'Bú qù xiǎng', french: 'Sans envier' },
      { id: 'wg_10', hanzi: '他们拥有美丽的太阳', pinyin: 'Tāmen yōngyǒu měilì de tàiyáng', french: 'Le soleil éclatant des autres' },
      { id: 'wg_11', hanzi: '我看见', pinyin: 'Wǒ kànjiàn', french: 'Je contemple' },
      { id: 'wg_12', hanzi: '每天的夕阳也会有变化', pinyin: 'Měitiān de xīyáng yě huì yǒu biànhuà', french: 'Les couleurs magnifiques et changeantes du couchant' },
      { id: 'wg_13', hanzi: '我知道', pinyin: 'Wǒ zhīdào', french: 'Je sais' },
      { id: 'wg_14', hanzi: '我一直有双隐形的翅膀', pinyin: 'Wǒ yìzhí yǒu shuāng yǐnxíng de chìbǎng', french: 'Que je porte au fond de moi des ailes secrètes' },
      { id: 'wg_15', hanzi: '带我飞', pinyin: 'Dài wǒ fēi', french: 'Qui me font voler' },
      { id: 'wg_16', hanzi: '给我希望', pinyin: 'Gěi wǒ xīwàng', french: 'Et me remplissent d’espérance' },
      { id: 'wg_17', section: 'Refrain', hanzi: '我终于', pinyin: 'Wǒ zhōngyú', french: 'Je vois enfin' },
      { id: 'wg_18', hanzi: '看到所有梦想都开花', pinyin: 'Kàndào suǒyǒu mèngxiǎng dōu kāihuā', french: 'Tous mes rêves éclore comme des fleurs' },
      { id: 'wg_19', hanzi: '追逐的年轻', pinyin: 'Zhuīzhú de niánqīng', french: 'La jeunesse passionnée' },
      { id: 'wg_20', hanzi: '歌声多嘹亮', pinyin: 'Gēshēng duō liáoliàng', french: 'Chante d’une voix claire et retentissante' },
      { id: 'wg_21', hanzi: '我终于', pinyin: 'Wǒ zhōngyú', french: 'Je m’élève enfin' },
      { id: 'wg_22', hanzi: '翱翔用心凝望不害怕', pinyin: 'Áoxiáng yòngxīn níngwàng bú hàipà', french: 'Dans les airs, le regard serein et sans crainte' },
      { id: 'wg_23', hanzi: '哪里会有风', pinyin: 'Nǎlǐ huì yǒu fēng', french: 'Partout où le vent soufflera' },
      { id: 'wg_24', hanzi: '就飞多远吧', pinyin: 'Jiù fēi duō yuǎn ba', french: 'Je volerai sans limites' },
      { id: 'wg_25', section: 'Couplet 3', hanzi: '不去想', pinyin: 'Bú qù xiǎng', french: 'Sans envier' },
      { id: 'wg_26', hanzi: '他们拥有美丽的太阳', pinyin: 'Tāmen yōngyǒu měilì de tàiyáng', french: 'La clarté éclatante des autres' },
      { id: 'wg_27', hanzi: '我看见', pinyin: 'Wǒ kànjiàn', french: 'Je contemple' },
      { id: 'wg_28', hanzi: '每天的夕阳也会有变化', pinyin: 'Měitiān de xīyáng yě huì yǒu biànhuà', french: 'Chaque crépuscule qui apporte ses promesses' },
      { id: 'wg_29', hanzi: '我知道', pinyin: 'Wǒ zhīdào', french: 'Je sais' },
      { id: 'wg_30', hanzi: '我一直有双隐形的翅膀', pinyin: 'Wǒ yìzhí yǒu shuāng yǐnxíng de chìbǎng', french: 'Mes ailes invisibles me guident' },
      { id: 'wg_31', hanzi: '带我飞', pinyin: 'Dài wǒ fēi', french: 'Elles me portent' },
      { id: 'wg_32', hanzi: '给我希望', pinyin: 'Gěi wǒ xīwàng', french: 'Et soutiennent mes pas' },
      { id: 'wg_33', section: 'Refrain', hanzi: '我终于', pinyin: 'Wǒ zhōngyú', french: 'Mes aspirations' },
      { id: 'wg_34', hanzi: '看到所有梦想都开花', pinyin: 'Kàndào suǒyǒu mèngxiǎng dōu kāihuā', french: 'S’épanouissent enfin au grand jour' },
      { id: 'wg_35', hanzi: '追逐的年轻', pinyin: 'Zhuīzhú de niánqīng', french: 'Les chants de nos élans' },
      { id: 'wg_36', hanzi: '歌声多嘹亮', pinyin: 'Gēshēng duō liáoliàng', french: 'Résonnent avec pureté' },
      { id: 'wg_37', hanzi: '我终于', pinyin: 'Wǒ zhōngyú', french: 'Je plane dans l’azur' },
      { id: 'wg_38', hanzi: '翱翔用心凝望不害怕', pinyin: 'Áoxiáng yòngxīn níngwàng bú hàipà', french: 'Sans aucune hésitation' },
      { id: 'wg_39', hanzi: '哪里会有风', pinyin: 'Nǎlǐ huì yǒu fēng', french: 'Vers tous les horizons' },
      { id: 'wg_40', hanzi: '就飞多远吧', pinyin: 'Jiù fēi duō yuǎn ba', french: 'Où souffle le vent bienfaisant' },
      { id: 'wg_41', hanzi: '隐形的翅膀', pinyin: 'Yǐnxíng de chìbǎng', french: 'Ces ailes invisibles' },
      { id: 'wg_42', hanzi: '让梦恒久比天长', pinyin: 'Ràng mèng héngjiǔ bǐ tiān cháng', french: 'Rendent nos rêves plus infinis que le ciel' },
      { id: 'wg_43', hanzi: '留一个愿望', pinyin: 'Liú yí gè yuànwàng', french: 'Offrant un vœu précieux' },
      { id: 'wg_44', hanzi: '让你自己想像', pinyin: 'Ràng nǐ zìjǐ xiǎngxiàng', french: 'À ton imagination la plus haute' },
    ],
  },
  {
    id: 'chanson_nanshuo',
    ...
    imageUrl: 'https://img.youtube.com/vi/2cKrIXnRDG8/hqdefault.jpg',
    iconBg: 'from-[#00897B] to-[#004D40]',
    sentences: [
      // Couplet 1
      { id: 'ns_1', section: 'Couplet 1', hanzi: '习惯幕起幕落', pinyin: 'Xíguàn mù qǐ mù luò', french: 'Habitué au lever et au coucher de rideau' },
      { id: 'ns_2', hanzi: '总以为明天还很多', pinyin: 'Zǒng yǐwéi míngtiān hái hěn duō', french: 'Pensant toujours que les lendemains seraient infinis' },
      { id: 'ns_3', hanzi: '没想到这笑脸', pinyin: 'Méi xiǎngdào zhè xiàoliǎn', french: 'Je ne pensais pas que ces sourires' },
      { id: 'ns_4', hanzi: '会让我难过', pinyin: 'Huì ràng wǒ nánguò', french: 'Me serreraient autant le cœur' },
      { id: 'ns_5', hanzi: '习惯一起走过', pinyin: 'Xíguàn yìqǐ zǒu guò', french: 'Habitué à cheminer côte à côte' },
      { id: 'ns_6', hanzi: '没想你不在的生活', pinyin: 'Méi xiǎng nǐ bú zài de shēnghuó', french: 'Sans imaginer ma vie loin de ta présence' },
      { id: 'ns_7', hanzi: '泪雨也是阳光闪烁', pinyin: 'Lèiyǔ yě shì yángguāng shǎnshuò', french: 'Même sous les larmes brille le soleil' },
      { id: 'ns_8', hanzi: '是避风的角落', pinyin: 'Shì bìfēng de jiǎoluò', french: 'Tu as été mon havre de paix' },
      { id: 'ns_9', hanzi: '离开会成最美的洒脱', pinyin: 'Líkāi huì chéng zuì měi de sǎtuō', french: 'Le départ deviendra la plus noble des élégances' },
      { id: 'ns_10', hanzi: '眼是心的守诺', pinyin: 'Yǎn shì xīn de shǒunuò', french: 'Le regard est le serment fidèle de nos âmes' },
      { id: 'ns_11', hanzi: '我和你不逃过', pinyin: 'Wǒ hé nǐ bù táoguò', french: 'Toi et moi ne reculons jamais' },
      { id: 'ns_12', hanzi: '你是我一辈子的收获', pinyin: 'Nǐ shì wǒ yí bèizi de shōuhuò', french: 'Tu es le plus grand trésor de toute mon existence' },

      // Refrain 1
      { id: 'ns_13', section: 'Refrain', hanzi: '难说再见', pinyin: 'Nán shuō zàijiàn', french: 'Difficile de se dire au revoir' },
      { id: 'ns_14', hanzi: '你的微笑遗落在我眼前', pinyin: 'Nǐ de wēixiào yíluò zài wǒ yǎnqián', french: 'Ton doux sourire reste gravé devant mes yeux' },
      { id: 'ns_15', hanzi: '难说再见', pinyin: 'Nán shuō zàijiàn', french: 'Difficile de se dire adieu' },
      { id: 'ns_16', hanzi: '永远不忘转身瞬间', pinyin: 'Yǒngyuǎn bú wàng zhuǎnshēn shùnjiān', french: 'Je n’oublierai jamais l’instant où tu t’es retourné' },
      { id: 'ns_17', hanzi: '海阔天空在明天', pinyin: 'Hǎikuòtiānkōng zài míngtiān', french: 'Un horizon infini nous attend demain' },
      { id: 'ns_18', hanzi: '再相见', pinyin: 'Zài xiāngjiàn', french: 'Nous nous retrouverons !' },

      // Couplet 2
      { id: 'ns_19', section: 'Couplet 2', hanzi: '习惯一起走过', pinyin: 'Xíguàn yìqǐ zǒu guò', french: 'Habitué à traverser chaque étape ensemble' },
      { id: 'ns_20', hanzi: '没想你不在的生活', pinyin: 'Méi xiǎng nǐ bú zài de shēnghuó', french: 'Sans songer à la vie loin de toi' },
      { id: 'ns_21', hanzi: '泪雨也是阳光闪烁', pinyin: 'Lèiyǔ yě shì yángguāng shǎnshuò', french: 'Sous les larmes brille toujours la clarté' },
      { id: 'ns_22', hanzi: '是避风的角落', pinyin: 'Shì bìfēng de jiǎoluò', french: 'Un refuge doux et protecteur' },

      // Pré-refrain 2
      { id: 'ns_23', hanzi: '离开会成最美的洒脱', pinyin: 'Líkāi huì chéng zuì měi de sǎtuō', french: 'Le départ deviendra la plus belle des libertés' },
      { id: 'ns_24', hanzi: '眼是心的守诺', pinyin: 'Yǎn shì xīn de shǒunuò', french: 'Le regard est la promesse sacrée du cœur' },
      { id: 'ns_25', hanzi: '我和你不逃过', pinyin: 'Wǒ hé nǐ bù táoguò', french: 'Toi et moi restons inébranlables' },
      { id: 'ns_26', hanzi: '你是我一辈子的收获', pinyin: 'Nǐ shì wǒ yí bèizi de shōuhuò', french: 'Tu es la plus belle richesse de mon existence' },

      // Refrain 2
      { id: 'ns_27', section: 'Refrain', hanzi: '难说再见', pinyin: 'Nán shuō zàijiàn', french: 'Difficile de se dire au revoir' },
      { id: 'ns_28', hanzi: '你的微笑遗落在我眼前', pinyin: 'Nǐ de wēixiào yíluò zài wǒ yǎnqián', french: 'Ton visage souriant m’accompagne partout' },
      { id: 'ns_29', hanzi: '难说再见', pinyin: 'Nán shuō zàijiàn', french: 'Difficile de se dire adieu' },
      { id: 'ns_30', hanzi: '永远不忘转身瞬间', pinyin: 'Yǒngyuǎn bú wàng zhuǎnshēn shùnjiān', french: 'Jamais je n’oublierai l’instant de nos adieux' },
      { id: 'ns_31', hanzi: '海阔天空在明天', pinyin: 'Hǎikuòtiānkōng zài míngtiān', french: 'Sous un ciel radieux et infini' },
      { id: 'ns_32', hanzi: '再相见', pinyin: 'Zài xiāngjiàn', french: 'Nous nous reverrons demain !' },

      // Refrain 3 (Climax & Fin)
      { id: 'ns_33', section: 'Refrain', hanzi: '难说再见', pinyin: 'Nán shuō zàijiàn', french: 'Difficile de se quitter' },
      { id: 'ns_34', hanzi: '你的微笑遗落在我眼前', pinyin: 'Nǐ de wēixiào yíluò zài wǒ yǎnqián', french: 'Ton doux sourire veille sur mes pas' },
      { id: 'ns_35', hanzi: '难说再见', pinyin: 'Nán shuō zàijiàn', french: 'Difficile de se séparer' },
      { id: 'ns_36', hanzi: '永远不忘转身瞬间', pinyin: 'Yǒngyuǎn bú wàng zhuǎnshēn shùnjiān', french: 'Ce souvenir précieux est gravé pour l’éternité' },
      { id: 'ns_37', hanzi: '海阔天空在明天', pinyin: 'Hǎikuòtiānkōng zài míngtiān', french: 'Vers des horizons remplis d’espoir' },
      { id: 'ns_38', hanzi: '再相见', pinyin: 'Zài xiāngjiàn', french: 'Nous serons de nouveau réunis !' },
    ],
  },
  ...
  // ---------- NIVEAU HSK 3 ----------
  {
    ...
    imageUrl: 'https://img.youtube.com/vi/-uzuhqQIaTM/hqdefault.jpg',
    iconBg: 'from-[#00897B] to-[#004D40]',
    sentences: [
      { id: 'st_1', section: 'Couplet 1', hanzi: '夜空中最亮的星', pinyin: 'Yè kōng zhōng zuì liàng de xīng', french: 'Étoile la plus brillante du ciel nocturne' },
      { id: 'st_2', hanzi: '能否听清', pinyin: 'Néng fǒu tīng qīng', french: 'M’entends-tu clairement ?' },
      { id: 'st_3', hanzi: '那仰望的人', pinyin: 'Nà yǎngwàng de rén', french: 'Celui qui lève les yeux vers toi' },
      { id: 'st_4', hanzi: '心底的孤独和叹息', pinyin: 'Xīndǐ de gūdú hé tànxī', french: 'Entends-tu la solitude et les soupirs au fond de son cœur ?' },
      { id: 'st_5', hanzi: '夜空中最亮的星', pinyin: 'Yè kōng zhōng zuì liàng de xīng', french: 'Étoile la plus brillante du ciel nocturne' },
      { id: 'st_6', hanzi: '能否记起', pinyin: 'Néng fǒu jì qǐ', french: 'Te souviens-tu ?' },
      { id: 'st_7', hanzi: '曾与我同行', pinyin: 'Céng yǔ wǒ tóngxíng', french: 'De cette silhouette qui marchait avec moi' },
      { id: 'st_8', hanzi: '消失在风里的身影', pinyin: 'Xiāoshī zài fēng lǐ de shēnyǐng', french: 'Avant de disparaître dans le vent' },
      { id: 'st_9', section: 'Pré-refrain', hanzi: '我祈祷拥有一颗透明的心灵', pinyin: 'Wǒ qǐdǎo yōngyǒu yì kē tòumíng de xīnlíng', french: 'Je prie pour garder un cœur pur et transparent' },
      { id: 'st_10', hanzi: '和会流泪的眼睛', pinyin: 'Hé huì liúlèi de yǎnjing', french: 'Et des yeux capables de s’émouvoir' },
      { id: 'st_11', hanzi: '给我再去相信的勇气', pinyin: 'Gěi wǒ zài qù xiāngxìn de yǒngqì', french: 'Donne-moi le courage de croire à nouveau' },
      { id: 'st_12', hanzi: '越过谎言去拥抱你', pinyin: 'Yuèguò huǎngyán qù yōngbào nǐ', french: 'Et de dépasser les faux-semblants pour t’embrasser' },
      { id: 'st_13', section: 'Refrain', hanzi: '每当我找不到存在的意义', pinyin: 'Měi dāng wǒ zhǎo bú dào cúnzài de yìyì', french: 'Chaque fois que je perds le sens de ma vie' },
      { id: 'st_14', hanzi: '每当我迷失在黑夜里', pinyin: 'Měi dāng wǒ míshī zài hēiyè lǐ', french: 'Chaque fois que je m’égare dans l’obscurité' },
      { id: 'st_15', hanzi: '夜空中最亮的星', pinyin: 'Yè kōng zhōng zuì liàng de xīng', french: 'Étoile la plus brillante du ciel nocturne' },
      { id: 'st_16', hanzi: '请指引我靠近你', pinyin: 'Qǐng zhǐyǐn wǒ kàojìn nǐ', french: 'Guide mes pas pour me rapprocher de toi' },
      { id: 'st_17', section: 'Pré-refrain', hanzi: '我祈祷拥有一颗透明的心灵', pinyin: 'Wǒ qǐdǎo yōngyǒu yì kē tòumíng de xīnlíng', french: 'Je prie pour préserver la pureté de mon âme' },
      { id: 'st_18', hanzi: '和会流泪的眼睛', pinyin: 'Hé huì liúlèi de yǎnjing', french: 'Et mon empathie' },
      { id: 'st_19', hanzi: '给我再去相信的勇气', pinyin: 'Gěi wǒ zài qù xiāngxìn de yǒngqì', french: 'Donne-moi l’audace d’aimer' },
      { id: 'st_20', hanzi: '越过谎言去拥抱你', pinyin: 'Yuèguò huǎngyán qù yōngbào nǐ', french: 'Au-delà de toute désillusion' },
      { id: 'st_21', section: 'Refrain', hanzi: '每当我找不到存在的意义', pinyin: 'Měi dāng wǒ zhǎo bú dào cúnzài de yìyì', french: 'Quand s’efface le sens' },
      { id: 'st_22', hanzi: '每当我迷失在黑夜里', pinyin: 'Měi dāng wǒ míshī zài hēiyè lǐ', french: 'Et que vient l’obscurité' },
      { id: 'st_23', hanzi: '夜空中最亮的星', pinyin: 'Yè kōng zhōng zuì liàng de xīng', french: 'Étoile la plus brillante du firmament' },
      { id: 'st_24', hanzi: '请照亮我前行', pinyin: 'Qǐng zhàoliàng wǒ qiánxíng', french: 'Guide mes pas vers la lumière' },
      { id: 'st_25', section: 'Outro', hanzi: '夜空中最亮的星', pinyin: 'Yè kōng zhōng zuì liàng de xīng', french: 'Étoile dans la nuit' },
    ],
  },
  {
    id: 'chanson_naying',
    ...
    imageUrl: 'https://img.youtube.com/vi/XJVuKRMogfE/hqdefault.jpg',
    iconBg: 'from-[#00897B] to-[#004D40]',
    sentences: [
      { id: 'ny_1', section: 'Couplet 1', hanzi: '忍不住化身一条固执的鱼', pinyin: 'Rěn bù zhù huàshēn yì tiáo gùzhí de yú', french: 'Je ne peux m’empêcher de devenir un poisson obstiné' },
      { id: 'ny_2', hanzi: '逆着洋流独自游到底', pinyin: 'Nì zhe yángliú dúzì yóu dào dǐ', french: 'Nageant seul à contre-courant jusqu’au fond des mers' },
      { id: 'ny_3', hanzi: '年少时候虔诚发过的誓', pinyin: 'Niánshào shíhou qiánchéng fā guò de shì', french: 'Ce serment sacré prononcé dans notre jeunesse' },
      { id: 'ny_4', hanzi: '沉默地沉没在深海里', pinyin: 'Chénmò de chénmò zài shēnhǎi lǐ', french: 'Sombre en silence dans les profondeurs de l’océan' },
      { id: 'ny_5', hanzi: '重温几次', pinyin: 'Chóngwēn jǐ cì', french: 'J’ai beau revivre ces souvenirs' },
      { id: 'ny_6', hanzi: '结局还是失去你', pinyin: 'Jiéjú hái shì shīqù nǐ', french: 'La fin reste toujours de te perdre' },
      { id: 'ny_7', section: 'Refrain', hanzi: '我被爱判处终身孤寂', pinyin: 'Wǒ bèi ài pànchǔ zhōngshēn gūjì', french: 'Condamnée par l’amour à une solitude perpétuelle' },
      { id: 'ny_8', hanzi: '不还手', pinyin: 'Bù huánshǒu', french: 'Sans me défendre' },
      { id: 'ny_9', hanzi: '不放手', pinyin: 'Bù fàngshǒu', french: 'Mais sans jamais lâcher prise' },
      { id: 'ny_10', hanzi: '笔下画不完的圆', pinyin: 'Bǐ xià huà bù wán de yuán', french: 'Ce cercle infini que ma plume ne peut clore' },
      { id: 'ny_11', hanzi: '心间填不满的缘', pinyin: 'Xīn jiān tián bù mǎn de yuán', french: 'Ce vide dans mon cœur que nul ne peut combler' },
      { id: 'ny_12', hanzi: '是你', pinyin: 'Shì nǐ', french: 'C’est toi' },
      { id: 'ny_13', hanzi: '为何爱判处众生孤寂', pinyin: 'Wèihé ài pànchǔ zhòngshēng gūjì', french: 'Pourquoi l’amour condamne-t-il tous les êtres à la solitude ?' },
      { id: 'ny_14', hanzi: '挣不脱', pinyin: 'Zhèng bù tuō', french: 'Impossible de s’en détacher' },
      { id: 'ny_15', hanzi: '逃不过', pinyin: 'Táo bú guò', french: 'Impossible d’y échapper' },
      { id: 'ny_16', hanzi: '眉头解不开的结', pinyin: 'Méitóu jiě bù kāi de jié', french: 'Ce pli soucieux impossible à dénouer sur mon front' },
      { id: 'ny_17', hanzi: '命中解不开的劫', pinyin: 'Mìng zhōng jiě bù kāi de jié', french: 'Cette fatalité indélébile inscrite dans mon destin' },
      { id: 'ny_18', hanzi: '是你', pinyin: 'Shì nǐ', french: 'C’est toi' },
      { id: 'ny_19', hanzi: '啊', pinyin: 'A', french: 'Ah...' },
      { id: 'ny_20', hanzi: '失去你', pinyin: 'Shīqù nǐ', french: 'Te perdre' },
      { id: 'ny_21', hanzi: '我失去你', pinyin: 'Wǒ shīqù nǐ', french: 'T’avoir perdu à jamais' },
      { id: 'ny_22', section: 'Couplet 2', hanzi: '忍不住化身一条固执的鱼', pinyin: 'Rěn bù zhù huàshēn yì tiáo gùzhí de yú', french: 'Je redeviens ce poisson obstiné' },
      { id: 'ny_23', hanzi: '逆着洋流独自游到底', pinyin: 'Nì zhe yángliú dúzì yóu dào dǐ', french: 'Qui brave seul la force des courants' },
      { id: 'ny_24', hanzi: '年少时候虔诚发过的誓', pinyin: 'Niánshào shíhou qiánchéng fā guò de shì', french: 'Les vœux sacrés de nos jeunes années' },
      { id: 'ny_25', hanzi: '沉默地沉没在深海里', pinyin: 'Chénmò de chénmò zài shēnhǎi lǐ', french: 'Gisent silencieux dans l’abîme' },
      { id: 'ny_26', hanzi: '周而复始', pinyin: 'Zhōu ér fù shǐ', french: 'Cercle perpétuel' },
      { id: 'ny_27', hanzi: '结局还是失去你', pinyin: 'Jiéjú hái shì shīqù nǐ', french: 'La conclusion inévitable est de te perdre' },
      { id: 'ny_28', section: 'Refrain', hanzi: '我被爱判处终身孤寂', pinyin: 'Wǒ bèi ài pànchǔ zhōngshēn gūjì', french: 'Condamnée à la solitude sans fin' },
      { id: 'ny_29', hanzi: '不还手', pinyin: 'Bù huánshǒu', french: 'Sans défense' },
      { id: 'ny_30', hanzi: '不放手', pinyin: 'Bù fàngshǒu', french: 'Je garde la foi' },
      { id: 'ny_31', hanzi: '笔下画不完的圆', pinyin: 'Bǐ xià huà bù wán de yuán', french: 'Ce cercle inachevé' },
      { id: 'ny_32', hanzi: '心间填不满的缘', pinyin: 'Xīn jiān tián bù mǎn de yuán', french: 'Ce destin inassouvi' },
      { id: 'ny_33', hanzi: '是你', pinyin: 'Shì nǐ', french: 'C’est toi' },
      { id: 'ny_34', hanzi: '为何爱判处众生孤寂', pinyin: 'Wèihé ài pànchǔ zhòngshēng gūjì', french: 'Pourquoi l’amour isole-t-il les âmes sans issue ?' },
      { id: 'ny_35', hanzi: '挣不脱', pinyin: 'Zhèng bù tuō', french: 'Sans pouvoir s’en défaire' },
      { id: 'ny_36', hanzi: '逃不过', pinyin: 'Táo bú guò', french: 'Sans pouvoir fuir' },
      { id: 'ny_37', hanzi: '眉头解不开的结', pinyin: 'Méitóu jiě bù kāi de jié', french: 'Ce tourment indéfectible' },
      { id: 'ny_38', hanzi: '命中解不开的劫', pinyin: 'Mìng zhōng jiě bù kāi de jié', french: 'Cet amour absolu' },
      { id: 'ny_39', hanzi: '是你', pinyin: 'Shì nǐ', french: 'C’est toi' },
      { id: 'ny_40', hanzi: '啊', pinyin: 'A', french: 'Ah...' },
      { id: 'ny_41', hanzi: '失去你', pinyin: 'Shīqù nǐ', french: 'Te perdre' },
      { id: 'ny_42', hanzi: '我失去你', pinyin: 'Wǒ shīqù nǐ', french: 'Mon amour perdu...' },
    ],
  },
  {
    id: 'chanson_tonghua',
    ...
    imageUrl: 'https://img.youtube.com/vi/IBTmypxD2mU/hqdefault.jpg',
    iconBg: 'from-[#00897B] to-[#004D40]',
    sentences: [
      { id: 'ch4_1', section: 'Couplet 1', hanzi: '忘了有多久', pinyin: 'Wàng le yǒu duō jiǔ', french: 'J’ai oublié depuis combien de temps' },
      { id: 'ch4_2', hanzi: '再没听到你', pinyin: 'Zài méi tīng dào nǐ', french: 'Je ne t’ai plus entendue' },
      { id: 'ch4_3', hanzi: '对我说你最爱的故事', pinyin: 'Duì wǒ shuō nǐ zuì ài de gùshì', french: 'Me raconter ton histoire préférée' },
      { id: 'ch4_4', hanzi: '我想了很久', pinyin: 'Wǒ xiǎng le hěn jiǔ', french: 'J’y ai songé longtemps' },
      { id: 'ch4_5', hanzi: '我开始慌了', pinyin: 'Wǒ kāishǐ huāng le', french: 'L’inquiétude m’a envahi' },
      { id: 'ch4_6', hanzi: '是不是我又做错了什么', pinyin: 'Shì bu shì wǒ yòu zuò cuò le shénme', french: 'Me demandant si j’avais encore fait une maladresse' },
      { id: 'ch4_7', hanzi: '你哭着对我说', pinyin: 'Nǐ kū zhe duì wǒ shuō', french: 'En pleurant tu m’as dit' },
      { id: 'ch4_8', hanzi: '童话里都是骗人的', pinyin: 'Tónghuà lǐ dōu shì piàn rén de', french: 'Que les contes de fées n’étaient que des mensonges' },
      { id: 'ch4_9', hanzi: '我不可能是你的王子', pinyin: 'Wǒ bù kěnéng shì nǐ de wángzǐ', french: 'Que je ne pourrais jamais être ton prince' },
      { id: 'ch4_10', hanzi: '也许你不会懂', pinyin: 'Yěxǔ nǐ bú huì dǒng', french: 'Peut-être ne le sais-tu pas' },
      { id: 'ch4_11', hanzi: '从你说爱我以后', pinyin: 'Cóng nǐ shuō ài wǒ yǐhòu', french: 'Mais depuis que tu m’as avoué ton amour' },
      { id: 'ch4_12', hanzi: '我的天空', pinyin: 'Wǒ de tiānkōng', french: 'Tout mon ciel' },
      { id: 'ch4_13', hanzi: '星星都亮了', pinyin: 'Xīngxīng dōu liàng le', french: 'Toutes les étoiles se sont illuminées' },
      { id: 'ch4_14', section: 'Refrain', hanzi: '我愿变成童话里', pinyin: 'Wǒ yuàn biànchéng tónghuà lǐ', french: 'Je veux devenir dans ton conte' },
      { id: 'ch4_15', hanzi: '你爱的那个天使', pinyin: 'Nǐ ài de nà gè tiānshǐ', french: 'L’ange bienveillant que tu aimes' },
      { id: 'ch4_16', hanzi: '张开双手', pinyin: 'Zhāngkāi shuāngshǒu', french: 'Ouvrant mes bras' },
      { id: 'ch4_17', hanzi: '变成翅膀守护你', pinyin: 'Biànchéng chìbǎng shǒuhù nǐ', french: 'Devenus des ailes pour veiller sur toi' },
      { id: 'ch4_18', hanzi: '你要相信', pinyin: 'Nǐ yào xiāngxìn', french: 'Tu dois y croire' },
      { id: 'ch4_19', hanzi: '相信我们会像童话故事里', pinyin: 'Xiāngxìn wǒmen huì xiàng tónghuà gùshì lǐ', french: 'Croire que notre histoire sera comme un conte' },
      { id: 'ch4_20', hanzi: '幸福和快乐是结局', pinyin: 'Xìngfú hé kuàilè shì jiéjú', french: 'Où le bonheur et la joie couronnent la fin' },
      { id: 'ch4_21', section: 'Couplet 2', hanzi: '你哭着对我说', pinyin: 'Nǐ kū zhe duì wǒ shuō', french: 'Tu m’as dit en pleurs' },
      { id: 'ch4_22', hanzi: '童话里都是骗人的', pinyin: 'Tónghuà lǐ dōu shì piàn rén de', french: 'Que les contes n’étaient que des illusions' },
      { id: 'ch4_23', hanzi: '我不可能是你的王子', pinyin: 'Wǒ bù kěnéng shì nǐ de wángzǐ', french: 'Que je ne serais pas ton prince' },
      { id: 'ch4_24', hanzi: '也许你不会懂', pinyin: 'Yěxǔ nǐ bú huì dǒng', french: 'Tu ne sais sans doute pas' },
      { id: 'ch4_25', hanzi: '从你说爱我以后', pinyin: 'Cóng nǐ shuō ài wǒ yǐhòu', french: 'Que dès ton premier aveu d’amour' },
      { id: 'ch4_26', hanzi: '我的天空', pinyin: 'Wǒ de tiānkōng', french: 'Tout mon ciel' },
      { id: 'ch4_27', hanzi: '星星都亮了', pinyin: 'Xīngxīng dōu liàng le', french: 'S’est illuminé de mille feux' },
      { id: 'ch4_28', section: 'Refrain', hanzi: '我愿变成童话里', pinyin: 'Wǒ yuàn biànchéng tónghuà lǐ', french: 'Je serai cet ange protecteur' },
      { id: 'ch4_29', hanzi: '你爱的那个天使', pinyin: 'Nǐ ài de nà gè tiānshǐ', french: 'Prêt à t’aimer' },
      { id: 'ch4_30', hanzi: '张开双手', pinyin: 'Zhāngkāi shuāngshǒu', french: 'Déployant mes ailes' },
      { id: 'ch4_31', hanzi: '变成翅膀守护你', pinyin: 'Biànchéng chìbǎng shǒuhù nǐ', french: 'Pour prendre soin de toi' },
      { id: 'ch4_32', hanzi: '你要相信', pinyin: 'Nǐ yào xiāngxìn', french: 'Aie confiance' },
      { id: 'ch4_33', hanzi: '相信我们会像童话故事里', pinyin: 'Xiāngxìn wǒmen huì xiàng tónghuà gùshì lǐ', french: 'Notre amour triomphera dans la féerie' },
      { id: 'ch4_34', hanzi: '幸福和快乐是结局', pinyin: 'Xìngfú hé kuàilè shì jiéjú', french: 'Vers une fin radieuse' },
      { id: 'ch4_35', section: 'Refrain', hanzi: '我要变成童话里', pinyin: 'Wǒ yào biànchéng tónghuà lǐ', french: 'Oui je deviens pour toi cet ange dévoué' },
      { id: 'ch4_36', hanzi: '你爱的那个天使', pinyin: 'Nǐ ài de nà gè tiānshǐ', french: 'Que tu chéris tant' },
      { id: 'ch4_37', hanzi: '张开双手', pinyin: 'Zhāngkāi shuāngshǒu', french: 'Ouvrant grand mes bras' },
      { id: 'ch4_38', hanzi: '变成翅膀守护你', pinyin: 'Biànchéng chìbǎng shǒuhù nǐ', french: 'Pour te protéger toujours' },
      { id: 'ch4_39', hanzi: '你要相信', pinyin: 'Nǐ yào xiāngxìn', french: 'Crois-y fermement' },
      { id: 'ch4_40', hanzi: '相信我们会像童话故事里', pinyin: 'Xiāngxìn wǒmen huì xiàng tónghuà gùshì lǐ', french: 'Comme dans la plus belle des histoires' },
      { id: 'ch4_41', hanzi: '幸福和快乐是结局', pinyin: 'Xìngfú hé kuàilè shì jiéjú', french: 'Le bonheur infini sera notre destin' },
      { id: 'ch4_42', section: 'Refrain', hanzi: '我会变成童话里', pinyin: 'Wǒ huì biànchéng tónghuà lǐ', french: 'Je serai à jamais cet ange d’amour' },
      { id: 'ch4_43', hanzi: '你爱的那个天使', pinyin: 'Nǐ ài de nà gè tiānshǐ', french: 'À tes côtés' },
      { id: 'ch4_44', hanzi: '张开双手', pinyin: 'Zhāngkāi shuāngshǒu', french: 'Les bras ouverts' },
      { id: 'ch4_45', hanzi: '变成翅膀守护你', pinyin: 'Biànchéng chìbǎng shǒuhù nǐ', french: 'Pour veiller sur toi éternellement' },
      { id: 'ch4_46', hanzi: '你要相信', pinyin: 'Nǐ yào xiāngxìn', french: 'Aie foi en nous' },
      { id: 'ch4_47', hanzi: '相信我们会像童话故事里', pinyin: 'Xiāngxìn wǒmen huì xiàng tónghuà gùshì lǐ', french: 'Notre vie sera un enchantement' },
      { id: 'ch4_48', hanzi: '幸福和快乐是结局', pinyin: 'Xìngfú hé kuàilè shì jiéjú', french: 'Couronnée de joie et de sérénité' },
      { id: 'ch4_49', hanzi: '一起写', pinyin: 'Yìqǐ xiě', french: 'Écrivons ensemble' },
      { id: 'ch4_50', hanzi: '我们的结局', pinyin: 'Wǒmen de jiéjú', french: 'La fin merveilleuse de notre histoire' },
    ],
  },
  {
    id: 'chanson_keneng',
    ...
    imageUrl: 'https://img.youtube.com/vi/errNa-R3vDM/hqdefault.jpg',
    iconBg: 'from-[#6200EE] to-[#3700B3]',
    sentences: [
      { id: 'kn_1', section: 'Couplet 1', hanzi: '可能南方的阳光', pinyin: 'Kěnéng nánfāng de yángguāng', french: 'Peut-être que le soleil du Sud' },
      { id: 'kn_2', hanzi: '照着北方的风', pinyin: 'Zhào zhe běifāng de fēng', french: 'Éclaire le souffle du vent du Nord' },
      { id: 'kn_3', hanzi: '可能时光被吹走', pinyin: 'Kěnéng shíguāng bèi chuī zǒu', french: 'Peut-être que le temps s’envole emporté au loin' },
      { id: 'kn_4', hanzi: '从此无影无踪', pinyin: 'Cóngcǐ wú yǐng wú zōng', french: 'Disparaissant pour toujours sans laisser de trace' },
      { id: 'kn_5', hanzi: '可能故事只剩下一个难忘的人', pinyin: 'Kěnéng gùshì zhǐ shèng xià yí gè nánwàng de rén', french: 'Peut-être que de l’histoire ne reste qu’un être inoubliable' },
      { id: 'kn_6', hanzi: '可能在昨夜梦里', pinyin: 'Kěnéng zài zuóyè mèng lǐ', french: 'Peut-être que dans le rêve de la nuit dernière' },
      { id: 'kn_7', hanzi: '依然笑得纯真', pinyin: 'Yīrán xiào de chúnzhēn', french: 'Son sourire brillait encore d’une douce innocence' },
      { id: 'kn_8', hanzi: '可能北京的后海', pinyin: 'Kěnéng Běijīng de Hòuhǎi', french: 'Peut-être qu’au bord du lac Houhai à Pékin' },
      { id: 'kn_9', hanzi: '许多漂泊的魂', pinyin: 'Xǔduō piāobó de hún', french: 'Errent tant d’âmes voyageuses et vagabondes' },
      { id: 'kn_10', hanzi: '可能成都小酒馆', pinyin: 'Kěnéng Chéngdū xiǎo jiǔguǎn', french: 'Peut-être que dans les petits bistrots de Chengdu' },
      { id: 'kn_11', hanzi: '有群孤独的人', pinyin: 'Yǒu qún gūdú de rén', french: 'Se réunit un groupe de cœurs solitaires' },
      { id: 'kn_12', hanzi: '可能枕边有微笑', pinyin: 'Kěnéng zhěnbiān yǒu wēixiào', french: 'Peut-être qu’un doux sourire au réveil' },
      { id: 'kn_13', hanzi: '才能暖你清晨', pinyin: 'Cái néng nuǎn nǐ qīngchén', french: 'Peut seul réchauffer ton matin' },
      { id: 'kn_14', hanzi: '可能夜空有流星', pinyin: 'Kěnéng yèkōng yǒu liúxīng', french: 'Peut-être qu’une étoile filante dans la nuit' },
      { id: 'kn_15', hanzi: '才能照你前行', pinyin: 'Cái néng zhào nǐ qiánxíng', french: 'Peut illuminer ton chemin vers l’avenir' },
      { id: 'kn_16', section: 'Refrain', hanzi: '可能西安城墙上', pinyin: 'Kěnéng Xī’ān chéngqiáng shàng', french: 'Peut-être que sur les vieux remparts de Xi’an' },
      { id: 'kn_17', hanzi: '有人誓言不分', pinyin: 'Yǒu rén shìyán bù fēn', french: 'Deux amoureux se jurent de ne jamais se quitter' },
      { id: 'kn_18', hanzi: '可能要去到大理', pinyin: 'Kěnéng yào qù dào Dàlǐ', french: 'Peut-être faut-il voyager jusqu’à Dali' },
      { id: 'kn_19', hanzi: '才算爱得认真', pinyin: 'Cái suàn ài de rènzhēn', french: 'Pour apprendre à aimer avec sincérité' },
      { id: 'kn_20', hanzi: '可能谁说要陪你', pinyin: 'Kěnéng shuí shuō yào péi nǐ', french: 'Peut-être que quelqu’un a promis de t’accompagner' },
      { id: 'kn_21', hanzi: '牵手走完一生', pinyin: 'Qiānshǒu zǒu wán yìshēng', french: 'En te tenant la main tout au long de la vie' },
      { id: 'kn_22', hanzi: '可能笑着流出泪', pinyin: 'Kěnéng xiào zhe liú chū lèi', french: 'Peut-être souriras-tu en versant une larme' },
      { id: 'kn_23', hanzi: '某天在某时辰', pinyin: 'Mǒu tiān zài mǒu shíchén', french: 'Un jour à une heure imprévue du destin' },
      { id: 'kn_24', section: 'Couplet 2', hanzi: '可能桂林有渔船', pinyin: 'Kěnéng Guìlín yǒu yúchuán', french: 'Peut-être qu’à Guilin une barque de pêche' },
      { id: 'kn_25', hanzi: '为你迷茫点灯', pinyin: 'Wèi nǐ mímáng diǎn dēng', french: 'Allumera sa lanterne pour dissiper tes doutes' },
      { id: 'kn_26', hanzi: '可能在呼伦草原', pinyin: 'Kěnéng zài Hūlún cǎoyuán', french: 'Peut-être que dans les immenses steppes de Hulunbuir' },
      { id: 'kn_27', hanzi: '牛羊流成风景', pinyin: 'Niú yáng liú chéng fēngjǐng', french: 'Les troupeaux ondulent en un paisible tableau' },
      { id: 'kn_28', hanzi: '可能再也找不到', pinyin: 'Kěnéng zài yě zhǎo bú dào', french: 'Peut-être ne trouveras-tu plus jamais' },
      { id: 'kn_29', hanzi: '愿意相信的人', pinyin: 'Yuànyì xiāngxìn de rén', french: 'Une âme en qui placer toute ta confiance' },
      { id: 'kn_30', hanzi: '可能穿越了彷徨', pinyin: 'Kěnéng chuānyuè le pánghuáng', french: 'Peut-être qu’après avoir traversé les tourments' },
      { id: 'kn_31', hanzi: '脚步才能坚定', pinyin: 'Jiǎobù cái néng jiāndìng', french: 'Tes pas deviendront enfin inébranlables' },
      { id: 'kn_32', hanzi: '可能武当山道上', pinyin: 'Kěnéng Wǔdāng shāndào shàng', french: 'Peut-être que sur les sentiers sacrés du mont Wudang' },
      { id: 'kn_33', hanzi: '有人虔诚攀登', pinyin: 'Yǒu rén qiánchéng pāndēng', french: 'Des pèlerins gravissent les marches avec ferveur' },
      { id: 'kn_34', hanzi: '可能周庄小巷里', pinyin: 'Kěnéng Zhōuzhuāng xiǎoxiàng lǐ', french: 'Peut-être que dans les ruelles d’eau de Zhouzhuang' },
      { id: 'kn_35', hanzi: '忽然忘掉年轮', pinyin: 'Hūrán wàngdiào niánlún', french: 'On oublie en un instant le poids des années' },
      { id: 'kn_36', hanzi: '可能要多年以后', pinyin: 'Kěnéng yào duō nián yǐhòu', french: 'Peut-être faudra-t-il de longues années' },
      { id: 'kn_37', hanzi: '才能看清曾经', pinyin: 'Cái néng kàn qīng céngjīng', french: 'Pour comprendre la beauté du passé' },
      { id: 'kn_38', hanzi: '可能在当时身边', pinyin: 'Kěnéng zài dāngshí shēnbiān', french: 'Peut-être qu’à cette époque près de toi' },
      { id: 'kn_39', hanzi: '有双温柔眼睛', pinyin: 'Yǒu shuāng wēnróu yǎnjīng', french: 'Brillait un regard plein de douceur infinie' },
      { id: 'kn_40', section: 'Refrain', hanzi: '可能西安城墙上', pinyin: 'Kěnéng Xī’ān chéngqiáng shàng', french: 'Peut-être que sur les remparts de Xi’an' },
      { id: 'kn_41', hanzi: '有人誓言不分', pinyin: 'Yǒu rén shìyán bù fēn', french: 'Deux êtres se jurent une union éternelle' },
      { id: 'kn_42', hanzi: '可能要去到大理', pinyin: 'Kěnéng yào qù dào Dàlǐ', french: 'Peut-être faut-il aller jusqu’à Dali' },
      { id: 'kn_43', hanzi: '才算爱得认真', pinyin: 'Cái suàn ài de rènzhēn', french: 'Pour vivre un amour authentique' },
      { id: 'kn_44', hanzi: '可能谁说要陪你', pinyin: 'Kěnéng shuí shuō yào péi nǐ', french: 'Peut-être que quelqu’un a promis de cheminer à tes côtés' },
      { id: 'kn_45', hanzi: '牵手走完一生', pinyin: 'Qiānshǒu zǒu wán yìshēng', french: 'Main dans la main jusqu’au bout du voyage' },
      { id: 'kn_46', hanzi: '可能笑着流出泪', pinyin: 'Kěnéng xiào zhe liú chū lèi', french: 'Peut-être souriras-tu en essuyant une larme' },
      { id: 'kn_47', hanzi: '可能终于有一天', pinyin: 'Kěnéng zhōngyú yǒu yì tiān', french: 'Peut-être qu’un jour enfin' },
      { id: 'kn_48', hanzi: '刚好遇见爱情', pinyin: 'Gānghǎo yùjiàn àiqíng', french: 'Tu croiseras l’amour sur ta route' },
      { id: 'kn_49', hanzi: '可能永远在路上', pinyin: 'Kěnéng yǒngyuǎn zài lù shàng', french: 'Peut-être que toujours sur le chemin' },
      { id: 'kn_50', hanzi: '有人奋斗前行', pinyin: 'Yǒu rén fèndòu qiánxíng', french: 'Des cœurs courageux continuent de bâtir leur destin' },
      { id: 'kn_51', hanzi: '可能一切的可能', pinyin: 'Kěnéng yíqiè de kěnéng', french: 'Peut-être que tous les possibles de ce monde' },
      { id: 'kn_52', hanzi: '相信才有可能', pinyin: 'Xiāngxìn cái yǒu kěnéng', french: 'Ne deviennent réels que si l’on y croit' },
      { id: 'kn_53', hanzi: '可能拥有过梦想', pinyin: 'Kěnéng yōngyǒu guò mèngxiǎng', french: 'Peut-être qu’avoir embrassé des rêves' },
      { id: 'kn_54', hanzi: '才能叫做青春', pinyin: 'Cái néng jiàozuò qīngchūn', french: 'C’est précisément cela qu’on appelle la jeunesse' },
    ],
  },
  {
    ...
    imageUrl: 'https://img.youtube.com/vi/w0dMz8RBG7g/hqdefault.jpg',
    iconBg: 'from-[#6200EE] to-[#3700B3]',
    sentences: [
      { id: 'wgs_1', section: 'Couplet 1', hanzi: '没有一点点防备', pinyin: 'Méiyǒu yì diǎndiǎn fángbèi', french: 'Sans le moindre avertissement' },
      { id: 'wgs_2', hanzi: '也没有一丝顾虑', pinyin: 'Yě méiyǒu yì sī gùlǜ', french: 'Sans aucune hésitation ni réserve' },
      { id: 'wgs_3', hanzi: '你就这样出现', pinyin: 'Nǐ jiù zhèyàng chūxiàn', french: 'C’est ainsi que tu es apparu' },
      { id: 'wgs_4', hanzi: '在我的世界里', pinyin: 'Zài wǒ de shìjiè lǐ', french: 'Au beau milieu de mon univers' },
      { id: 'wgs_5', hanzi: '带给我惊喜', pinyin: 'Dài gěi wǒ jīngxǐ', french: 'M’apportant tant de douces surprises' },
      { id: 'wgs_6', hanzi: '情不自已', pinyin: 'Qíng bù zìyǐ', french: 'Un amour impossible à contenir' },
      { id: 'wgs_7', hanzi: '可是你偏又这样', pinyin: 'Kěshì nǐ piān yòu zhèyàng', french: 'Mais voilà que de la même façon' },
      { id: 'wgs_8', hanzi: '在我不知不觉中', pinyin: 'Zài wǒ bù zhī bù jué zhōng', french: 'Sans que je ne m’en aperçoive' },
      { id: 'wgs_9', hanzi: '悄悄地消失', pinyin: 'Qiāoqiāo de xiāoshī', french: 'Tu t’es effacé en silence' },
      { id: 'wgs_10', hanzi: '从我的世界里', pinyin: 'Cóng wǒ de shìjiè lǐ', french: 'Hors de mon monde' },
      { id: 'wgs_11', hanzi: '没有音讯', pinyin: 'Méiyǒu yīnxùn', french: 'Sans laisser de nouvelles' },
      { id: 'wgs_12', hanzi: '剩下的只是回忆', pinyin: 'Shèng xià de zhǐshì huíyì', french: 'Ne laissant derrière toi que des souvenirs' },
      { id: 'wgs_13', section: 'Refrain', hanzi: '你存在', pinyin: 'Nǐ cúnzài', french: 'Tu existes' },
      { id: 'wgs_14', hanzi: '我深深的脑海里', pinyin: 'Wǒ shēnshēn de nǎohǎi lǐ', french: 'Profondément ancré dans mes pensées' },
      { id: 'wgs_15', hanzi: '我的梦里', pinyin: 'Wǒ de mèng lǐ', french: 'Dans mes rêves' },
      { id: 'wgs_16', hanzi: '我的心里', pinyin: 'Wǒ de xīn lǐ', french: 'Dans mon cœur' },
      { id: 'wgs_17', hanzi: '我的歌声里', pinyin: 'Wǒ de gēshēng lǐ', french: 'Présent au cœur de mon chant' },
      { id: 'wgs_18', hanzi: '你存在', pinyin: 'Nǐ cúnzài', french: 'Tu vis encore' },
      { id: 'wgs_19', hanzi: '我深深的脑海里', pinyin: 'Wǒ shēnshēn de nǎohǎi lǐ', french: 'Tout au fond de ma mémoire' },
      { id: 'wgs_20', hanzi: '我的梦里', pinyin: 'Wǒ de mèng lǐ', french: 'Dans mes songes' },
      { id: 'wgs_21', hanzi: '我的心里', pinyin: 'Wǒ de xīn lǐ', french: 'Dans mon âme' },
      { id: 'wgs_22', hanzi: '我的歌声里', pinyin: 'Wǒ de gēshēng lǐ', french: 'Gravé dans chacune de mes mélodies' },
      { id: 'wgs_23', section: 'Couplet 2', hanzi: '还记得我们曾经', pinyin: 'Hái jìde wǒmen céngjīng', french: 'Je me souviens encore qu’autrefois' },
      { id: 'wgs_24', hanzi: '肩并肩一起走过', pinyin: 'Jiān bìng jiān yìqǐ zǒuguò', french: 'Nous marchions côte à côte' },
      { id: 'wgs_25', hanzi: '那段繁华巷口', pinyin: 'Nà duàn fánhuá xiàngkǒu', french: 'Dans ces ruelles animées' },
      { id: 'wgs_26', hanzi: '尽管你我是陌生人', pinyin: 'Jǐnguǎn nǐ wǒ shì mòshēng rén', french: 'Bien que nous fussions des inconnus' },
      { id: 'wgs_27', hanzi: '是过路人', pinyin: 'Shì guòlù rén', french: 'De simples passants qui se croisent' },
      { id: 'wgs_28', hanzi: '但彼此还是感觉到了对方的', pinyin: 'Dàn bǐcǐ háishì gǎnjué dào le duìfāng de', french: 'Nous ressentions déjà chez l’un et l’autre' },
      { id: 'wgs_29', hanzi: '一个眼神', pinyin: 'Yí gè yǎnshén', french: 'L’intensité d’un regard' },
      { id: 'wgs_30', hanzi: '一个心跳', pinyin: 'Yí gè xīntiào', french: 'La cadence d’un battement de cœur' },
      { id: 'wgs_31', hanzi: '一种意想不到的快乐', pinyin: 'Yì zhǒng yìxiǎng búdào de kuàilè', french: 'Une joie si inattendue et lumineuse' },
      { id: 'wgs_32', hanzi: '好像是', pinyin: 'Hǎoxiàng shì', french: 'Comme si c’était' },
      { id: 'wgs_33', hanzi: '一场梦境', pinyin: 'Yì chǎng mèngjìng', french: 'Un rêve éveillé' },
      { id: 'wgs_34', hanzi: '命中注定', pinyin: 'Mìngzhòng zhùdìng', french: 'Écrit par le destin' },
      { id: 'wgs_35', section: 'Refrain', hanzi: '你存在', pinyin: 'Nǐ cúnzài', french: 'Tu demeures' },
      { id: 'wgs_36', hanzi: '我深深的脑海里', pinyin: 'Wǒ shēnshēn de nǎohǎi lǐ', french: 'Au plus profond de mes pensées' },
      { id: 'wgs_37', hanzi: '我的梦里', pinyin: 'Wǒ de mèng lǐ', french: 'Dans mes rêves' },
      { id: 'wgs_38', hanzi: '我的心里', pinyin: 'Wǒ de xīn lǐ', french: 'Dans mon cœur' },
      { id: 'wgs_39', hanzi: '我的歌声里', pinyin: 'Wǒ de gēshēng lǐ', french: 'Dans les accords de mon chant' },
      { id: 'wgs_40', hanzi: '你存在', pinyin: 'Nǐ cúnzài', french: 'Tu existes toujours' },
      { id: 'wgs_41', hanzi: '我深深的脑海里', pinyin: 'Wǒ shēnshēn de nǎohǎi lǐ', french: 'Ancré dans mes souvenirs' },
      { id: 'wgs_42', hanzi: '我的梦里', pinyin: 'Wǒ de mèng lǐ', french: 'Dans mes songes' },
      { id: 'wgs_43', hanzi: '我的心里', pinyin: 'Wǒ de xīn lǐ', french: 'Dans mon âme' },
      { id: 'wgs_44', hanzi: '我的歌声里', pinyin: 'Wǒ de gēshēng lǐ', french: 'Vibrant dans ma voix' },
      { id: 'wgs_45', hanzi: '世界之大', pinyin: 'Shìjiè zhī dà', french: 'Le monde est si vaste' },
      { id: 'wgs_46', hanzi: '为何我们相遇', pinyin: 'Wèihé wǒmen xiāngyù', french: 'Pourquoi nos chemins se sont-ils croisés ?' },
      { id: 'wgs_47', hanzi: '难道是缘分', pinyin: 'Nándào shì yuánfèn', french: 'Serait-ce un lien du destin ?' },
      { id: 'wgs_48', hanzi: '难道是天意', pinyin: 'Nándào shì tiānyì', french: 'Une volonté du ciel ?' },
      { id: 'wgs_49', section: 'Refrain', hanzi: '你存在', pinyin: 'Nǐ cúnzài', french: 'Tu existes' },
      { id: 'wgs_50', hanzi: '我深深的脑海里', pinyin: 'Wǒ shēnshēn de nǎohǎi lǐ', french: 'Au plus profond de mon être' },
      { id: 'wgs_51', hanzi: '我的梦里', pinyin: 'Wǒ de mèng lǐ', french: 'Dans mes rêves' },
      { id: 'wgs_52', hanzi: '我的心里', pinyin: 'Wǒ de xīn lǐ', french: 'Dans mon cœur' },
      { id: 'wgs_53', hanzi: '我的歌声里', pinyin: 'Wǒ de gēshēng lǐ', french: 'À jamais dans mon chant' },
      { id: 'wgs_54', section: 'Refrain', hanzi: '你存在', pinyin: 'Nǐ cúnzài', french: 'Tu existes' },
      { id: 'wgs_55', hanzi: '我深深的脑海里', pinyin: 'Wǒ shēnshēn de nǎohǎi lǐ', french: 'Gravé dans mes pensées' },
      { id: 'wgs_56', hanzi: '我的梦里', pinyin: 'Wǒ de mèng lǐ', french: 'Dans mes rêves' },
      { id: 'wgs_57', hanzi: '我的心里', pinyin: 'Wǒ de xīn lǐ', french: 'Dans mon cœur' },
      { id: 'wgs_58', hanzi: '我的歌声里', pinyin: 'Wǒ de gēshēng lǐ', french: 'Présent dans ma voix' },
      { id: 'wgs_59', hanzi: '你存在', pinyin: 'Nǐ cúnzài', french: 'Tu vis encore' },
      { id: 'wgs_60', hanzi: '我深深的脑海里', pinyin: 'Wǒ shēnshēn de nǎohǎi lǐ', french: 'Tout au fond de mon cœur' },
      { id: 'wgs_61', hanzi: '我的梦里', pinyin: 'Wǒ de mèng lǐ', french: 'Dans mes rêves' },
      { id: 'wgs_62', hanzi: '我的心里', pinyin: 'Wǒ de xīn lǐ', french: 'Dans mon âme' },
      { id: 'wgs_63', hanzi: '我的歌声里', pinyin: 'Wǒ de gēshēng lǐ', french: 'Éternellement dans mon chant' },
    ],
  },
  {
    id: 'chanson_shinian',
    titleFr: 'Dix Ans',
    titleZh: '十年',
    titlePinyin: 'Shí Nián',
    type: 'chansons',
    level: 'HSK 3',
    duration: '3 min 25',
    artist: 'Eason Chan',
    youtubeId: 'ZUc6mnHGzIM',
    description: 'L’un des plus grands classiques intemporels de la variété chinoise par Eason Chan, chantant la nostalgie et les amours passées.',
    imageUrl: 'https://img.youtube.com/vi/ZUc6mnHGzIM/hqdefault.jpg',
    iconBg: 'from-[#6200EE] to-[#3700B3]',
    sentences: [
      { id: 'sn_1', section: 'Couplet 1', hanzi: '如果那两个字没有颤抖', pinyin: 'Rúguǒ nà liǎng gè zì méiyǒu chàndǒu', french: 'Si ces deux mots n’avaient pas tremblé' },
      { id: 'sn_2', hanzi: '我不会发现我难受', pinyin: 'Wǒ bú huì fāxiàn wǒ nánshòu', french: 'Je n’aurais pas réalisé combien j’ai mal' },
      { id: 'sn_3', hanzi: '怎么说出口', pinyin: 'Zěnme shuō chū kǒu', french: 'Comment réussir à les prononcer ?' },
      { id: 'sn_4', hanzi: '也不过是分手', pinyin: 'Yě búguò shì fēnshǒu', french: 'Ce n’est pourtant qu’une rupture' },
      { id: 'sn_5', section: 'Couplet 2', hanzi: '如果对于明天没有要求', pinyin: 'Rúguǒ duìyú míngtiān méiyǒu yāoqiú', french: 'Si l’on n’attendait plus rien de demain' },
      { id: 'sn_6', hanzi: '牵牵手就像旅游', pinyin: 'Qiānqiān shǒu jiù xiàng lǚyóu', french: 'Se donner la main serait comme un simple voyage' },
      { id: 'sn_7', hanzi: '成千上万个门口', pinyin: 'Chéngqiān-shàngwàn gè ménkǒu', french: 'Parmi des milliers et des milliers de portes' },
      { id: 'sn_8', hanzi: '总有一个人要先走', pinyin: 'Zǒng yǒu yí gè rén yào xiān zǒu', french: 'Il y en a toujours un qui doit s’en aller le premier' },
      { id: 'sn_9', section: 'Pré-refrain', hanzi: '怀抱既然不能逗留', pinyin: 'Huáibào jìrán bù néng dòuliú', french: 'Puisqu’on ne peut s’attarder dans cette étreinte' },
      { id: 'sn_10', hanzi: '何不在离开的时候', pinyin: 'Hébú zài líkāi de shíhou', french: 'Pourquoi ne pas, au moment de se séparer' },
      { id: 'sn_11', hanzi: '一边享受', pinyin: 'Yìbiān xiǎngshòu', french: 'D’un côté savourer l’instant' },
      { id: 'sn_12', hanzi: '一边泪流', pinyin: 'Yìbiān lèi liú', french: 'Et de l’autre laisser couler ses larmes' },
      { id: 'sn_13', section: 'Refrain', hanzi: '十年之前', pinyin: 'Shí nián zhīqián', french: 'Il y a dix ans' },
      { id: 'sn_14', hanzi: '我不认识你', pinyin: 'Wǒ bú rènshi nǐ', french: 'Je ne te connaissais pas' },
      { id: 'sn_15', hanzi: '你不属于我', pinyin: 'Nǐ bù shǔyú wǒ', french: 'Tu ne m’appartenais pas' },
      { id: 'sn_16', hanzi: '我们还是一样', pinyin: 'Wǒmen hái shì yí yàng', french: 'Nous étions tous les deux pareils' },
      { id: 'sn_17', hanzi: '陪在一个陌生人左右', pinyin: 'Péi zài yí gè mòshēngrén zuǒyòu', french: 'Aux côtés d’un parfait étranger' },
      { id: 'sn_18', hanzi: '走过渐渐熟悉的街头', pinyin: 'Zǒuguò jiànjiàn shúxī de jiētóu', french: 'Arpentant ces rues devenues peu à peu familières' },
      { id: 'sn_19', section: 'Refrain', hanzi: '十年之后', pinyin: 'Shí nián zhīhòu', french: 'Dix ans plus tard' },
      { id: 'sn_20', hanzi: '我们是朋友', pinyin: 'Wǒmen shì péngyou', french: 'Nous sommes de simples amis' },
      { id: 'sn_21', hanzi: '还可以问候', pinyin: 'Hái kěyǐ wènhòu', french: 'Nous pouvons encore nous saluer' },
      { id: 'sn_22', hanzi: '只是那种温柔', pinyin: 'Zhǐ shì nà zhǒng wēnróu', french: 'Mais cette tendresse d’autrefois' },
      { id: 'sn_23', hanzi: '再也找不到拥抱的理由', pinyin: 'Zài yě zhǎo bú dào yōngbào de lǐyóu', french: 'Ne trouve plus aucune raison de s’enlacer' },
      { id: 'sn_24', hanzi: '情人最后难免沦为朋友', pinyin: 'Qíngrén zuìhòu nánmiǎn lún wéi péngyou', french: 'Les amoureux finissent inévitablement par devenir de simples amis' },
      { id: 'sn_25', section: 'Pré-refrain', hanzi: '怀抱既然不能逗留', pinyin: 'Huáibào jìrán bù néng dòuliú', french: 'Puisqu’on ne peut demeurer dans cette étreinte' },
      { id: 'sn_26', hanzi: '何不在离开的时候', pinyin: 'Hébú zài líkāi de shíhou', french: 'Pourquoi ne pas, à l’heure de l’adieu' },
      { id: 'sn_27', hanzi: '一边享受', pinyin: 'Yìbiān xiǎngshòu', french: 'D’un côté savourer le souvenir' },
      { id: 'sn_28', hanzi: '一边泪流', pinyin: 'Yìbiān lèi liú', french: 'Et de l’autre laisser couler ses pleurs' },
      { id: 'sn_29', section: 'Refrain', hanzi: '十年之前', pinyin: 'Shí nián zhīqián', french: 'Il y a dix ans' },
      { id: 'sn_30', hanzi: '我不认识你', pinyin: 'Wǒ bú rènshi nǐ', french: 'Je ne te connaissais pas' },
      { id: 'sn_31', hanzi: '你不属于我', pinyin: 'Nǐ bù shǔyú wǒ', french: 'Tu ne m’appartenais pas' },
      { id: 'sn_32', hanzi: '我们还是一样', pinyin: 'Wǒmen hái shì yí yàng', french: 'Nous étions l’un et l’autre pareils' },
      { id: 'sn_33', hanzi: '陪在一个陌生人左右', pinyin: 'Péi zài yí gè mòshēngrén zuǒyòu', french: 'Accompagnant un étranger' },
      { id: 'sn_34', hanzi: '走过渐渐熟悉的街头', pinyin: 'Zǒuguò jiànjiàn shúxī de jiētóu', french: 'Traversant ces rues devenues familières' },
      { id: 'sn_35', section: 'Refrain', hanzi: '十年之后', pinyin: 'Shí nián zhīhòu', french: 'Dix ans plus tard' },
      { id: 'sn_36', hanzi: '我们是朋友', pinyin: 'Wǒmen shì péngyou', french: 'Nous sommes amis' },
      { id: 'sn_37', hanzi: '还可以问候', pinyin: 'Hái kěyǐ wènhòu', french: 'Nous pouvons encore échanger des nouvelles' },
      { id: 'sn_38', hanzi: '只是那种温柔', pinyin: 'Zhǐ shì nà zhǒng wēnróu', french: 'Mais cette tendresse passée' },
      { id: 'sn_39', hanzi: '再也找不到拥抱的理由', pinyin: 'Zài yě zhǎo bú dào yōngbào de lǐyóu', french: 'Ne trouve plus aucun motif de s’étreindre' },
      { id: 'sn_40', hanzi: '情人最后难免沦为朋友', pinyin: 'Qíngrén zuìhòu nánmiǎn lún wéi péngyou', french: 'Les amants finissent fatalement par devenir amis' },
      { id: 'sn_41', section: 'Outro', hanzi: '直到和你做了多年朋友', pinyin: 'Zhídào hé nǐ zuò le duō nián péngyou', french: 'Ce n’est qu’après avoir été ton ami tant d’années' },
      { id: 'sn_42', hanzi: '才明白我的眼泪', pinyin: 'Cái míngbai wǒ de yǎnlèi', french: 'Que j’ai compris que mes larmes' },
      { id: 'sn_43', hanzi: '不是为你而流', pinyin: 'Bú shì wèi nǐ ér liú', french: 'Ne coulaient pas seulement pour toi' },
      { id: 'sn_44', hanzi: '也为别人而流', pinyin: 'Yě wèi biérén ér liú', french: 'Mais coulaient aussi pour d’autres' },
    ],
  },
  {
    id: 'chanson_jinshengyuan',
    titleFr: 'Le Destin de cette Vie',
    titleZh: '今生缘',
    titlePinyin: 'Jīn Shēng Yuán',
    type: 'chansons',
    level: 'HSK 4',
    duration: '4 min 10',
    artist: 'Chuanzi',
    youtubeId: 'uPfhib9zHtc',
    description: 'Une puissante ballade folk sur la fraternité, la fidélité et le partage des épreuves de la vie, rendue célèbre par la voix rauque et authentique de Chuanzi.',
    imageUrl: 'https://img.youtube.com/vi/uPfhib9zHtc/hqdefault.jpg',
    iconBg: 'from-[#3F51B5] to-[#1A237E]',
    sentences: [
      { id: 'jsy_1', section: 'Couplet 1', hanzi: '我们今生有缘在路上', pinyin: 'Wǒmen jīnshēng yǒu yuán zài lù shàng', french: 'Dans cette vie, le destin nous a réunis sur le même chemin' },
      { id: 'jsy_2', hanzi: '只要我们彼此永不忘', pinyin: 'Zhǐyào wǒmen bǐcǐ yǒng bú wàng', french: 'Tant que nous ne nous oublierons jamais l’un l’autre' },
      { id: 'jsy_3', section: 'Refrain', hanzi: '朋友啊', pinyin: 'Péngyǒu a', french: 'Ô mes amis !' },
      { id: 'jsy_4', hanzi: '让我们一起牢牢铭记呀', pinyin: 'Ràng wǒmen yìqǐ láoláo míngjì ya', french: 'Gravons tous ensemble ces instants dans nos mémoires' },
      { id: 'jsy_5', hanzi: '别在乎那一些忧和伤', pinyin: 'Bié zàihu nà yìxiē yōu hé shāng', french: 'Ne nous soucions pas de ces peines et blessures' },
      { id: 'jsy_6', section: 'Refrain', hanzi: '朋友啊', pinyin: 'Péngyǒu a', french: 'Ô mes amis !' },
      { id: 'jsy_7', hanzi: '让我们一起牢牢铭记呀', pinyin: 'Ràng wǒmen yìqǐ láoláo míngjì ya', french: 'Gardons ces souvenirs précieusement ancrés en nous' },
      { id: 'jsy_8', hanzi: '别在乎那一些忧和伤', pinyin: 'Bié zàihu nà yìxiē yōu hé shāng', french: 'Oublions les tourments et les chagrins passés' },
      { id: 'jsy_9', section: 'Couplet 2', hanzi: '我们今生注定是沧桑', pinyin: 'Wǒmen jīnshēng zhùdìng shì cāngsāng', french: 'Notre existence est vouée à traverser les épreuves de la vie' },
      { id: 'jsy_10', hanzi: '哭着来要笑着走过呀', pinyin: 'Kū zhe lái yào xiào zhe zǒuguò ya', french: 'Nés dans les larmes, nous devons avancer avec le sourire' },
      { id: 'jsy_11', section: 'Refrain', hanzi: '朋友啊', pinyin: 'Péngyǒu a', french: 'Ô mes amis !' },
      { id: 'jsy_12', hanzi: '让我们一起牢牢铭记呀', pinyin: 'Ràng wǒmen yìqǐ láoláo míngjì ya', french: 'Gravons ensemble cette fidélité dans nos cœurs' },
      { id: 'jsy_13', hanzi: '我们今生兄弟情谊长', pinyin: 'Wǒmen jīnshēng xiōngdì qíngyì cháng', french: 'Notre fraternité en cette vie durera toujours' },
      { id: 'jsy_14', section: 'Refrain', hanzi: '朋友啊', pinyin: 'Péngyǒu a', french: 'Ô mes amis !' },
      { id: 'jsy_15', hanzi: '让我们一起牢牢铭记呀', pinyin: 'Ràng wǒmen yìqǐ láoláo míngjì ya', french: 'Scellons pour toujours ces liens fraternels' },
      { id: 'jsy_16', hanzi: '我们今生兄弟情谊长', pinyin: 'Wǒmen jīnshēng xiōngdì qíngyì cháng', french: 'L’amitié entre frères traversera les âges' },
      { id: 'jsy_17', section: 'Couplet 3', hanzi: '我们今生有缘在路上', pinyin: 'Wǒmen jīnshēng yǒu yuán zài lù shàng', french: 'Le destin nous a rassemblés sur cette route' },
      { id: 'jsy_18', hanzi: '只要我们彼此永不忘', pinyin: 'Zhǐyào wǒmen bǐcǐ yǒng bú wàng', french: 'Tant que nos cœurs restent fidèles à ce serment' },
      { id: 'jsy_19', section: 'Refrain', hanzi: '朋友啊', pinyin: 'Péngyǒu a', french: 'Ô mes frères !' },
      { id: 'jsy_20', hanzi: '让我们一起牢牢铭记呀', pinyin: 'Ràng wǒmen yìqǐ láoláo míngjì ya', french: 'Gardons gravée cette fraternité sans faille' },
      { id: 'jsy_21', hanzi: '别在乎那一些忧和伤', pinyin: 'Bié zàihu nà yìxiē yōu hé shāng', french: 'Au-delà des peines et des blessures' },
      { id: 'jsy_22', section: 'Refrain', hanzi: '朋友啊', pinyin: 'Péngyǒu a', french: 'Ô mes amis !' },
      { id: 'jsy_23', hanzi: '让我们一起牢牢铭记呀', pinyin: 'Ràng wǒmen yìqǐ láoláo míngjì ya', french: 'Célébrons ensemble ce voyage partagé' },
      { id: 'jsy_24', hanzi: '别在乎那一些忧和伤', pinyin: 'Bié zàihu nà yìxiē yōu hé shāng', french: 'Rien ne pourra ternir notre joie' },
      { id: 'jsy_25', section: 'Couplet 4', hanzi: '我们今生就像梦一场', pinyin: 'Wǒmen jīnshēng jiù xiàng mèng yì chǎng', french: 'Notre vie ici-bas est comme un grand rêve' },
      { id: 'jsy_26', hanzi: '有你陪喝醉了又何妨', pinyin: 'Yǒu nǐ péi hē zuì le yòu héfáng', french: 'À tes côtés, qu’importe si l’on s’enivre !' },
      { id: 'jsy_27', section: 'Refrain', hanzi: '朋友啊', pinyin: 'Péngyǒu a', french: 'Ô mes amis !' },
      { id: 'jsy_28', hanzi: '让我们一起牢牢铭记呀', pinyin: 'Ràng wǒmen yìqǐ láoláo míngjì ya', french: 'Gardons précieusement ce souvenir' },
      { id: 'jsy_29', hanzi: '凡尘过后终了无牵挂', pinyin: 'Fánchén guòhòu zhōng liǎo wú qiānguà', french: 'Une fois le monde terrestre traversé, le cœur sera sans regrets' },
      { id: 'jsy_30', section: 'Refrain', hanzi: '朋友啊', pinyin: 'Péngyǒu a', french: 'Ô mes frères !' },
      { id: 'jsy_31', hanzi: '让我们一起牢牢铭记呀', pinyin: 'Ràng wǒmen yìqǐ láoláo míngjì ya', french: 'N’oublions jamais ce que nous avons partagé' },
      { id: 'jsy_32', hanzi: '凡尘过后终了无牵挂', pinyin: 'Fánchén guòhòu zhōng liǎo wú qiānguà', french: 'Quand passera la poussière de ce monde, l’esprit sera libre et serein' },
      { id: 'jsy_33', section: 'Outro', hanzi: '朋友啊', pinyin: 'Péngyǒu a', french: 'Ô mes amis !' },
      { id: 'jsy_34', hanzi: '让我们一起牢牢铭记呀', pinyin: 'Ràng wǒmen yìqǐ láoláo míngjì ya', french: 'Gravons à tout jamais ces instants' },
      { id: 'jsy_35', hanzi: '凡尘过后终了无牵挂', pinyin: 'Fánchén guòhòu zhōng liǎo wú qiānguà', french: 'Et nous partirons le cœur léger et comblé' },
    ],
  },
  {
    ...
    sentences: [
      { id: 'xcz_1', section: 'Couplet 1', hanzi: '不是因为寒冷气候', pinyin: 'Bú shì yīnwèi hánlěng qìhòu', french: 'Ce n’est pas à cause du froid' },
      { id: 'xcz_2', hanzi: '我全身发抖', pinyin: 'Wǒ quánshēn fādǒu', french: 'Que je frissonne de tout mon corps' },
      { id: 'xcz_3', hanzi: '这感觉很熟悉', pinyin: 'Zhè gǎnjué hěn shúxī', french: 'Cette sensation m’est si familière' },
      { id: 'xcz_4', hanzi: '如梦境一样', pinyin: 'Rú mèngjìng yíyàng', french: 'Comme dans un songe' },
      { id: 'xcz_5', hanzi: '却没法拥有', pinyin: 'Què méi fǎ yǒngyǒu', french: 'Sans pouvoir la retenir' },
      { id: 'xcz_6', hanzi: '你就在那里', pinyin: 'Nǐ jiù zài nàlǐ', french: 'Tu es pourtant là' },
      { id: 'xcz_7', hanzi: '像是一个老朋友', pinyin: 'Xiàng shì yí gè lǎo péngyou', french: 'Tel un vieil ami' },
      { id: 'xcz_8', hanzi: '来到这里', pinyin: 'Lái dào zhèlǐ', french: 'En arrivant ici' },
      { id: 'xcz_9', hanzi: '好像回到家门口', pinyin: 'Hǎoxiàng huí dào jiā ménkǒu', french: 'J’ai l’impression d’être enfin chez moi' },
      { id: 'xcz_10', section: 'Couplet 2', hanzi: '我坚强的心是城堡', pinyin: 'Wǒ jiānqiáng de xīn shì chéngbǎo', french: 'Mon cœur fort était une forteresse' },
      { id: 'xcz_11', hanzi: '把秘密关起来', pinyin: 'Bǎ mìmì guān qǐlái', french: 'Gardant ses secrets bien scellés' },
      { id: 'xcz_12', hanzi: '你也有秘密', pinyin: 'Nǐ yě yǒu mìmì', french: 'Toi aussi tu as des secrets' },
      { id: 'xcz_13', hanzi: '但你不用躲开', pinyin: 'Dàn nǐ bú yòng duǒkāi', french: 'Mais tu n’as plus besoin de te cacher' },
      { id: 'xcz_14', section: 'Refrain', hanzi: '你是谁', pinyin: 'Nǐ shì shéi', french: 'Qui es-tu ?' },
      { id: 'xcz_15', hanzi: '我渴望见到你', pinyin: 'Wǒ kěwàng jiàndào nǐ', french: 'J’ai tellement hâte de te rencontrer' },
      { id: 'xcz_16', hanzi: '你是谁', pinyin: 'Nǐ shì shéi', french: 'Qui es-tu ?' },
      { id: 'xcz_17', hanzi: '快出来', pinyin: 'Kuài chūlái', french: 'Montre-toi !' },
      { id: 'xcz_18', hanzi: '你是不是我生命里所有的期待', pinyin: 'Nǐ shì bú shì wǒ shēngmìng lǐ suǒyǒu de qīdài', french: 'Es-tu l’attente de toute ma vie ?' },
      { id: 'xcz_19', hanzi: '你是谁', pinyin: 'Nǐ shì shéi', french: 'Qui es-tu ?' },
      { id: 'xcz_20', hanzi: '答案说出来', pinyin: 'Dá’àn shuō chūlái', french: 'Révèle-moi la vérité !' },
      { id: 'xcz_21', hanzi: '啊啊啊啊', pinyin: 'Ā ā ā ā', french: 'Ah ah ah ah' },
      { id: 'xcz_22', section: 'Couplet 3', hanzi: '我一直都很清楚', pinyin: 'Wǒ yìzhí dōu hěn qīngchu', french: 'J’ai toujours su parfaitement' },
      { id: 'xcz_23', hanzi: '我受过的折磨', pinyin: 'Wǒ shòuguò de zhémó', french: 'Toutes les épreuves endurées' },
      { id: 'xcz_24', hanzi: '但今天我在这里', pinyin: 'Dàn jīntiān wǒ zài zhèlǐ', french: 'Mais aujourd’hui je suis ici' },
      { id: 'xcz_25', hanzi: '也许找到出生的线索', pinyin: 'Yěxǔ zhǎodào chūshēng de xiànsuǒ', french: 'Pour enfin percer le mystère de mes origines' },
      { id: 'xcz_26', hanzi: '我是天生与众不同', pinyin: 'Wǒ shì tiānshēng yǔzhòng-bùtóng', french: 'Je suis née différente des autres' },
      { id: 'xcz_27', hanzi: '不适合平凡生活', pinyin: 'Bú shìhé píngfán shēnghuó', french: 'Non faite pour une vie ordinaire' },
      { id: 'xcz_28', hanzi: '是否今天', pinyin: 'Shìfǒu jīntiān', french: 'Est-ce qu’aujourd’hui,' },
      { id: 'xcz_29', hanzi: '你的出现', pinyin: 'Nǐ de chūxiàn', french: 'Ta présence' },
      { id: 'xcz_30', hanzi: '将答案告诉我', pinyin: 'Jiāng dá’àn gàosù wǒ', french: 'M’apportera enfin la réponse ?' },
      { id: 'xcz_31', section: 'Refrain', hanzi: '你是谁', pinyin: 'Nǐ shì shéi', french: 'Qui es-tu ?' },
      { id: 'xcz_32', hanzi: '我再不会颤抖', pinyin: 'Wǒ zài bú huì chàndǒu', french: 'Je n’ai plus peur de trembler' },
      { id: 'xcz_33', hanzi: '离开家我不害怕', pinyin: 'Líkāi jiā wǒ bú pà', french: 'Loin de chez moi, je n’ai plus peur' },
      { id: 'xcz_34', hanzi: '你能把我生命中疑惑', pinyin: 'Nǐ néng bǎ wǒ shēngmìng zhōng yíhuò', french: 'Tu peux dissiper tous les doutes de ma vie' },
      { id: 'xcz_35', hanzi: '全部解答', pinyin: 'Quánbù jiědá', french: 'Et m’éclairer' },
      { id: 'xcz_36', hanzi: '你是谁', pinyin: 'Nǐ shì shéi', french: 'Qui es-tu ?' },
      { id: 'xcz_37', hanzi: '跟我见面好吗', pinyin: 'Gēn wǒ jiànmiàn hǎo ma', french: 'Montre-toi, je t’en prie' },
      { id: 'xcz_38', section: 'Pont', hanzi: '向我走来', pinyin: 'Xiàng wǒ zǒu lái', french: 'Viens à ma rencontre' },
      { id: 'xcz_39', hanzi: '把门打开', pinyin: 'Bǎ mén dǎkāi', french: 'Ouvre la porte' },
      { id: 'xcz_40', hanzi: '不要让我一直等待', pinyin: 'Bú yào ràng wǒ yìzhí děngdài', french: 'Ne me laisse plus attendre' },
      { id: 'xcz_41', hanzi: '向我走来', pinyin: 'Xiàng wǒ zǒu lái', french: 'Viens vers moi' },
      { id: 'xcz_42', hanzi: '把门打开', pinyin: 'Bǎ mén dǎkāi', french: 'Ouvre la porte' },
      { id: 'xcz_43', hanzi: '别再让我 一直等待', pinyin: 'Bié zài ràng wǒ yìzhí děngdài', french: 'Ne me fais plus languir' },
      { id: 'xcz_44', section: 'Couplet 4', hanzi: '北风吹过 浪卷起', pinyin: 'Běifēng chuī guò, làng juǎn qǐ', french: 'Le vent du Nord souffle, les vagues se soulèvent' },
      { id: 'xcz_45', hanzi: '有一条河 充满着回忆', pinyin: 'Yǒu yì tiáo hé, chōngmǎnzhe huíyì', french: 'Il est un fleuve chargé de souvenirs' },
      { id: 'xcz_46', hanzi: '请回家吧 小宝宝', pinyin: 'Qǐng huí jiā ba, xiǎo bǎobao', french: 'Reviens à la maison, mon enfant bien-aimé' },
      { id: 'xcz_47', section: 'Refrain', hanzi: '我存在', pinyin: 'Wǒ cúnzài', french: 'J’existe enfin !' },
      { id: 'xcz_48', hanzi: '看自己 力量排山倒海', pinyin: 'Kàn zìjǐ, lìliàng páishāndǎohǎi', french: 'Regarde en toi cette puissance infinie' },
      { id: 'xcz_49', hanzi: '看自己 全新的姿态', pinyin: 'Kàn zìjǐ, quánxīn de zītài', french: 'Révèle-toi sous un jour nouveau' },
      { id: 'xcz_50', hanzi: '终于明白 你就是自己', pinyin: 'Zhōngyú míngbai, nǐ jiù shì zìjǐ', french: 'J’ai enfin compris : cette force, c’est toi-même' },
      { id: 'xcz_51', hanzi: '终于明白', pinyin: 'Zhōngyú míngbai', french: 'J’ai enfin compris' },
      { id: 'xcz_52', hanzi: '所有期待', pinyin: 'Suǒyǒu qīdài', french: 'Toutes mes espérances' },
      { id: 'xcz_53', hanzi: '哦 我存在', pinyin: 'Ó, wǒ cúnzài', french: 'Oh, je suis enfin moi-même !' },
      { id: 'xcz_54', hanzi: '呜啊啊啊啊', pinyin: 'Wū ā ā ā ā', french: 'Ooh ah ah ah ah' },
    ],
  },
  {
    id: 'chanson_yeguang',
    ...
    imageUrl: 'https://img.youtube.com/vi/5JXOLr-32Wc/hqdefault.jpg',
    iconBg: 'from-[#8E24AA] to-[#6200EE]',
    sentences: [
      { id: 'yg_1', section: 'Couplet 1', hanzi: '在你被淹没时闪烁', pinyin: 'Zài nǐ bèi yānmò shí shǎnshuò', french: 'Scintillant quand tu te sens submergé' },
      { id: 'yg_2', hanzi: '在你的左手', pinyin: 'Zài nǐ de zuǒshǒu', french: 'Posée contre ta main gauche' },
      { id: 'yg_3', hanzi: '在你闪烁时候沉默', pinyin: 'Zài nǐ shǎnshuò shíhou chénmò', french: 'Silencieuse quand tu rayonnes' },
      { id: 'yg_4', hanzi: '等你的抚摩', pinyin: 'Děng nǐ de fǔmō', french: 'Attendant simplement ta caresse' },
      { id: 'yg_5', hanzi: '醒着做梦', pinyin: 'Xǐng zhe zuò mèng', french: 'Rêver éveillée' },
      { id: 'yg_6', hanzi: '听人潮翻涌', pinyin: 'Tīng réncháo fānyǒng', french: 'En écoutant la marée humaine déferler' },
      { id: 'yg_7', hanzi: '像凝固的一条河流', pinyin: 'Xiàng nínggù de yì tiáo héliú', french: 'Telle une rivière figée dans le temps' },
      { id: 'yg_8', hanzi: '在无声荒茫的宇宙', pinyin: 'Zài wúshēng huāngmáng de yǔzhòu', french: 'Dans le silence infini du cosmos' },
      { id: 'yg_9', hanzi: '情愿被孤囚', pinyin: 'Qíngyuàn bèi gūqiú', french: 'Je consens à être recluse par amour' },
      { id: 'yg_10', hanzi: '在独自拥抱的冷冬', pinyin: 'Zài dúzì yōngbào de lěngdōng', french: 'Dans la froide solitude de l’hiver' },
      { id: 'yg_11', hanzi: '黯淡过眼眸', pinyin: 'Àndàn guò yǎnmóu', french: 'Mon regard a perdu son éclat' },
      { id: 'yg_12', hanzi: '转身回首', pinyin: 'Zhuǎnshēn huíshǒu', french: 'En me retournant' },
      { id: 'yg_13', hanzi: '又随你漂游', pinyin: 'Yòu suí nǐ piāoyóu', french: 'Je me laisse porter à la dérive avec toi' },
      { id: 'yg_14', hanzi: '贪留这脉搏的温柔', pinyin: 'Tānliú zhè màibó de wēnróu', french: 'Désirant la douceur de tes battements de cœur' },
      { id: 'yg_15', section: 'Refrain', hanzi: '如果所有的光芒都失去颜色', pinyin: 'Rúguǒ suǒyǒu de guāngmáng dōu shīqù yánsè', french: 'Si toutes les lumières perdaient leurs couleurs' },
      { id: 'yg_16', hanzi: '就擦亮我黑夜里不灭的路灯', pinyin: 'Jiù cāliàng wǒ hēiyè lǐ búmiè de lùdēng', french: 'Ravive ce réverbère qui ne s’éteint jamais dans la nuit' },
      { id: 'yg_17', hanzi: '如果寂寞是拥有的唯一要求', pinyin: 'Rúguǒ jìmò shì yōngyǒu de wéiyī yāoqiú', french: 'Si la solitude est le seul prix pour t’aimer' },
      { id: 'yg_18', hanzi: '就让我寂寞', pinyin: 'Jiù ràng wǒ jìmò', french: 'Alors laisse-moi embrasser la solitude' },
      { id: 'yg_19', section: 'Couplet 2', hanzi: '在无声荒茫的宇宙', pinyin: 'Zài wúshēng huāngmáng de yǔzhòu', french: 'Dans l’immensité silencieuse' },
      { id: 'yg_20', hanzi: '情愿被孤囚', pinyin: 'Qíngyuàn bèi gūqiú', french: 'Je choisis d’être captive de ton souvenir' },
      { id: 'yg_21', hanzi: '在独自拥抱的冷冬', pinyin: 'Zài dúzì yōngbào de lěngdōng', french: 'Au cœur du rude hiver' },
      { id: 'yg_22', hanzi: '黯淡过眼眸', pinyin: 'Àndàn guò yǎnmóu', french: 'Le regard voilé' },
      { id: 'yg_23', hanzi: '转身回首', pinyin: 'Zhuǎnshēn huíshǒu', french: 'Je me tourne vers toi' },
      { id: 'yg_24', hanzi: '又随你漂游', pinyin: 'Yòu suí nǐ piāoyóu', french: 'Et vogue au fil de ton ombre' },
      { id: 'yg_25', hanzi: '贪留这脉搏的温柔', pinyin: 'Tānliú zhè màibó de wēnróu', french: 'Cherchant la tendresse de chaque battement' },
      { id: 'yg_26', section: 'Refrain', hanzi: '如果所有的光芒都失去颜色', pinyin: 'Rúguǒ suǒyǒu de guāngmáng dōu shīqù yánsè', french: 'Si toutes les lumières perdaient leurs couleurs' },
      { id: 'yg_27', hanzi: '就擦亮我黑夜里不灭的路灯', pinyin: 'Jiù cāliàng wǒ hēiyè lǐ búmiè de lùdēng', french: 'Ravive ce réverbère qui ne s’éteint jamais dans la nuit' },
      { id: 'yg_28', hanzi: '如果寂寞是拥有的唯一要求', pinyin: 'Rúguǒ jìmò shì yōngyǒu de wéiyī yāoqiú', french: 'Si la solitude est le seul prix pour t’aimer' },
      { id: 'yg_29', hanzi: '就让我寂寞', pinyin: 'Jiù ràng wǒ jìmò', french: 'Alors laisse-moi embrasser la solitude' },
      { id: 'yg_30', hanzi: '如果所有的风景变成了沙漠', pinyin: 'Rúguǒ suǒyǒu de fēngjǐng biànchéng le shāmò', french: 'Si tous les paysages devenaient des déserts' },
      { id: 'yg_31', hanzi: '请放逐我如流星碎落的粉末', pinyin: 'Qǐng fàngzhú wǒ rú liúxīng suìluò de fěnmò', french: 'Exile-moi comme la poussière d’une étoile filante' },
      { id: 'yg_32', hanzi: '你会记得在回忆最美的时候', pinyin: 'Nǐ huì jìde zài huíyì zuì měi de shíhou', french: 'Tu te rappelleras qu’au plus bel instant de nos vies' },
      { id: 'yg_33', section: 'Outro', hanzi: '你爱我', pinyin: 'Nǐ ài wǒ', french: 'Tu m’aimais' },
      { id: 'yg_34', hanzi: '爱我', pinyin: 'Ài wǒ', french: 'Tu m’aimais' },
      { id: 'yg_35', hanzi: '爱我', pinyin: 'Ài wǒ', french: 'Tu m’aimais passionnément' },
    ],
  },
  {
    ...
    sentences: [
      { id: 'tdc_1', section: 'Couplet 1', hanzi: '不愿意看你在流泪', pinyin: 'Bú yuànyì kàn nǐ zài liúlèi', french: 'Je ne veux pas te voir pleurer' },
      { id: 'tdc_2', hanzi: '可我却不能在你身边安慰', pinyin: 'Kě wǒ què bù néng zài nǐ shēnbiān ānwèi', french: 'Pourtant je ne peux être à tes côtés pour te réconforter' },
      ...
      { id: 'tdc_10', hanzi: '努力赚钱还要照顾家里', pinyin: 'Nǔlì zhuànqián hái yào zhàogù jiā lǐ', french: 'Travailler dur pour gagner sa vie tout en s’occupant du foyer' },
      { id: 'tdc_11', hanzi: '你可知道此刻的我', pinyin: 'Nǐ kě zhīdào cǐkè de wǒ', french: 'Sais-tu à quel point en cet instant' },
      { id: 'tdc_12', hanzi: '有多么心疼你', pinyin: 'Yǒu duōme xīnténg nǐ', french: 'Mon cœur a mal pour toi' },
      { id: 'tdc_13', hanzi: '每次回到我们生活的城市', pinyin: 'Měicì huí dào wǒmen shēnghuó de chéngshì', french: 'Chaque fois que je reviens dans notre ville' },
      { id: 'tdc_14', hanzi: '你总是用温柔和微笑来掩饰', pinyin: 'Nǐ zǒngshì yòng wēnróu hé wēixiào lái yǎnshì', french: 'Tu masques toujours ta peine sous la douceur d’un sourire' },
      { id: 'tdc_15', hanzi: '把全部的苦都自己来背', pinyin: 'Bǎ quánbù de kǔ dōu zìjǐ lái bēi', french: 'Portant toute la souffrance sur tes seules épaules' },
      { id: 'tdc_16', section: 'Refrain', hanzi: '都是我的错', pinyin: 'Dōu shì wǒ de cuò', french: 'Tout est de ma faute' },
      { id: 'tdc_17', hanzi: '请你原谅我', pinyin: 'Qǐng nǐ yuánliàng wǒ', french: 'S’il te plaît pardonne moi' },
      { id: 'tdc_18', hanzi: '为了你受再多的委屈都值得', pinyin: 'Wèile nǐ shòu zài duō de wěiqu dōu zhídé', french: 'Pour toi, endurer tant d’épreuves en vaut la peine' },
      { id: 'tdc_19', hanzi: '本想给你我们的未来', pinyin: 'Běn xiǎng gěi nǐ wǒmen de wèilái', french: 'Je voulais tant t’offrir notre avenir' },
      { id: 'tdc_20', hanzi: '可代价却是两地的分离', pinyin: 'Kě dàijià què shì liǎng dì de fēnlí', french: 'Mais le prix à payer a été la séparation de nos vies' },
      { id: 'tdc_21', hanzi: '只能够用思念互相祝福', pinyin: 'Zhǐ nénggòu yòng sīniàn hùxiāng zhùfú', french: 'Nous ne pouvons que nous soutenir à travers nos pensées' },
      { id: 'tdc_22', hanzi: '都是我的错', pinyin: 'Dōu shì wǒ de cuò', french: 'Tout est de ma faute' },
      { id: 'tdc_23', hanzi: '请你原谅我', pinyin: 'Qǐng nǐ yuánliàng wǒ', french: 'S’il te plaît pardonne moi' },
      { id: 'tdc_24', hanzi: '为了你我会更加珍惜自己', pinyin: 'Wèile nǐ wǒ huì gèngjiā zhēnxī zìjǐ', french: 'Pour toi, je prendrai encore plus soin de moi' },
      { id: 'tdc_25', hanzi: '只要我们的心还在一起', pinyin: 'Zhǐyào wǒmen de xīn hái zài yìqǐ', french: 'Tant que nos cœurs restent unis' },
      { id: 'tdc_26', hanzi: '岁月会有无数的惊喜', pinyin: 'Suìyuè huì yǒu wúshù de jīngxǐ', french: 'Le temps nous réservera d’infinies surprises' },
      { id: 'tdc_27', hanzi: '我爱你', pinyin: 'Wǒ ài nǐ', french: 'Je t’aime' },
      { id: 'tdc_28', hanzi: '谢谢你', pinyin: 'Xièxie nǐ', french: 'Merci à toi' },
      { id: 'tdc_29', section: 'Pré-refrain', hanzi: '你一个女人不容易', pinyin: 'Nǐ yí gè nǚrén bù róngyì', french: 'Ce n’est pas facile pour une femme seule' },
      { id: 'tdc_30', hanzi: '努力赚钱还要照顾家里', pinyin: 'Nǔlì zhuànqián hái yào zhàogù jiā lǐ', french: 'Travailler dur pour gagner sa vie tout en veillant sur le foyer' },
      { id: 'tdc_31', hanzi: '你可知道此刻的我', pinyin: 'Nǐ kě zhīdào cǐkè de wǒ', french: 'Sais-tu à quel point en cet instant' },
      { id: 'tdc_32', hanzi: '有多么心疼你', pinyin: 'Yǒu duōme xīnténg nǐ', french: 'Mon âme saigne pour toi' },
      { id: 'tdc_33', hanzi: '每次回到我们生活的城市', pinyin: 'Měicì huí dào wǒmen shēnghuó de chéngshì', french: 'Chaque fois que je reviens dans notre ville' },
      { id: 'tdc_34', hanzi: '你总是用温柔和微笑来掩饰', pinyin: 'Nǐ zǒngshì yòng wēnróu hé wēixiào lái yǎnshì', french: 'Tu masques toujours ta détresse avec tendresse et sourire' },
      { id: 'tdc_35', hanzi: '把全部的苦都自己来背', pinyin: 'Bǎ quánbù de kǔ dōu zìjǐ lái bēi', french: 'Portant toute la souffrance sur tes seules épaules' },
      { id: 'tdc_36', section: 'Refrain', hanzi: '都是我的错', pinyin: 'Dōu shì wǒ de cuò', french: 'Tout est de ma faute' },
      { id: 'tdc_37', hanzi: '请你原谅我', pinyin: 'Qǐng nǐ yuánliàng wǒ', french: 'S’il te plaît pardonne moi' },
      { id: 'tdc_38', hanzi: '为了你受再多的委屈都值得', pinyin: 'Wèile nǐ shòu zài duō de wěiqu dōu zhídé', french: 'Pour toi, affronter tous les chagrins en vaut la peine' },
      { id: 'tdc_39', hanzi: '本想给你我们的未来', pinyin: 'Běn xiǎng gěi nǐ wǒmen de wèilái', french: 'Je voulais bâtir notre avenir ensemble' },
      { id: 'tdc_40', hanzi: '可代价却是两地的分离', pinyin: 'Kě dàijià què shì liǎng dì de fēnlí', french: 'Mais le destin a imposé la distance entre nous' },
      { id: 'tdc_41', hanzi: '只能够用思念互相祝福', pinyin: 'Zhǐ nénggòu yòng sīniàn hùxiāng zhùfú', french: 'En ne pouvant que nous bénir par nos pensées' },
      { id: 'tdc_42', hanzi: '都是我的错', pinyin: 'Dōu shì wǒ de cuò', french: 'Tout est de ma faute' },
      { id: 'tdc_43', hanzi: '请你原谅我', pinyin: 'Qǐng nǐ yuánliàng wǒ', french: 'S’il te plaît pardonne moi' },
      { id: 'tdc_44', hanzi: '为了你我会更加珍惜自己', pinyin: 'Wèile nǐ wǒ huì gèngjiā zhēnxī zìjǐ', french: 'Pour toi, je prendrai encore plus soin de mon existence' },
      { id: 'tdc_45', hanzi: '只要我们的心还在一起', pinyin: 'Zhǐyào wǒmen de xīn hái zài yìqǐ', french: 'Tant que nos cœurs battent à l’unisson' },
      { id: 'tdc_46', hanzi: '岁月会有无数的奇迹', 'pinyin': 'Suìyuè huì yǒu wúshù de qíjì', french: 'Les jours à venir accompliront des miracles' },
      { id: 'tdc_47', hanzi: '我爱你', pinyin: 'Wǒ ài nǐ', french: 'Je t’aime' },
      { id: 'tdc_48', hanzi: '谢谢你', pinyin: 'Xièxie nǐ', french: 'Merci du fond du cœur' },
      { id: 'tdc_49', section: 'Refrain', hanzi: '都是我的错', pinyin: 'Dōu shì wǒ de cuò', french: 'Tout est de ma faute' },
      { id: 'tdc_50', hanzi: '请你原谅我', pinyin: 'Qǐng nǐ yuánliàng wǒ', french: 'S’il te plaît pardonne moi' },
      { id: 'tdc_51', hanzi: '为了你受再多的委屈都值得', pinyin: 'Wèile nǐ shòu zài duō de wěiqu dōu zhídé', french: 'Pour toi, chaque épreuve consentie en vaut la peine' },
      { id: 'tdc_52', hanzi: '本想给你我们的未来', pinyin: 'Běn xiǎng gěi nǐ wǒmen de wèilái', french: 'Je voulais t’offrir un avenir radieux' },
      { id: 'tdc_53', hanzi: '可代价却是两地的分离', pinyin: 'Kě dàijià què shì liǎng dì de fēnlí', french: 'Mais la distance est devenue notre fardeau' },
      { id: 'tdc_54', hanzi: '只能够用思念互相祝福', pinyin: 'Zhǐ nénggòu yòng sīniàn hùxiāng zhùfú', french: 'Et nos pensées restent notre seul réconfort' },
      { id: 'tdc_55', hanzi: '都是我的错', pinyin: 'Dōu shì wǒ de cuò', french: 'Tout est de ma faute' },
      { id: 'tdc_56', hanzi: '请你原谅我', pinyin: 'Qǐng nǐ yuánliàng wǒ', french: 'S’il te plaît pardonne moi' },
      { id: 'tdc_57', hanzi: '为了你我会更加珍惜自己', pinyin: 'Wèile nǐ wǒ huì gèngjiā zhēnxī zìjǐ', french: 'Pour toi, je veillerai précieusement sur moi' },
      { id: 'tdc_58', hanzi: '只要我们的心还在一起', pinyin: 'Zhǐyào wǒmen de xīn hái zài yìqǐ', french: 'Tant que nos âmes demeurent liées' },
      { id: 'tdc_59', hanzi: '岁月会有无数的惊喜', pinyin: 'Suìyuè huì yǒu wúshù de jīngxǐ', french: 'La vie nous réservera de magnifiques surprises' },
      { id: 'tdc_60', hanzi: '我爱你', pinyin: 'Wǒ ài nǐ', french: 'Je t’aime' },
      { id: 'tdc_61', hanzi: '谢谢你', pinyin: 'Xièxie nǐ', french: 'Merci du fond du cœur' },
    ],
  },
  {
    ...
    iconBg: 'from-[#D81B60] to-[#8E24AA]',
    sentences: [
      { id: 'qbn_1', section: 'Couplet 1', hanzi: '当时你给我一个笑脸', pinyin: 'Dāngshí nǐ gěi wǒ yí gè xiàoliǎn', french: 'En ce temps-là, ton sourire' },
      { id: 'qbn_2', hanzi: '让我心跳一辈子', pinyin: 'Ràng wǒ xīntiào yí bèizi', french: 'A fait battre mon cœur pour toute une vie' },
      { id: 'qbn_3', hanzi: '使我的目光永远', pinyin: 'Shǐ wǒ de mùguāng yǒngyuǎn', french: 'A fait que mon regard s’est pour toujours' },
      { id: 'qbn_4', hanzi: '融进了你的背影', pinyin: 'Róng jìn le nǐ de bèiyǐng', french: 'Fondu dans l’ombre de ta silhouette' },
      { id: 'qbn_5', hanzi: '岁月老去 我已不能爱', pinyin: 'Suìyuè lǎoqù, wǒ yǐ bù néng ài', french: 'Les années ont vieilli, je ne puis plus aimer' },
      { id: 'qbn_6', hanzi: '转过身往事突然清晰', pinyin: 'Zhuǎn guò shēn wǎngshì tūrán qīngxī', french: 'En me retournant, le passé redevient soudain limpide' },
      { id: 'qbn_7', hanzi: '重复你的目光', pinyin: 'Chóngfù nǐ de mùguāng', french: 'En croisant à nouveau ton regard' },
      { id: 'qbn_8', hanzi: '再也难串起我的记忆', pinyin: 'Zài yě nán chuàn qǐ wǒ de jìyì', french: 'Il est si difficile de renouer le fil de mes souvenirs' },
      { id: 'qbn_9', section: 'Refrain', hanzi: '夜深深 梦缠绵人沉醉', pinyin: 'Yè shēnshēn, mèng chánmián rén chénzuì', french: 'Dans la nuit profonde, les songes s’enlacent et l’âme s’enivre' },
      { id: 'qbn_10', hanzi: '既然离别难免 今生何必相会', pinyin: 'Jìrán líbié nánmiǎn, jīnshēng hébì xiānghuì', french: 'Si l’adieu est inéluctable, pourquoi nous être rencontrés en cette vie ?' },
      { id: 'qbn_11', hanzi: '今生何必相会', pinyin: 'Jīnshēng hébì xiānghuì', french: 'Pourquoi nous être croisés en cette vie ?' },
      { id: 'qbn_12', hanzi: '流星闪过 莫须伤悲', pinyin: 'Liúxīng shǎn guò, mò xū shāngbēi', french: 'L’étoile filante a traversé le ciel, nul besoin d’avoir du chagrin' },
      { id: 'qbn_13', hanzi: '千百年之后 谁又还记得谁', pinyin: 'Qiānbǎi nián zhīhòu, shéi yòu hái jìdé shéi', french: 'Mille ans plus tard, qui se souviendra encore de qui ?' },
      { id: 'qbn_14', hanzi: '谁又还记得 记得谁', pinyin: 'Shéi yòu hái jìdé, jìdé shéi', french: 'Qui se souviendra encore... de qui ?' },
      { id: 'qbn_15', section: 'Couplet 2', hanzi: '当时你给我一个笑脸', pinyin: 'Dāngshí nǐ gěi wǒ yí gè xiàoliǎn', french: 'En ce temps-là, ton sourire' },
      { id: 'qbn_16', hanzi: '让我心跳一辈子', pinyin: 'Ràng wǒ xīntiào yí bèizi', french: 'A fait battre mon cœur pour toute une vie' },
      { id: 'qbn_17', hanzi: '使我的目光永远', pinyin: 'Shǐ wǒ de mùguāng yǒngyuǎn', french: 'A fait que mon regard s’est pour toujours' },
      { id: 'qbn_18', hanzi: '融进了你的背影', pinyin: 'Róng jìn le nǐ de bèiyǐng', french: 'Fondu dans l’ombre de ta silhouette' },
      { id: 'qbn_19', hanzi: '岁月老去 我已不能爱', pinyin: 'Suìyuè lǎoqù, wǒ yǐ bù néng ài', french: 'Les années ont vieilli, je ne puis plus aimer' },
      { id: 'qbn_20', hanzi: '转过身往事突然清晰', pinyin: 'Zhuǎn guò shēn wǎngshì tūrán qīngxī', french: 'En me retournant, le passé redevient soudain si clair' },
      { id: 'qbn_21', hanzi: '重复你的目光', pinyin: 'Chóngfù nǐ de mùguāng', french: 'En croisant à nouveau ton regard' },
      { id: 'qbn_22', hanzi: '再也难串起我的记忆', pinyin: 'Zài yě nán chuàn qǐ wǒ de jìyì', french: 'Il est si dur de renouer la trame de mes souvenirs' },
      { id: 'qbn_23', section: 'Refrain', hanzi: '夜深深 梦缠绵人沉醉', pinyin: 'Yè shēnshēn, mèng chánmián rén chénzuì', french: 'Dans la nuit profonde, les songes s’enlacent et l’âme s’enivre' },
      { id: 'qbn_24', hanzi: '既然离别难免 今生何必相会', pinyin: 'Jìrán líbié nánmiǎn, jīnshēng hébì xiānghuì', french: 'Si l’adieu est inévitable, pourquoi nous être rencontrés en cette vie ?' },
      { id: 'qbn_25', hanzi: '今生何必相会', pinyin: 'Jīnshēng hébì xiānghuì', french: 'Pourquoi nous être croisés en cette vie ?' },
      { id: 'qbn_26', hanzi: '流星闪过 莫须伤悲', pinyin: 'Liúxīng shǎn guò, mò xū shāngbēi', french: 'L’étoile filante s’est évanouie, ne sois point triste' },
      { id: 'qbn_27', hanzi: '千百年之后 谁又还记得谁', pinyin: 'Qiānbǎi nián zhīhòu, shéi yòu hái jìdé shéi', french: 'Mille ans plus tard, qui se souviendra encore de qui ?' },
      { id: 'qbn_28', hanzi: '谁又还记得 记得谁', pinyin: 'Shéi yòu hái jìdé, jìdé shéi', french: 'Qui se souviendra encore... de qui ?' },
      { id: 'qbn_29', section: 'Refrain', hanzi: '夜深深 梦缠绵人沉醉', pinyin: 'Yè shēnshēn, mèng chánmián rén chénzuì', french: 'Dans la nuit profonde, les songes s’enlacent et l’âme s’enivre' },
      { id: 'qbn_30', hanzi: '既然离别难免 今生何必相会', pinyin: 'Jìrán líbié nánmiǎn, jīnshēng hébì xiānghuì', french: 'Si la rupture est inéluctable, pourquoi nous être rencontrés en cette vie ?' },
      { id: 'qbn_31', hanzi: '今生何必相会', pinyin: 'Jīnshēng hébì xiānghuì', french: 'Pourquoi nous être croisés en cette existence ?' },
      { id: 'qbn_32', hanzi: '流星闪过 莫须伤悲', pinyin: 'Liúxīng shǎn guò, mò xū shāngbēi', french: 'L’étoile filante a brillé un instant, ne garde nulle amertume' },
      { id: 'qbn_33', hanzi: '千百年之后 谁又还记得谁', pinyin: 'Qiānbǎi nián zhīhòu, shéi yòu hái jìdé shéi', french: 'Mille ans après, qui gardera la mémoire de qui ?' },
      { id: 'qbn_34', hanzi: '谁又还记得 记得谁', pinyin: 'Shéi yòu hái jìdé, jìdé shéi', french: 'Qui se souviendra encore... de qui ?' },
    ],
  },
  {
    ...
    imageUrl: 'https://img.youtube.com/vi/lxPybHy4SoM/hqdefault.jpg',
    iconBg: 'from-[#D81B60] to-[#880E4F]',
    sentences: [
      { id: 'ry_1', section: 'Couplet 1', hanzi: '一人后来过江南', pinyin: 'Yì rén hòulái guò Jiāngnán', french: 'Seul, je suis venu plus tard dans le Sud du fleuve' },
      { id: 'ry_2', hanzi: '烟雨锁惆怅', pinyin: 'Yānyǔ suǒ chóuchàng', french: 'La brume et la pluie enferment la mélancolie' },
      { id: 'ry_3', hanzi: '听得乌篷轻摇桨', pinyin: 'Tīng dé wūpéng qīng yáo jiǎng', french: 'J’entends les rames légères bercer la barque' },
      { id: 'ry_4', hanzi: '竟不知所想', pinyin: 'Jìng bù zhī suǒ xiǎng', french: 'Perdu dans le cours de mes songes' },
      { id: 'ry_5', hanzi: '画船箫鼓声声唱', pinyin: 'Huàchuán xiāogǔ shēngshēng chàng', french: 'Sur les bateaux peints résonnent les flûtes et les tambours' },
      { id: 'ry_6', hanzi: '几曲断人肠', pinyin: 'Jǐ qū duàn rén cháng', french: 'Quelques mélodies qui déchirent l’âme' },
      { id: 'ry_7', hanzi: '谁家墙头', pinyin: 'Shuí jiā qiángtóu', french: 'Au sommet d’un mur inconnu' },
      { id: 'ry_8', hanzi: '有梅自芬芳', pinyin: 'Yǒu méi zì fēnfāng', french: 'Fleurit un prunier au doux parfum' },
      { id: 'ry_9', section: 'Refrain', hanzi: '人间一场烟火', pinyin: 'Rénjiān yì chǎng yānhuǒ', french: 'Un feu d’artifice éphémère dans ce bas monde' },
      { id: 'ry_10', hanzi: '你曾盛开过', pinyin: 'Nǐ céng shèngkāi guò', french: 'Où tu as jadis fleuri de mille éclats' },
      { id: 'ry_11', hanzi: '刻几人在心窝', pinyin: 'Kè jǐ rén zài xīnwō', french: 'Combien d’êtres sont gravés au fond du cœur ?' },
      { id: 'ry_12', hanzi: '从此孤独活', pinyin: 'Cóngcǐ gūdú huó', french: 'Pour continuer à vivre dans la solitude' },
      { id: 'ry_13', hanzi: '江南花已凋落', pinyin: 'Jiāngnán huā yǐ diāoluò', french: 'Les fleurs de Jiangnan se sont déjà fanées' },
      { id: 'ry_14', hanzi: '怎堪再斟酌', pinyin: 'Zěn kān zài zhēnzhuó', french: 'Comment supporter d’y repenser encore ?' },
      { id: 'ry_15', hanzi: '可怜良辰无多', pinyin: 'Kělián liángchén wú duō', french: 'Hélas, les beaux instants sont si éphémères' },
      { id: 'ry_16', hanzi: '竟似无人说', pinyin: 'Jìng sì wú rén shuō', french: 'Et personne à qui confier sa peine' },
      { id: 'ry_17', section: 'Couplet 2', hanzi: '你撑纸伞回头望', pinyin: 'Nǐ chēng zhǐsǎn huítóu wàng', french: 'Tenant ton ombrelle de papier, tu te retournes' },
      { id: 'ry_18', hanzi: '千年乌衣巷', pinyin: 'Qiānnián Wūyī Xiàng', french: 'Vers la ruelle millénaire de Wuyi' },
      { id: 'ry_19', hanzi: '问君青丝有几丈', pinyin: 'Wèn jūn qīngsī yǒu jǐ zhàng', french: 'Dis-moi quelle longueur a ta chevelure' },
      { id: 'ry_20', hanzi: '能把风月量', pinyin: 'Néng bǎ fēngyuè liáng', french: 'Pour mesurer l’immensité des amours et du vent ?' },
      { id: 'ry_21', hanzi: '谁言杯酒醉他乡', pinyin: 'Shuí yán bēijiǔ zuì tāxiāng', french: 'Qui prétend qu’une coupe de vin au loin' },
      { id: 'ry_22', hanzi: '红尘皆可忘', pinyin: 'Hóngchén jiē kě wàng', french: 'Peut faire oublier les tourments de ce monde ?' },
      { id: 'ry_23', hanzi: '凭栏数尽孤帆', pinyin: 'Pínglán shǔ jìn gū fān', french: 'Accoudé au balcon à compter les voiles solitaires' },
      { id: 'ry_24', hanzi: '泪两行', pinyin: 'Lèi liǎng háng', french: 'Deux filets de larmes coulent sur mes joues' },
      { id: 'ry_25', section: 'Refrain', hanzi: '人间一场烟火', pinyin: 'Rénjiān yì chǎng yānhuǒ', french: 'Un feu d’artifice éphémère dans ce monde' },
      { id: 'ry_26', hanzi: '你曾盛开过', pinyin: 'Nǐ céng shèngkāi guò', french: 'Où tu as jadis fleuri avec splendeur' },
      { id: 'ry_27', hanzi: '刻几人在心窝', pinyin: 'Kè jǐ rén zài xīnwō', french: 'Combien d’âmes restent gravées en notre cœur ?' },
      { id: 'ry_28', hanzi: '从此孤独活', pinyin: 'Cóngcǐ gūdú huó', french: 'Désormais voué à une vie solitaire' },
      { id: 'ry_29', hanzi: '江南花已凋落', pinyin: 'Jiāngnán huā yǐ diāoluò', french: 'Les pétales de Jiangnan sont déjà tombés' },
      { id: 'ry_30', hanzi: '怎堪再斟酌', pinyin: 'Zěn kān zài zhēnzhuó', french: 'Comment trouver la force d’y songer encore ?' },
      { id: 'ry_31', hanzi: '可怜良辰无多', pinyin: 'Kělián liángchén wú duō', french: 'Hélas, les moments précieux s’envolent si vite' },
      { id: 'ry_32', hanzi: '竟似无人说', pinyin: 'Jìng sì wú rén shuō', french: 'Sans que personne ne vienne les partager' },
      { id: 'ry_33', section: 'Refrain', hanzi: '人间一场烟火', pinyin: 'Rénjiān yì chǎng yānhuǒ', french: 'Un éclat éphémère dans ce monde terrestre' },
      { id: 'ry_34', hanzi: '你曾盛开过', pinyin: 'Nǐ céng shèngkāi guò', french: 'Où ta présence a brillé de tant de beauté' },
      { id: 'ry_35', hanzi: '刻几人在心窝', pinyin: 'Kè jǐ rén zài xīnwō', french: 'Ceux que l’on garde à jamais au fond de soi' },
      { id: 'ry_36', hanzi: '从此孤独活', pinyin: 'Cóngcǐ gūdú huó', french: 'Et vivre avec ce souvenir en solitaire' },
      { id: 'ry_37', hanzi: '江南花已凋落', pinyin: 'Jiāngnán huā yǐ diāoluò', french: 'Les fleurs de Jiangnan se sont éteintes' },
      { id: 'ry_38', hanzi: '怎堪再斟酌', pinyin: 'Zěn kān zài zhēnzhuó', french: 'Difficile d’en peser la nostalgie' },
      { id: 'ry_39', hanzi: '可怜良辰无多', pinyin: 'Kělián liángchén wú duō', french: 'Hélas, le temps du bonheur est compté' },
      { id: 'ry_40', hanzi: '竟似无人说', pinyin: 'Jìng sì wú rén shuō', french: 'Et nul ne saurait l’exprimer' },
      { id: 'ry_41', hanzi: '可怜良辰无多', pinyin: 'Kělián liángchén wú duō', french: 'Tant de précieux instants perdus' },
      { id: 'ry_42', hanzi: '竟似无人说', pinyin: 'Jìng sì wú rén shuō', french: 'Et nul ne saurait l’exprimer' },
      { id: 'ry_43', hanzi: '可怜良辰无多', pinyin: 'Kělián liángchén wú duō', french: 'Tant de précieux instants perdus' },
      { id: 'ry_44', hanzi: '再难与人说', pinyin: 'Zài nán yǔ rén shuō', french: 'Qu’il est désormais si difficile d’en parler à quiconque' },
    ],
  },
];
