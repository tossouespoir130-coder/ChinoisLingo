...
export const readingCatalog: ReadingItem[] = [
  ...
  },
  {
    ...
    iconBg: 'from-[#6200EE] to-[#3700B3]',
    sentences: [
      { id: 'sn_1', section: 'Couplet 1', speaker: 'Eason Chan', hanzi: '如果那两个字没有颤抖', pinyin: 'Rúguǒ nà liǎng gè zì méiyǒu chàndǒu', french: 'Si ces deux mots n’avaient pas tremblé' },
      { id: 'sn_2', speaker: 'Eason Chan', hanzi: '我不会发现我难受', pinyin: 'Wǒ bú huì fāxiàn wǒ nánshòu', french: 'Je n’aurais pas réalisé combien j’ai mal' },
      { id: 'sn_3', speaker: 'Eason Chan', hanzi: '怎么说出口', pinyin: 'Zěnme shuō chū kǒu', french: 'Comment réussir à les prononcer ?' },
      { id: 'sn_4', speaker: 'Eason Chan', hanzi: '也不过是分手', pinyin: 'Yě búguò shì fēnshǒu', french: 'Ce n’est pourtant qu’une rupture' },
      { id: 'sn_5', section: 'Couplet 2', speaker: 'Eason Chan', hanzi: '如果对于明天没有要求', pinyin: 'Rúguǒ duìyú míngtiān méiyǒu yāoqiú', french: 'Si l’on n’attendait plus rien de demain' },
      { id: 'sn_6', speaker: 'Eason Chan', hanzi: '牵牵手就像旅游', pinyin: 'Qiānqiān shǒu jiù xiàng lǚyóu', french: 'Se donner la main serait comme un simple voyage' },
      { id: 'sn_7', speaker: 'Eason Chan', hanzi: '成千上万个门口', pinyin: 'Chéngqiān-shàngwàn gè ménkǒu', french: 'Parmi des milliers et des milliers de portes' },
      { id: 'sn_8', speaker: 'Eason Chan', hanzi: '总有一个人要先走', pinyin: 'Zǒng yǒu yí gè rén yào xiān zǒu', french: 'Il y en a toujours un qui doit s’en aller le premier' },
      { id: 'sn_9', section: 'Pré-refrain', speaker: 'Eason Chan', hanzi: '怀抱既然不能逗留', pinyin: 'Huáibào jìrán bù néng dòuliú', french: 'Puisqu’on ne peut s’attarder dans cette étreinte' },
      { id: 'sn_10', speaker: 'Eason Chan', hanzi: '何不在离开的时候', pinyin: 'Hébù zài líkāi de shíhou', french: 'Pourquoi ne pas, au moment de se séparer' },
      { id: 'sn_11', speaker: 'Eason Chan', hanzi: '一边享受', pinyin: 'Yìbiān xiǎngshòu', french: 'D’un côté savourer l’instant' },
      { id: 'sn_12', speaker: 'Eason Chan', hanzi: '一边泪流', pinyin: 'Yìbiān lèi liú', french: 'Et de l’autre laisser couler ses larmes' },
      { id: 'sn_13', section: 'Refrain', speaker: 'Eason Chan', hanzi: '十年之前', pinyin: 'Shí nián zhīqián', french: 'Il y a dix ans' },
      { id: 'sn_14', speaker: 'Eason Chan', hanzi: '我不认识你', pinyin: 'Wǒ bù rènshi nǐ', french: 'Je ne te connaissais pas' },
      { id: 'sn_15', speaker: 'Eason Chan', hanzi: '你不属于我', pinyin: 'Nǐ bù shǔyú wǒ', french: 'Tu ne m’appartenais pas' },
      { id: 'sn_16', speaker: 'Eason Chan', hanzi: '我们还是一样', pinyin: 'Wǒmen hái shì yí yàng', french: 'Nous étions tous les deux pareils' },
      { id: 'sn_17', speaker: 'Eason Chan', hanzi: '陪在一个陌生人左右', pinyin: 'Péi zài yí gè mòshēngrén zuǒyòu', french: 'Aux côtés d’un parfait étranger' },
      { id: 'sn_18', speaker: 'Eason Chan', hanzi: '走过渐渐熟悉的街头', pinyin: 'Zǒuguò jiànjiàn shúxī de jiētóu', french: 'Arpentant ces rues devenues peu à peu familières' },
      { id: 'sn_19', section: 'Refrain', speaker: 'Eason Chan', hanzi: '十年之后', pinyin: 'Shí nián zhīhòu', french: 'Dix ans plus tard' },
      { id: 'sn_20', speaker: 'Eason Chan', hanzi: '我们是朋友', pinyin: 'Wǒmen shì péngyou', french: 'Nous sommes de simples amis' },
      { id: 'sn_21', speaker: 'Eason Chan', hanzi: '还可以问候', pinyin: 'Hái kěyǐ wènhòu', french: 'Nous pouvons encore nous saluer' },
      { id: 'sn_22', speaker: 'Eason Chan', hanzi: '只是那种温柔', pinyin: 'Zhǐ shì nà zhǒng wēnróu', french: 'Mais cette tendresse d’autrefois' },
      { id: 'sn_23', speaker: 'Eason Chan', hanzi: '再也找不到拥抱的理由', pinyin: 'Zài yě zhǎo bú dào yōngbào de lǐyóu', french: 'Ne trouve plus aucune raison de s’enlacer' },
      { id: 'sn_24', speaker: 'Eason Chan', hanzi: '情人最后难免沦为朋友', pinyin: 'Qíngrén zuìhòu nánmiǎn lún wéi péngyou', french: 'Les amoureux finissent inévitablement par devenir de simples amis' },
      { id: 'sn_25', section: 'Pré-refrain', speaker: 'Eason Chan', hanzi: '怀抱既然不能逗留', pinyin: 'Huáibào jìrán bù néng dòuliú', french: 'Puisqu’on ne peut demeurer dans cette étreinte' },
      { id: 'sn_26', speaker: 'Eason Chan', hanzi: '何不在离开的时候', pinyin: 'Hébù zài líkāi de shíhou', french: 'Pourquoi ne pas, à l’heure de l’adieu' },
      { id: 'sn_27', speaker: 'Eason Chan', hanzi: '一边享受', pinyin: 'Yìbiān xiǎngshòu', french: 'D’un côté savourer le souvenir' },
      { id: 'sn_28', speaker: 'Eason Chan', hanzi: '一边泪流', pinyin: 'Yìbiān lèi liú', french: 'Et de l’autre laisser couler ses pleurs' },
      { id: 'sn_29', section: 'Refrain', speaker: 'Eason Chan', hanzi: '十年之前', pinyin: 'Shí nián zhīqián', french: 'Il y a dix ans' },
      { id: 'sn_30', speaker: 'Eason Chan', hanzi: '我不认识你', pinyin: 'Wǒ bù rènshi nǐ', french: 'Je ne te connaissais pas' },
      { id: 'sn_31', speaker: 'Eason Chan', hanzi: '你不属于我', pinyin: 'Nǐ bù shǔyú wǒ', french: 'Tu ne m’appartenais pas' },
      { id: 'sn_32', speaker: 'Eason Chan', hanzi: '我们还是一样', pinyin: 'Wǒmen hái shì yí yàng', french: 'Nous étions l’un et l’autre pareils' },
      { id: 'sn_33', speaker: 'Eason Chan', hanzi: '陪在一个陌生人左右', pinyin: 'Péi zài yí gè mòshēngrén zuǒyòu', french: 'Accompagnant un étranger' },
      { id: 'sn_34', speaker: 'Eason Chan', hanzi: '走过渐渐熟悉的街头', pinyin: 'Zǒuguò jiànjiàn shúxī de jiētóu', french: 'Traversant ces rues devenues familières' },
      { id: 'sn_35', section: 'Refrain', speaker: 'Eason Chan', hanzi: '十年之后', pinyin: 'Shí nián zhīhòu', french: 'Dix ans plus tard' },
      { id: 'sn_36', speaker: 'Eason Chan', hanzi: '我们是朋友', pinyin: 'Wǒmen shì péngyou', french: 'Nous sommes amis' },
      { id: 'sn_37', speaker: 'Eason Chan', hanzi: '还可以问候', pinyin: 'Hái kěyǐ wènhòu', french: 'Nous pouvons encore échanger des nouvelles' },
      { id: 'sn_38', speaker: 'Eason Chan', hanzi: '只是那种温柔', pinyin: 'Zhǐ shì nà zhǒng wēnróu', french: 'Mais cette tendresse passée' },
      { id: 'sn_39', speaker: 'Eason Chan', hanzi: '再也找不到拥抱的理由', pinyin: 'Zài yě zhǎo bú dào yōngbào de lǐyóu', french: 'Ne trouve plus aucun motif de s’étreindre' },
      { id: 'sn_40', speaker: 'Eason Chan', hanzi: '情人最后难免沦为朋友', pinyin: 'Qíngrén zuìhòu nánmiǎn lún wéi péngyou', french: 'Les amants finissent fatalement par devenir amis' },
      { id: 'sn_41', section: 'Outro', speaker: 'Eason Chan', hanzi: '直到和你做了多年朋友', pinyin: 'Zhídào hé nǐ zuò le duō nián péngyou', french: 'Ce n’est qu’après avoir été ton ami tant d’années' },
      { id: 'sn_42', speaker: 'Eason Chan', hanzi: '才明白我的眼泪', pinyin: 'Cái míngbai wǒ de yǎnlèi', french: 'Que j’ai compris que mes larmes' },
      { id: 'sn_43', speaker: 'Eason Chan', hanzi: '不是为你而流', pinyin: 'Bú shì wèi nǐ ér liú', french: 'Ne coulaient pas seulement pour toi' },
      { id: 'sn_44', speaker: 'Eason Chan', hanzi: '也为别人而流', pinyin: 'Yě wèi biérén ér liú', french: 'Mais coulaient aussi pour d’autres' },
    ],
  },
  {
