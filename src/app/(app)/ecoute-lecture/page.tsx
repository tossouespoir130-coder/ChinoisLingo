...
export const readingCatalog: ReadingItem[] = [
  ...
  // ---------- NIVEAU HSK 1 ----------
  {
    ...
    sentences: [
      {
        id: 'art_cn_1',
        hanzi: '中国很大。中国有很多人。北京在中国。北京也很大。',
        pinyin: 'Zhōngguó hěn dà. Zhōngguó yǒu hěn duō rén. Běijīng zài Zhōngguó. Běijīng yě hěn dà.',
        french: 'La Chine est très grande. La Chine compte beaucoup d’habitants. Pékin est en Chine. Pékin est également très grande.',
      },
      {
        id: 'art_cn_2',
        hanzi: '中国人说汉语。中国人写汉字。中国人喜欢喝茶。中国人也喜欢中国菜。',
        pinyin: 'Zhōngguórén shuō Hànyǔ. Zhōngguórén xiě Hànzì. Zhōngguórén xǐhuan hē chá. Zhōngguórén yě xǐhuan Zhōngguó cài.',
        french: 'Les Chinois parlent le mandarin. Les Chinois écrivent les caractères chinois. Les Chinois aiment boire du thé. Les Chinois aiment aussi la cuisine chinoise.',
      },
    ],
    vocabulary: [
  ...
  },
  {
    ...
    sentences: [
      ...
      {
        id: 'art_friend_2',
        hanzi: '他说汉语，也写汉字。他喜欢喝茶，也喜欢吃中国菜。',
        pinyin: 'Tā shuō Hànyǔ, yě xiě Hànzì. Tā xǐhuan hē chá, yě xǐhuan chī Zhōngguó cài.',
        french: 'Il parle chinois et écrit aussi les caractères chinois. Il aime boire du thé et apprécie également la cuisine chinoise.',
      },
      {
        id: 'art_friend_3',
        hanzi: '他请我喝茶。我说：“谢谢。”',
      ...
      {
        id: 'art_friend_4',
        hanzi: '我们说话，我们看书，我们写字。',
        pinyin: 'Wǒmen shuōhuà, wǒmen kàn shū, wǒmen xiězì.',
        french: 'Nous discutons, nous lisons des livres et nous nous entraînons à écrire.',
      },
      {
        id: 'art_friend_5',
        hanzi: '他是我的好朋友。',
        pinyin: 'Tā shì wǒ de hǎo péngyou.',
        french: 'C’est mon bon ami.',
      },
    ],
    vocabulary: [
  ...
  },
  {
    ...
    sentences: [
      {
        id: 'h_wm_1',
        hanzi: '王明是学生。他有一个好朋友，叫李月。李月也是学生。',
        pinyin: 'Wáng Míng shì xuésheng. Tā yǒu yí gè hǎo péngyou, jiào Lǐ Yuè. Lǐ Yuè yě shì xuésheng.',
        french: 'Wang Ming est étudiant. Il a une bonne amie qui s’appelle Li Yue. Li Yue est étudiante aussi.',
      },
      {
        id: 'h_wm_2',
        hanzi: '今天天气很好。不冷，也不热。',
      ...
      {
        id: 'h_wm_3',
        hanzi: '上午，王明去学校。他在学校学习汉语。他看见李月。李月很高兴。',
        pinyin: 'Shàngwǔ, Wáng Míng qù xuéxiào. Tā zài xuéxiào xuéxí Hànyǔ. Tā kànjiàn Lǐ Yuè. Lǐ Yuè hěn gāoxìng.',
        french: 'Le matin, Wang Ming va à l’école. Il étudie le chinois à l’école. Il aperçoit Li Yue. Li Yue est très contente.',
      },
      {
        id: 'h_wm_4',
      ...
      {
        id: 'h_wm_5',
        hanzi: '下午，他们回家。王明在家看电视。李月在家看书。',
        pinyin: 'Xiàwǔ, tāmen huí jiā. Wáng Míng zài jiā kàn diànshì. Lǐ Yuè zài jiā kàn shū.',
        french: 'L’après-midi, ils rentrent chez eux. Wang Ming regarde la télévision à la maison. Li Yue lit un livre chez elle.',
      },
      {
        id: 'h_wm_6',
        hanzi: '今天，王明很高兴。李月也很高兴。',
        pinyin: 'Jīntiān, Wáng Míng hěn gāoxìng. Lǐ Yuè yě hěn gāoxìng.',
        french: 'Aujourd’hui, Wang Ming est très heureux. Li Yue est très heureuse aussi.',
      },
    ],
    vocabulary: [
  ...
  },
  {
    ...
    sentences: [
      {
        id: 'h_cat_1',
        hanzi: '李月家有猫。猫叫小白。小白很小，很漂亮。李月很喜欢小白。',
        pinyin: 'Lǐ Yuè jiā yǒu māo. Māo jiào Xiǎobái. Xiǎobái hěn xiǎo, hěn piàoliang. Lǐ Yuè hěn xǐhuan Xiǎobái.',
        french: 'Il y a un chat chez Li Yue. Le chat s’appelle Xiao Bai. Xiao Bai est tout petit et très mignon. Li Yue aime beaucoup Xiao Bai.',
      },
      {
        id: 'h_cat_2',
        hanzi: '今天上午，李月在家。她看书，小白睡觉。',
        pinyin: 'Jīntiān shàngwǔ, Lǐ Yuè zài jiā. Tā kàn shū, Xiǎobái shuìjiào.',
        french: 'Ce matin, Li Yue est à la maison. Elle lit un livre pendant que Xiao Bai dort.',
      },
      {
        id: 'h_cat_3',
        hanzi: '中午，李月吃米饭。小白喝水。',
        pinyin: 'Zhōngwǔ, Lǐ Yuè chī mǐfàn. Xiǎobái hē shuǐ.',
        french: 'À midi, Li Yue mange du riz. Xiao Bai boit de l’eau.',
      },
      {
        id: 'h_cat_4',
        hanzi: '下午，李月去商店。她买水果。',
        pinyin: 'Xiàwǔ, Lǐ Yuè qù shāngdiàn. Tā mǎi shuǐguǒ.',
        french: 'L’après-midi, Li Yue va au magasin. Elle achète des fruits.',
      },
      {
        id: 'h_cat_5',
        hanzi: '她回家，看见小白在椅子上。',
        pinyin: 'Tā huí jiā, kànjiàn Xiǎobái zài yǐzi shang.',
        french: 'Elle rentre à la maison et aperçoit Xiao Bai assis sur la chaise.',
      },
    ],
    vocabulary: [
  ...
  },
  {
    ...
    sentences: [
      {
        id: 'h_zw_1',
        hanzi: '张伟是医生。他在医院工作。医院很大。医院里有很多人。',
        pinyin: 'Zhāng Wěi shì yīshēng. Tā zài yīyuàn gōngzuò. Yīyuàn hěn dà. Yīyuàn lǐ yǒu hěn duō rén.',
        french: 'Zhang Wei est médecin. Il travaille à l’hôpital. L’hôpital est grand et il y a beaucoup de monde à l’intérieur.',
      },
      {
        id: 'h_zw_2',
        hanzi: '张伟喜欢他的工作。他有很多朋友。朋友都是医生。他们工作，吃饭。',
        pinyin: 'Zhāng Wěi xǐhuan tā de gōngzuò. Tā yǒu hěn duō péngyou. Péngyou dōu shì yīshēng. Tāmen gōngzuò, chīfàn.',
        french: 'Zhang Wei aime son travail. Il a beaucoup d’amis. Ses amis sont tous médecins. Ils travaillent et mangent ensemble.',
      },
      {
        id: 'h_zw_3',
        hanzi: '张伟有女儿。女儿叫张小月。张小月是学生。',
        pinyin: 'Zhāng Wěi yǒu nǚ\'ér. Nǚ\'ér jiào Zhāng Xiǎoyuè. Zhāng Xiǎoyuè shì xuésheng.',
        french: 'Zhang Wei a une fille. Sa fille s’appelle Zhang Xiaoyue. Zhang Xiaoyue est étudiante.',
      },
      {
        id: 'h_zw_4',
        hanzi: '她学习汉语，也写字。她也很喜欢医院。她想做医生。',
        pinyin: 'Tā xuéxí Hànyǔ, yě xiězì. Tā yě hěn xǐhuan yīyuàn. Tā xiǎng zuò yīshēng.',
        french: 'Elle apprend le chinois et s’exerce à écrire les caractères. Elle aime aussi beaucoup l’hôpital et souhaite devenir médecin.',
      },
    ],
    vocabulary: [
