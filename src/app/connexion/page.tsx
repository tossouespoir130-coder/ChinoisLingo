...
export default function ConnexionPage() {
  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center p-3 sm:p-6 lg:p-10 overflow-hidden bg-[#ECEFF8] dark:bg-[#111218]">
      ...
      <div className="relative z-10 w-full max-w-lg lg:max-w-4xl bg-white dark:bg-[#1E1E28] rounded-3xl sm:rounded-[36px] border border-[#E0E0E0] dark:border-[#2D2D3D] shadow-2xl shadow-[#6200EE]/08 dark:shadow-black/50 overflow-hidden grid grid-cols-1 lg:grid-cols-12 animate-fadeIn">
        
        {/* ================= GAUCHE : VITRINE PÉDAGOGIQUE ÉPURÉE ================= */}
        <div className="lg:col-span-6 bg-gradient-to-br from-[#6200EE] via-[#3700B3] to-[#1E1E28] text-white p-5 sm:p-7 lg:p-10 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-3 sm:space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center font-hanzi font-black text-lg sm:text-xl text-white shadow-sm">
                华
              </div>
              <div>
                <span className="font-display font-black text-lg sm:text-2xl text-white tracking-tight block">
                  ChinoisLingo
                </span>
            ...
            <div className="pt-2 sm:pt-3">
              <h1 className="font-display font-black text-xl sm:text-2xl lg:text-3xl text-white leading-tight">
          ...
          {/* 3 Core Highlights (Synthesized & Clean) */}
          <div className="relative z-10 space-y-2.5 sm:space-y-3 my-5 sm:my-6">
            <div className="flex items-center gap-3 p-2 sm:p-2.5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xs">
          ...
          {/* Bottom Trust Note */}
          <div className="relative z-10 pt-3 border-t border-white/10 flex items-center justify-between text-[10.5px] sm:text-[11px] text-white/60">
            <span>Plateforme d’apprentissage</span>
            <span className="font-bold text-[#03DAC5]">100% Francophone</span>
          </div>
        </div>

        {/* ================= DROITE : FORMULAIRE PROPRE & ÉPURÉ SANS ONGLETS ================= */}
        <div className="lg:col-span-6 p-6 sm:p-8 lg:p-10 flex flex-col justify-between bg-white dark:bg-[#1E1E28]">
          <div className="space-y-6 w-full my-auto">
            ...
            {/* Formulaire avec les 3 éléments clés centrés */}
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5 animate-fadeIn">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 rounded-2xl border border-[#E0E0E0] dark:border-[#2D2D3D] bg-[#FAFAFA] dark:bg-[#252634] text-xs font-bold text-[#212121] dark:text-[#F5F5F5] outline-none focus:border-[#6200EE] transition-colors"
                    />
                  </div>
                </div>
              )}
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-2xl border border-[#E0E0E0] dark:border-[#2D2D3D] bg-[#FAFAFA] dark:bg-[#252634] text-xs text-[#212121] dark:text-[#F5F5F5] outline-none focus:border-[#6200EE] transition-colors"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full pl-10 pr-10 py-3 rounded-2xl border border-[#E0E0E0] dark:border-[#2D2D3D] bg-[#FAFAFA] dark:bg-[#252634] text-xs text-[#212121] dark:text-[#F5F5F5] outline-none focus:border-[#6200EE] focus:ring-2 focus:ring-[#6200EE]/20 transition-all"
                  />
                  <button
                    type="button"
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-3.5 rounded-full bg-[#6200EE] hover:bg-[#3700B3] text-white text-xs font-black shadow-md shadow-[#6200EE]/25 active:scale-95 transition-all btn-press flex items-center justify-center gap-2 cursor-pointer"
                >
            ...
            {/* Liens en bas : Mot de passe oublié (rouge au survol) & Créer un compte / Se connecter */}
            <div className="pt-4 border-t border-[#E0E0E0] dark:border-[#2D2D3D] flex items-center justify-between gap-2 text-xs">
              <button
                type="button"
                onClick={() => {
